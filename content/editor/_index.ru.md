...
############################# Head ############################
head_title: "SDK для редактирования документов  | На предпосылке APIS и бесплатное приложение"
head_description: "Редактировать файлы MS Office, OpenDocument, PDF, изображения и другие форматы файлов с использованием SDK для редактирования документов или же используйте приложение онлайн-редактора документов."

############################# Header ############################
title: "Редактируйте и управляйте документами с легкостью"
description: |
  Редактор документов SDK для манипулирования Microsoft Office, OpenOffice, PDF, HTML и другими форматами файлов документов.
