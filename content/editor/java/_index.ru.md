...
overview:
  enable: true
  title: "GroupDocs.Editor for Java с первого взгляда"
  description: "API для редактирования, преобразования и сохранения документов, электронных таблиц, слайдов и электронных книг в приложениях Java."
  features:
    # feature loop
    - title: "Без усилий редактировать несколько документов на Java"
      content: "Безусловно редактировать несколько файлов PDF и офисных файлов с поддержкой широкого спектра форматов. GroupDocs.Editor for Java делает документы быстро и без проблем."
...
formats:
  ...
  description: |
    GroupDocs.editor поддерживает операции со следующими форматами файлов при импорте и экспорте ([Полный список](https://docs.groupdocs.com/editor/java/supported-document-formats/)).
  groups:
    # group loop
    - color: "green"
      content: |
...
code_samples:
  enable: true
  title: "Образцы кода"
  description: "Некоторые варианты использования типичных операций с использованием GroupDocs.Editor for Java"
  items:
    # code sample loop
