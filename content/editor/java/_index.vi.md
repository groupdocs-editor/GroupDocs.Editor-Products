...
overview:
  enable: true
  title: "GroupDocs.Editor for Java trong nháy mắt"
  description: "API để chỉnh sửa, chuyển đổi và lưu tài liệu, bảng tính, slide và sách điện tử trong các ứng dụng Java."
  features:
    # feature loop
    - title: "Chỉnh sửa nhiều tài liệu trong Java một cách dễ dàng"
      content: "Chỉnh sửa một cách liền mạch nhiều tệp PDF và Office với sự hỗ trợ cho một loạt các định dạng. GroupDocs.Editor for Java Làm cho việc chỉnh sửa tài liệu nhanh chóng và không rắc rối."
...
platforms:
  ...
  description: "GroupDocs.Editor cho Java hỗ trợ các hệ điều hành, khung công tác và người quản lý gói sau đây."
  items:
    # platform loop
    - title: "Amazon"
      image: "amazon"
...
formats:
  ...
  description: |
    GroupDocs.Editor hỗ trợ các hoạt động với các định dạng tệp sau khi nhập và xuất ([danh sách đầy đủ](https://docs.groupdocs.com/editor/java/supported-document-formats/)).
  groups:
    # group loop
    - color: "green"
      content: |
...
code_samples:
  enable: true
  title: "Mẫu mã"
  description: "Một số trường hợp sử dụng các hoạt động điển hình sử dụng GroupDocs.Editor for Java"
  items:
    # code sample loop
