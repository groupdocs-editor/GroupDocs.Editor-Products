...
############################# Head ############################
head_title: "AZW3 محرر - تحرير AZW3 في Java"
head_description: "كيفية تعديل AZW3 في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير AZW3 في Java"
description: "تحرير AZW3 فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل AZW3 في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات AZW3 باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف AZW3
        * قم بإنشاء وتعيين مثيل فئة `EbookEditOptions` لتنسيق الملف AZW3
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند AZW3 بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف AZW3 الذي تم تحريره باستخدام فئة `EpubSaveOptions` أو` Azw3SaveOptions` للحفظ في تنسيقات ePub أو AZW3 على التوالي
...
demos:
    enable: true
    title: "AZW3 عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير AZW3 الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
