...
############################# Head ############################
head_title: "Editor AZW3 — Editeu AZW3 a Java"
head_description: "Com editar AZW3 a Java amb unes quantes línies de codi? Utilitzeu les API de processament de documents de GroupDocs per editar, actualitzar i desar més de 30 formats de fitxer."

############################# Header ############################
title: "Editeu AZW3 a Java"
description: "Edició AZW3 eficaç i robusta mitjançant GroupDocs.Editor del servidor per a les API Java, sense utilitzar cap programari com Microsoft o Open Office."
...
steps:
    enable: true
    title_left: "Passos per editar AZW3 a Java"
    content_left: |
        [GroupDocs.Editor for Java](/ca/editor/java/) ofereix als desenvolupadors una manera senzilla i senzilla d'editar els fitxers AZW3 utilitzant unes poques línies de codi.
        * Creeu una instància de la classe "Editor" amb el camí del fitxer o el flux de bytes obligatoris i carregueu el fitxer AZW3
        * Creeu i configureu la instància de classe `EbookEditOptions` per al format de fitxer AZW3
        * Truqueu al mètode `Editor.Edit()` i obteniu el document AZW3 en format HTML que es pugui editar fàcilment amb qualsevol editor WYSIWYG.
        * Truqueu al mètode `Editor.Save()` i deseu el fitxer editat AZW3 mitjançant la classe `EpubSaveOptions` o `Azw3SaveOptions` per desar-lo en formats ePub o AZW3 respectivament
...
demos:
    enable: true
    title: "AZW3 Editor de demostracions en directe"
    content: |
        Editeu AZW3 ara mateix visitant el lloc web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
