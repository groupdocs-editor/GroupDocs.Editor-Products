...
############################# Head ############################
head_title: "AZW3 Eagarthóir — Cuir AZW3 in eagar in {{ PlatformName}}"
head_description: "Conas AZW3 in Java a chur in eagar ag úsáid cúpla líne de chód? Bain úsáid as APIanna próiseála doiciméad GroupDocs chun 30+ formáid comhaid a chur in eagar, a nuashonrú agus a shábháil."

############################# Header ############################
title: "Cuir AZW3 in eagar in {{ PlatformName}}"
description: "Eagarthóireacht éifeachtach agus láidir AZW3 ag baint úsáide as taobh an fhreastalaí GroupDocs.Editor le haghaidh APIanna {{ PlatformName}}, gan úsáid a bhaint as aon bhogearraí ar nós Microsoft nó Open Office."
...
steps:
    enable: true
    title_left: "Céimeanna chun AZW3 a chur in eagar in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Editor for Java](/ga/editor/java/) bealach éasca agus simplí d’fhorbróirí chun na comhaid AZW3 a chur in eagar ag úsáid cúpla líne cód.
        * Cruthaigh sampla de rang `Eagarthóir` le conair éigeantach comhaid nó sruth beart agus lódáil an comhad AZW3
        * Cruthaigh & socraigh an sampla ranga `EbookEditOptions` don fhormáid comhaid AZW3
        * Glaoigh ar an modh `Editor.Edit()` agus faigh doiciméad AZW3 i bhformáid HTML is furasta a chur in eagar le haon eagarthóir WYSIWYG.
        * Glaoigh ar an modh `Editor.Save()` agus sábháil an comhad AZW3 atá curtha in eagar ag úsáid rang `EpubSaveOptions` nó `Azw3SaveOptions` chun é a shábháil i bhformáidí ePub nó AZW3 faoi seach
...
demos:
    enable: true
    title: "AZW3 Eagarthóir Beo Taispeántais"
    content: |
        Cuir AZW3 in eagar faoi láthair trí chuairt a thabhairt ar [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
