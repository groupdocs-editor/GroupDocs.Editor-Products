...
############################# Head ############################
head_title: "CSV محرر - تحرير CSV في Java"
head_description: "كيفية تعديل CSV في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير CSV في Java"
description: "تحرير CSV فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل CSV في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات CSV باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف CSV
        * أنشئ مثيل فئة `DelimitedTextEditOptions` لتنسيق ملف CSV وحدد فاصل سلسلة إلزاميًا في المنشئ
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند CSV بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG
        * استدع أسلوب `Editor.Save ()` واحفظ الملف CSV المحرر باستخدام مثيل فئة `DelimitedTextSaveOptions` مع الفاصل المطلوب
...
demos:
    enable: true
    title: "CSV عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير CSV الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
