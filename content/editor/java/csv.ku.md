...
############################# Head ############################
head_title: "CSV Edîtor — Biguherîne CSV li Java"
head_description: "Meriv çawa CSV di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne CSV li Java"
description: "Guhertina bi bandor û bihêz a CSV bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina CSV di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên CSV bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi riya pelê ya mecbûrî an herikîna baytê biafirîne û pelê CSV bar bike.
        * Ji bo forma pelê CSV mînaka çîna `DelimitedTextEditOptions` biafirîne û di çêkerê de veqetînerek rêzê ya mecbûrî diyar bike.
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya CSV ya bi formata HTML-ê ya ku bi her edîtorek WYSIWYG bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê CSV-ya hatî guherandin bi karanîna mînaka çîna `DelimitedTextSaveOptions` bi veqetînera xwestî hilînin.
...
demos:
    enable: true
    title: "CSV Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha CSV biguherînin.
