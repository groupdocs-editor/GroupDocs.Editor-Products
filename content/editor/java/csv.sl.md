...
############################# Head ############################
head_title: "Urejevalnik CSV — uredi CSV v Java"
head_description: "Kako urediti CSV v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi CSV v Java"
description: "Učinkovito in robustno urejanje CSV z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje CSV v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek CSV z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo datoteke ali tokom bajtov in naložite datoteko CSV
        * Ustvarite primerek razreda `DelimitedTextEditOptions` za obliko datoteke CSV in v konstruktorju določite obvezno ločilo nizov
        * Pokličite metodo `Editor.Edit()` in pridobite dokument CSV v formatu HTML, ki ga je mogoče preprosto urejati s katerim koli urejevalnikom WYSIWYG
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko CSV z uporabo primerka razreda `DelimitedTextSaveOptions` z želenim ločilom
...
demos:
    ...
    content: |
        Takoj uredite CSV tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
