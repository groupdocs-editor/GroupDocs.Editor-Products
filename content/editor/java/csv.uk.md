...
############################# Head ############################
head_title: "Редактор CSV — редагуйте CSV на Java"
head_description: "Як редагувати CSV в Java, використовуючи декілька рядків коду? Використовуйте API-інтерфейси обробки документів GroupDocs для редагування, оновлення та збереження файлів у більш ніж 30 форматах."

############################# Header ############################
title: "Редагувати CSV на Java"
description: "Ефективне та надійне редагування CSV із використанням API GroupDocs.Editor for Java, що виконується на серверній стороні, без використання стороннього ПЗ типу Microsoft Office чи Open Office."
...
steps:
    enable: true
    title_left: "Кроки по редагуванню CSV на Java"
    content_left: |
        [GroupDocs.Editor for Java](/uk/editor/java/) надає розробникам простий і зрозумілий спосіб редагування файлів CSV за допомогою кількох рядків коду.
        * Створіть екземпляр класу `Editor` із вказанням обов'язкового шляху до файлу чи байтового потоку із вмістом файлу і завантажте файл CSV
        * Створіть екземпляр класу `DelimitedTextEditOptions` для редагування CSV-файлів та у конструкторі вкажіть обов'язковий строковий розділювач, такий самий, що використовується у вхідному файлі
        * Викличте метод `Editor.Edit()` і отримайте документ CSV у форматі HTML, котрий легко редагується любим WYSIWYG-редактором
        * Викличте метод `Editor.Save()` і збережіть відредагований файл CSV, використовуючи клас `DelimitedTextSaveOptions`, у конструкторі котрого вказаний бажаний строковий розділювач
...
demos:
    enable: true
    title: "Демоверсії редактора CSV"
    content: |
        Відредагуйте CSV прямо зараз, відвідав [живі демонстрації](https://products.groupdocs.app/editor/family). Жива демонстрація має наступні переваги
