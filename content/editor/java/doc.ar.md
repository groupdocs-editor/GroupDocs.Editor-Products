...
############################# Head ############################
head_title: "DOC محرر - تحرير DOC في Java"
head_description: "كيفية تعديل DOC في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير DOC في Java"
description: "تحرير DOC فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل DOC في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات DOC باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق وفئة "WordProcessingLoadOptions" اختيارية وتحميل الملف DOC
        * إنشاء وتعيين مثيل فئة `WordProcessingEditOptions` لتنسيق الملف DOC
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند DOC بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * قم باستدعاء طريقة `Editor.Save ()` واحفظ الملف DOC المحرر باستخدام فئة `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOC عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير DOC الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
