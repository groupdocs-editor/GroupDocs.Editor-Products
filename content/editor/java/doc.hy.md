...
############################# Head ############################
head_title: "DOC Խմբագիր — Խմբագրել DOC Java-ում"
head_description: "Ինչպե՞ս խմբագրել DOC-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել DOC-ը Java-ում"
description: "Արդյունավետ և ուժեղ DOC խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "DOC-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու DOC ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ ֆայլի պարտադիր ուղով կամ հոսքով և ընտրովի «WordProcessingLoadOptions» դասով և բեռնեք DOC ֆայլը:
        * Ստեղծեք և սահմանեք «WordProcessingEditOptions» դասի օրինակը DOC ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք DOC փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված DOC ֆայլը՝ օգտագործելով «WordProcessingSaveOptions» դասը
...
demos:
    enable: true
    title: "DOC Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք DOC-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
