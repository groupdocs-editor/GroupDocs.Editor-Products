...
############################# Head ############################
head_title: "DOC Editor — Edit DOC di Java"
head_description: "Bagaimana cara mengedit DOC di Java menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

############################# Header ############################
title: "Edit DOC di Java"
description: "Pengeditan DOC yang efektif dan kuat menggunakan GroupDocs.Editor sisi server untuk API Java, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit DOC di Java"
    content_left: |
        [GroupDocs.Editor for Java](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file DOC menggunakan beberapa baris kode.
        * Buat instance kelas `Editor` dengan jalur atau aliran file wajib dan kelas `WordProcessingLoadOptions` opsional dan muat file DOC
        * Buat & setel instance kelas `WordProcessingEditOptions` untuk format file DOC
        * Panggil metode `Editor.Edit()` dan dapatkan dokumen DOC dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil metode `Editor.Save()` dan simpan file DOC yang telah diedit menggunakan kelas `WordProcessingSaveOptions`
...
demos:
    ...
    content: |
        Edit DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
