...
############################# Head ############################
head_title: "DOC Ritstjóri — Breyta DOC í Java"
head_description: "Hvernig á að breyta DOC í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta DOC í Java"
description: "Árangursrík og öflug DOC breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta DOC í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta DOC skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `WordProcessingLoadOptions` flokki og hlaðið DOC skránni
        * Búðu til og stilltu `WordProcessingEditOptions` flokkatilvikið fyrir DOC skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu DOC skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta DOC skrá með `WordProcessingSaveOptions` flokki
...
demos:
    enable: true
    title: "DOC Ritstjóri Live kynningar"
    content: |
        Breyttu DOC núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
