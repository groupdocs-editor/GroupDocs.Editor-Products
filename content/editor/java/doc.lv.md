...
############################# Head ############################
head_title: "DOC redaktors — rediģējiet DOC platformā Java"
head_description: "Kā rediģēt DOC platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt DOC platformā Java"
description: "Efektīva un stabila DOC rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu DOC programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt DOC failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu DOC.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam DOC
        * Izsauciet metodi "Editor.Edit()" un iegūstiet DOC dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto DOC failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "DOC Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet DOC tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
