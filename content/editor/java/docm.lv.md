...
############################# Head ############################
head_title: "DOCM redaktors — rediģējiet DOCM platformā Java"
head_description: "Kā rediģēt DOCM platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt DOCM platformā Java"
description: "Efektīva un stabila DOCM rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu DOCM programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt DOCM failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu DOCM.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam DOCM
        * Izsauciet metodi "Editor.Edit()" un iegūstiet DOCM dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto DOCM failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "DOCM Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet DOCM tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
