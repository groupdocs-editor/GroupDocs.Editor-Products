...
############################# Head ############################
head_title: "DOCX-redigeerder — Wysig DOCX in Java"
head_description: "Hoe om DOCX in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig DOCX in Java"
description: "Effektiewe en robuuste DOCX redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om DOCX in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die DOCX lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor` klas met verpligte lêerpad of stroom en opsionele `WordProcessingLoadOptions` klas en laai die DOCX lêer
        * Skep en stel die `WordProcessingEditOptions`-klasinstansie vir die DOCX-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry DOCX-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde DOCX-lêer met `WordProcessingSaveOptions`-klas
...
demos:
    enable: true
    title: "DOCX Redigeerder Regstreekse Demo's"
    content: |
        Wysig DOCX op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
