...
############################# Head ############################
head_title: "Editor DOCX – Upravit DOCX v Java"
head_description: "Jak upravit DOCX v Java pomocí několika řádků kódu? Pomocí rozhraní API pro zpracování dokumentů GroupDocs můžete upravovat, aktualizovat a ukládat více než 30 formátů souborů."

############################# Header ############################
title: "Upravit DOCX v Java"
description: "Efektivní a robustní úpravy DOCX pomocí rozhraní GroupDocs.Editor na straně serveru pro Java API bez použití jakéhokoli softwaru, jako je Microsoft nebo Open Office."
...
steps:
    enable: true
    title_left: "Kroky k úpravě DOCX v Java"
    content_left: |
        [GroupDocs.Editor for Java](/cs/editor/java/) poskytuje vývojářům snadný a přímočarý způsob, jak upravit soubory DOCX pomocí několika řádků kódu.
        * Vytvořte instanci třídy `Editor` s povinnou cestou k souboru nebo streamu a volitelnou třídou `WordProcessingLoadOptions` a načtěte soubor DOCX
        * Vytvořte a nastavte instanci třídy `WordProcessingEditOptions` pro formát souboru DOCX
        * Zavolejte metodu `Editor.Edit()` a získejte DOCX dokument ve formátu HTML, který lze snadno upravovat pomocí libovolného editoru WYSIWYG.
        * Zavolejte metodu `Editor.Save()` a uložte upravený soubor DOCX pomocí třídy `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "Živá ukázka editoru DOCX"
    content: |
        Upravte DOCX právě teď na webu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
