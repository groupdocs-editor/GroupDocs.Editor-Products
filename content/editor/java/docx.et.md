...
############################# Head ############################
head_title: "DOCX redaktor – muutke DOCX platvormil Java"
head_description: "Kuidas muuta DOCX platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda DOCX platvormil Java"
description: "Tõhus ja jõuline DOCX redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud DOCX muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi DOCX failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "WordProcessingLoadOptions" ja laadige fail DOCX
        * Looge ja määrake failivormingule DOCX klassi eksemplar "WordProcessingEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument DOCX, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail DOCX klassi "WordProcessingSaveOptions" abil
...
demos:
    enable: true
    title: "DOCX Reaalajas demode toimetaja"
    content: |
        Muutke DOCX kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
