...
############################# Head ############################
head_title: "DOCX Ritstjóri — Breyta DOCX í Java"
head_description: "Hvernig á að breyta DOCX í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta DOCX í Java"
description: "Árangursrík og öflug DOCX breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta DOCX í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta DOCX skránum með því að nota nokkrar línur af kóða.
