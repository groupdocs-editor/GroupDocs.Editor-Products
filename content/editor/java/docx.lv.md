...
############################# Head ############################
head_title: "DOCX redaktors — rediģējiet DOCX platformā Java"
head_description: "Kā rediģēt DOCX platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt DOCX platformā Java"
description: "Efektīva un stabila DOCX rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu DOCX programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt DOCX failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu DOCX.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam DOCX
        * Izsauciet metodi "Editor.Edit()" un iegūstiet DOCX dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto DOCX failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "DOCX Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet DOCX tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
