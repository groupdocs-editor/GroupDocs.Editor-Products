...
############################# Head ############################
head_title: "DOCX Editor — Bewerk DOCX in Java"
head_description: "Hoe bewerk je DOCX in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk DOCX in Java"
description: "Effectieve en robuuste DOCX bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om DOCX te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de DOCX-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of -stream en optionele klasse 'WordProcessingLoadOptions' en laad het bestand DOCX
        * Maak en stel de klasse-instantie 'WordProcessingEditOptions' in voor de bestandsindeling DOCX
        * Roep de `Editor.Edit()` methode aan en verkrijg een DOCX document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de methode 'Editor.Save()' aan en sla het bewerkte DOCX-bestand op met de klasse 'WordProcessingSaveOptions'
...
demos:
    enable: true
    title: "DOCX Editor Live demo's"
    content: |
        Bewerk DOCX nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
