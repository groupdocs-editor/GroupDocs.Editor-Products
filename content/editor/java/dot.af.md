...
############################# Head ############################
head_title: "DOT-redigeerder — Wysig DOT in Java"
head_description: "Hoe om DOT in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig DOT in Java"
description: "Effektiewe en robuuste DOT redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om DOT in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die DOT lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor` klas met verpligte lêerpad of stroom en opsionele `WordProcessingLoadOptions` klas en laai die DOT lêer
        * Skep en stel die `WordProcessingEditOptions`-klasinstansie vir die DOT-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry DOT-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde DOT-lêer met `WordProcessingSaveOptions`-klas
...
demos:
    enable: true
    title: "DOT Redigeerder Regstreekse Demo's"
    content: |
        Wysig DOT op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
