...
############################# Head ############################
head_title: "DOT Խմբագիր — Խմբագրել DOT Java-ում"
head_description: "Ինչպե՞ս խմբագրել DOT-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել DOT-ը Java-ում"
description: "Արդյունավետ և ուժեղ DOT խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "DOT-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու DOT ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ ֆայլի պարտադիր ուղով կամ հոսքով և ընտրովի «WordProcessingLoadOptions» դասով և բեռնեք DOT ֆայլը:
        * Ստեղծեք և սահմանեք «WordProcessingEditOptions» դասի օրինակը DOT ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք DOT փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված DOT ֆայլը՝ օգտագործելով «WordProcessingSaveOptions» դասը
...
demos:
    enable: true
    title: "DOT Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք DOT-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
