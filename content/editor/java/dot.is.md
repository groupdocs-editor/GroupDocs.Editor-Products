...
############################# Head ############################
head_title: "DOT Ritstjóri — Breyta DOT í Java"
head_description: "Hvernig á að breyta DOT í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta DOT í Java"
description: "Árangursrík og öflug DOT breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta DOT í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta DOT skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `WordProcessingLoadOptions` flokki og hlaðið DOT skránni
        * Búðu til og stilltu `WordProcessingEditOptions` flokkatilvikið fyrir DOT skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu DOT skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta DOT skrá með `WordProcessingSaveOptions` flokki
...
demos:
    enable: true
    title: "DOT Ritstjóri Live kynningar"
    content: |
        Breyttu DOT núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
