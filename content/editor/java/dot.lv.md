...
############################# Head ############################
head_title: "DOT redaktors — rediģējiet DOT platformā Java"
head_description: "Kā rediģēt DOT platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt DOT platformā Java"
description: "Efektīva un stabila DOT rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu DOT programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt DOT failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu DOT.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam DOT
        * Izsauciet metodi "Editor.Edit()" un iegūstiet DOT dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto DOT failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "DOT Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet DOT tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
