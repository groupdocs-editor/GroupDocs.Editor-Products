...
############################# Head ############################
head_title: "DOT Editor – Rediger DOT i Java"
head_description: "Hvordan redigere DOT i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger DOT i Java"
description: "Effektiv og robust DOT-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere DOT i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere DOT-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller strøm og valgfri 'WordProcessingLoadOptions'-klassen og last inn DOT-filen
        * Opprett og still inn klassen `WordProcessingEditOptions` for filformatet DOT
        * Kall `Editor.Edit()`-metoden og skaff DOT-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte DOT-filen ved å bruke `WordProcessingSaveOptions`-klassen
...
demos:
    enable: true
    title: "DOT Editor Live Demoer"
    content: |
        Rediger DOT akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
