...
############################# Head ############################
head_title: "DOT ผู้แก้ไข — แก้ไข DOT ใน Java"
head_description: "วิธีแก้ไข DOT ใน Java โดยใช้โค้ดสองสามบรรทัด ใช้ API การประมวลผลเอกสาร GroupDocs เพื่อแก้ไข อัปเดต และบันทึกรูปแบบไฟล์มากกว่า 30 รูปแบบ"

############################# Header ############################
title: "แก้ไข DOT ใน Java"
description: "การแก้ไข DOT ที่มีประสิทธิภาพและมีประสิทธิภาพโดยใช้ GroupDocs.Editor ฝั่งเซิร์ฟเวอร์สำหรับ API ของ Java โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการแก้ไข DOT ใน Java"
    content_left: |
        [GroupDocs.Editor for Java](/th/editor/java/) เป็นวิธีที่ง่ายและตรงไปตรงมาสำหรับนักพัฒนาในการแก้ไขไฟล์ DOT โดยใช้โค้ดสองสามบรรทัด
        * สร้างอินสแตนซ์ของคลาส "Editor" พร้อมเส้นทางไฟล์หรือสตรีมที่จำเป็น และคลาส "WordProcessingLoadOptions" ที่เป็นตัวเลือก และโหลดไฟล์ DOT
        * สร้างและตั้งค่าอินสแตนซ์คลาส `WordProcessingEditOptions` สำหรับรูปแบบไฟล์ DOT
        * เรียกใช้เมธอด `Editor.Edit()` และรับเอกสาร DOT ในรูปแบบ HTML ที่แก้ไขได้อย่างง่ายดายด้วยตัวแก้ไข WYSIWYG ใดๆ
        * เรียกเมธอด `Editor.Save()` และบันทึกไฟล์ DOT ที่แก้ไขแล้วโดยใช้คลาส `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOT การสาธิตสดของบรรณาธิการ"
    content: |
        แก้ไข DOT ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family)
