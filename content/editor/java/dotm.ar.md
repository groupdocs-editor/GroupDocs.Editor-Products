...
############################# Head ############################
head_title: "DOTM محرر - تحرير DOTM في Java"
head_description: "كيفية تعديل DOTM في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير DOTM في Java"
description: "تحرير DOTM فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل DOTM في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات DOTM باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق وفئة "WordProcessingLoadOptions" اختيارية وتحميل الملف DOTM
        * إنشاء وتعيين مثيل فئة `WordProcessingEditOptions` لتنسيق الملف DOTM
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند DOTM بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * قم باستدعاء طريقة `Editor.Save ()` واحفظ الملف DOTM المحرر باستخدام فئة `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOTM عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير DOTM الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
