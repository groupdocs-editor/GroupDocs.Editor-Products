...
############################# Head ############################
head_title: "DOTM redaktor – muutke DOTM platvormil Java"
head_description: "Kuidas muuta DOTM platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda DOTM platvormil Java"
description: "Tõhus ja jõuline DOTM redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud DOTM muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi DOTM failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "WordProcessingLoadOptions" ja laadige fail DOTM
        * Looge ja määrake failivormingule DOTM klassi eksemplar "WordProcessingEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument DOTM, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail DOTM klassi "WordProcessingSaveOptions" abil
...
demos:
    enable: true
    title: "DOTM Reaalajas demode toimetaja"
    content: |
        Muutke DOTM kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
