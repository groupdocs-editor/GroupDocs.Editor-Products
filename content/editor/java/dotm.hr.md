...
############################# Head ############################
head_title: "DOTM Editor — Uredite DOTM u Java"
head_description: "Kako urediti DOTM u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi DOTM u Java"
description: "Učinkovito i robusno DOTM uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje DOTM u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka DOTM pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznim putem datoteke ili streamom i izbornom klasom `WordProcessingLoadOptions` i učitajte datoteku DOTM
        * Stvorite i postavite instancu klase `WordProcessingEditOptions` za format datoteke DOTM
        * Pozovite metodu `Editor.Edit()` i dobijte DOTM dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu DOTM datoteku pomoću klase `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOTM Demonstracije uređivača uživo"
    content: |
        Uredite DOTM odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
