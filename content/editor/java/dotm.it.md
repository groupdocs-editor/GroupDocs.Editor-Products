...
############################# Head ############################
head_title: "Editor DOTM: modifica DOTM in Java"
head_description: "Come modificare DOTM in Java utilizzando poche righe di codice? Usa le API di elaborazione dei documenti di GroupDocs per modificare, aggiornare e salvare oltre 30 formati di file."

############################# Header ############################
title: "Modifica DOTM in Java"
description: "Modifica DOTM efficace e affidabile utilizzando GroupDocs.Editor lato server per API Java, senza l'uso di software come Microsoft o Open Office."
...
steps:
    enable: true
    title_left: "Passaggi per modificare DOTM in Java"
    content_left: |
        [GroupDocs.Editor for Java](/it/editor/java/) fornisce agli sviluppatori un modo semplice e diretto per modificare i file DOTM utilizzando poche righe di codice.
        * Crea un'istanza della classe `Editor` con percorso file o flusso obbligatorio e classe `WordProcessingLoadOptions` facoltativa e carica il file DOTM
        * Crea e imposta l'istanza della classe `WordProcessingEditOptions` per il formato file DOTM
        * Chiama il metodo `Editor.Edit()` e ottieni il documento DOTM in formato HTML facilmente modificabile con qualsiasi editor WYSIWYG.
        * Chiama il metodo `Editor.Save()` e salva il file DOTM modificato usando la classe `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOTM Editor Demo live"
    content: |
        Modifica DOTM in questo momento visitando il sito web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
