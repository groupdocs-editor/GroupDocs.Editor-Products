...
############################# Head ############################
head_title: "DOTM Edîtor — Biguherîne DOTM li Java"
head_description: "Meriv çawa DOTM di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne DOTM li Java"
description: "Guhertina bi bandor û bihêz a DOTM bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina DOTM di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên DOTM bi karanîna çend rêzikên kodê biguherînin.
