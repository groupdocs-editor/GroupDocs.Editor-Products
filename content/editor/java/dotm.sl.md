...
############################# Head ############################
head_title: "Urejevalnik DOTM — uredi DOTM v Java"
head_description: "Kako urediti DOTM v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi DOTM v Java"
description: "Učinkovito in robustno urejanje DOTM z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje DOTM v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek DOTM z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo do datoteke ali tokom in neobveznim razredom `WordProcessingLoadOptions` ter naložite datoteko DOTM
        * Ustvarite in nastavite primerek razreda `WordProcessingEditOptions` za obliko datoteke DOTM
        * Pokličite metodo `Editor.Edit()` in pridobite dokument DOTM v formatu HTML, ki ga je mogoče enostavno urejati s katerim koli urejevalnikom WYSIWYG.
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko DOTM z uporabo razreda `WordProcessingSaveOptions`
...
demos:
    ...
    content: |
        Takoj uredite DOTM tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
