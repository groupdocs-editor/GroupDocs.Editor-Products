...
############################# Head ############################
head_title: "Редактор DOTM — редагуйте DOTM на Java"
head_description: "Як редагувати DOTM в Java, використовуючи декілька рядків коду? Використовуйте API-інтерфейси обробки документів GroupDocs для редагування, оновлення та збереження файлів у більш ніж 30 форматах."

############################# Header ############################
title: "Редагувати DOTM на Java"
description: "Ефективне та надійне редагування DOTM із використанням API GroupDocs.Editor for Java, що виконується на серверній стороні, без використання стороннього ПЗ типу Microsoft Office чи Open Office."
...
steps:
    enable: true
    title_left: "Кроки по редагуванню DOTM на Java"
    content_left: |
        [GroupDocs.Editor for Java](/uk/editor/java/) надає розробникам простий і зрозумілий спосіб редагування файлів DOTM за допомогою кількох рядків коду.
        * Створіть екземпляр класу `Editor` із вказанням обов'язкового шляху до файлу чи потоки та необов'язковим класом `WordProcessingLoadOptions` і завантажте файл DOTM
        * Створіть та налаштуйте екземпляр класу `WordProcessingEditOptions` для формату файлу DOTM
        * Викличте метод `Editor.Edit()` і отримайте документ DOTM у форматі HTML, котрий легко редагується любим WYSIWYG-редактором.
        * Викличте метод `Editor.Save()` і збережіть відредагований файл DOTM, використовуючи клас `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "Демоверсії редактора DOTM"
    content: |
        Відредагуйте DOTM прямо зараз, відвідав [живі демонстрації](https://products.groupdocs.app/editor/family). Жива демонстрація має наступні переваги
