...
############################# Head ############################
head_title: "DOTX-redigeerder — Wysig DOTX in Java"
head_description: "Hoe om DOTX in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig DOTX in Java"
description: "Effektiewe en robuuste DOTX redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om DOTX in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die DOTX lêers te wysig deur 'n paar reëls kode te gebruik.
