...
head_title: "DOTX Editor untuk Java – Edit DOTX"
head_description: "Edit DOTX di Java menggunakan beberapa baris kode. API editor dokumen yang cepat dan tangguh untuk 30+ format file."

title: "Edit DOTX di Jawa"
description: "Editor DOTX yang andal dan cepat untuk aplikasi Java Anda tanpa perangkat lunak pihak ketiga seperti Microsoft Office atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah Mengedit DOTX di Java"
    content_left: |
        [GroupDocs.Editor](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file DOTX menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file DOTX dengan path lengkap
        * Buat & atur EditOptions untuk jenis file DOTX
        * Panggil metode Editor.edit dan dapatkan dokumen DOTX dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggilan Editor.save metode dan simpan file DOTX yang diedit
    ...
    code: |
        ```java
        // Muat file DOTX ke Editor
        Editor editor = new Editor("source.dotx");
        
        // Buka masukan DOTX dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.edit();

        // Ambil konten dokumen DOTX dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.getContent();

        // Perbarui konten dokumen DOTX dengan cara tertentu
        string updatedContent = content.replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.fromMarkup(updatedContent, null);

        // Simpan dokumen DOTX yang telah diedit
        editor.save(afterEdit, "edited.dotx");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor DOTX"
    content: |
        Edit DOTX sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family).  
