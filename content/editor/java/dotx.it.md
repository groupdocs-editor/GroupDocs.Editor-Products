...
############################# Head ############################
head_title: "Editor DOTX: modifica DOTX in Java"
head_description: "Come modificare DOTX in Java utilizzando poche righe di codice? Usa le API di elaborazione dei documenti di GroupDocs per modificare, aggiornare e salvare oltre 30 formati di file."

############################# Header ############################
title: "Modifica DOTX in Java"
description: "Modifica DOTX efficace e affidabile utilizzando GroupDocs.Editor lato server per API Java, senza l'uso di software come Microsoft o Open Office."
...
steps:
    enable: true
    title_left: "Passaggi per modificare DOTX in Java"
    content_left: |
        [GroupDocs.Editor for Java](/it/editor/java/) fornisce agli sviluppatori un modo semplice e diretto per modificare i file DOTX utilizzando poche righe di codice.
        * Crea un'istanza della classe `Editor` con percorso file o flusso obbligatorio e classe `WordProcessingLoadOptions` facoltativa e carica il file DOTX
        * Crea e imposta l'istanza della classe `WordProcessingEditOptions` per il formato file DOTX
        * Chiama il metodo `Editor.Edit()` e ottieni il documento DOTX in formato HTML facilmente modificabile con qualsiasi editor WYSIWYG.
        * Chiama il metodo `Editor.Save()` e salva il file DOTX modificato usando la classe `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "DOTX Editor Demo live"
    content: |
        Modifica DOTX in questo momento visitando il sito web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
