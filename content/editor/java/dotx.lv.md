...
############################# Head ############################
head_title: "DOTX redaktors — rediģējiet DOTX platformā Java"
head_description: "Kā rediģēt DOTX platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt DOTX platformā Java"
description: "Efektīva un stabila DOTX rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu DOTX programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt DOTX failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu DOTX.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam DOTX
        * Izsauciet metodi "Editor.Edit()" un iegūstiet DOTX dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto DOTX failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "DOTX Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet DOTX tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
