...
############################# Head ############################
head_title: "DOTX Editor — Bewerk DOTX in Java"
head_description: "Hoe bewerk je DOTX in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk DOTX in Java"
description: "Effectieve en robuuste DOTX bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om DOTX te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de DOTX-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of -stream en optionele klasse 'WordProcessingLoadOptions' en laad het bestand DOTX
        * Maak en stel de klasse-instantie 'WordProcessingEditOptions' in voor de bestandsindeling DOTX
        * Roep de `Editor.Edit()` methode aan en verkrijg een DOTX document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de methode 'Editor.Save()' aan en sla het bewerkte DOTX-bestand op met de klasse 'WordProcessingSaveOptions'
...
demos:
    enable: true
    title: "DOTX Editor Live demo's"
    content: |
        Bewerk DOTX nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
