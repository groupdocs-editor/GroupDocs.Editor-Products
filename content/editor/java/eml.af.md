...
############################# Head ############################
head_title: "EML-redigeerder — Wysig EML in Java"
head_description: "Hoe om EML in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig EML in Java"
description: "Effektiewe en robuuste EML redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om EML in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die EML lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die EML-lêer
        * Skep en stel die `EmailEditOptions`-klasinstansie vir die EML-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry EML-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde EML-lêer met `EmailSaveOptions`-klas
...
demos:
    enable: true
    title: "EML Redigeerder Regstreekse Demo's"
    content: |
        Wysig EML op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
