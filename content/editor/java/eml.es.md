...
############################# Head ############################
head_title: "Editor EML: edite EML en Java"
head_description: "¿Cómo editar EML en Java usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar EML en Java"
description: "Edición de EML efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de Java, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar EML en Java"
    content_left: |
        [GroupDocs.Editor for Java](/es/editor/java/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos EML usando unas pocas líneas de código.
        * Cree una instancia de la clase `Editor` con una ruta de archivo obligatoria o un flujo de bytes y cargue el archivo EML
        * Cree y configure la instancia de la clase `EmailEditOptions` para el formato de archivo EML
        * Llame al método `Editor.Edit()` y obtenga el documento EML en formato HTML que se puede editar fácilmente con cualquier editor WYSIWYG.
        * Llame al método `Editor.Save()` y guarde el archivo EML editado usando la clase `EmailSaveOptions`
...
demos:
    enable: true
    title: "EML Demostraciones en vivo del editor"
    content: |
        Edite EML ahora mismo visitando el sitio web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
