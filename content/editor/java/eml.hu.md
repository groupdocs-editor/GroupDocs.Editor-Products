...
############################# Head ############################
head_title: "EML szerkesztő – EML szerkesztése a Java alkalmazásban"
head_description: "Hogyan szerkeszthető a(z) EML a(z) Java alkalmazásban néhány sornyi kóddal? Használja a GroupDocs dokumentumfeldolgozó API-it több mint 30 fájlformátum szerkesztéséhez, frissítéséhez és mentéséhez."

############################# Header ############################
title: "EML szerkesztése itt: Java"
description: "Hatékony és robusztus EML szerkesztés a szerveroldali GroupDocs.Editor segítségével a Java API-khoz, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office."
...
steps:
    enable: true
    title_left: "A EML szerkesztésének lépései a Java nyelven"
    content_left: |
        A [GroupDocs.Editor for Java](/hu/editor/java/) egyszerű és egyértelmű módot biztosít a fejlesztők számára a EML fájlok szerkesztésére néhány sornyi kód használatával.
        * Hozzon létre egy példányt az "Editor" osztályból kötelező fájl elérési úttal vagy bájtfolyammal, és töltse be az EML fájlt
        * Hozza létre és állítsa be az `EmailEditOptions` osztálypéldányt a EML fájlformátumhoz
        * Hívja az "Editor.Edit()" metódust, és szerezzen be EML dokumentumot HTML formátumban, amely könnyen szerkeszthető bármely WYSIWYG-szerkesztővel.
        * Hívja meg az `Editor.Save()' metódust, és mentse a szerkesztett EML fájlt az `EmailSaveOptions` osztály segítségével
...
demos:
    enable: true
    title: "EML Élő bemutatók szerkesztője"
    content: |
        Szerkessze a(z) EML elemet most a [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webhelyen.
