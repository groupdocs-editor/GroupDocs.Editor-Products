...
############################# Head ############################
head_title: "EML Ritstjóri — Breyta EML í Java"
head_description: "Hvernig á að breyta EML í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta EML í Java"
description: "Árangursrík og öflug EML breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta EML í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta EML skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið EML skránni
        * Búðu til og stilltu `EmailEditOptions` flokkstilvikið fyrir EML skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu EML skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta EML skrá með `EmailSaveOptions` flokki
...
demos:
    enable: true
    title: "EML Ritstjóri Live kynningar"
    content: |
        Breyttu EML núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
