...
############################# Head ############################
head_title: "EML redaktors — rediģējiet EML platformā Java"
head_description: "Kā rediģēt EML platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt EML platformā Java"
description: "Efektīva un stabila EML rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu EML programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt EML failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu EML
        * Izveidojiet un iestatiet klases gadījumu `EmailEditOptions' faila formātam EML
        * Izsauciet metodi "Editor.Edit()" un iegūstiet EML dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto EML failu, izmantojot klasi "EmailSaveOptions".
...
demos:
    enable: true
    title: "EML Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet EML tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
