...
############################# Head ############################
head_title: "EMLX szerkesztő – EMLX szerkesztése a Java alkalmazásban"
head_description: "Hogyan szerkeszthető a(z) EMLX a(z) Java alkalmazásban néhány sornyi kóddal? Használja a GroupDocs dokumentumfeldolgozó API-it több mint 30 fájlformátum szerkesztéséhez, frissítéséhez és mentéséhez."

############################# Header ############################
title: "EMLX szerkesztése itt: Java"
description: "Hatékony és robusztus EMLX szerkesztés a szerveroldali GroupDocs.Editor segítségével a Java API-khoz, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office."
...
steps:
    enable: true
    title_left: "A EMLX szerkesztésének lépései a Java nyelven"
    content_left: |
        A [GroupDocs.Editor for Java](/hu/editor/java/) egyszerű és egyértelmű módot biztosít a fejlesztők számára a EMLX fájlok szerkesztésére néhány sornyi kód használatával.
        * Hozzon létre egy példányt az "Editor" osztályból kötelező fájl elérési úttal vagy bájtfolyammal, és töltse be az EMLX fájlt
        * Hozza létre és állítsa be az `EmailEditOptions` osztálypéldányt a EMLX fájlformátumhoz
        * Hívja az "Editor.Edit()" metódust, és szerezzen be EMLX dokumentumot HTML formátumban, amely könnyen szerkeszthető bármely WYSIWYG-szerkesztővel.
        * Hívja meg az `Editor.Save()' metódust, és mentse a szerkesztett EMLX fájlt az `EmailSaveOptions` osztály segítségével
...
demos:
    enable: true
    title: "EMLX Élő bemutatók szerkesztője"
    content: |
        Szerkessze a(z) EMLX elemet most a [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webhelyen.
