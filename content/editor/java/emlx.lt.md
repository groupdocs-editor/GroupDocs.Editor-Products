...
############################# Head ############################
head_title: "EMLX redaktorius – redaguoti EMLX Java"
head_description: "Kaip redaguoti EMLX Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti EMLX Java"
description: "Efektyvus ir patikimas EMLX redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti EMLX Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti EMLX failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba baitų srautu ir įkelkite failą EMLX
        * Sukurkite ir nustatykite „EmailEditOptions“ klasės egzempliorių failo formatui EMLX
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite EMLX dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą EMLX failą naudodami klasę „EmailSaveOptions“
...
demos:
    enable: true
    title: "EMLX Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite EMLX dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
