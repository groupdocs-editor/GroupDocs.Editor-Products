...
############################# Head ############################
head_title: "EMLX Editor – Rediger EMLX i Java"
head_description: "Hvordan redigere EMLX i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger EMLX i Java"
description: "Effektiv og robust EMLX-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere EMLX i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere EMLX-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller bytestrøm og last inn EMLX-filen
        * Opprett og still inn klasseforekomsten `EmailEditOptions` for filformatet EMLX
        * Kall `Editor.Edit()`-metoden og skaff EMLX-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte EMLX-filen med `EmailSaveOptions`-klassen
...
demos:
    enable: true
    title: "EMLX Editor Live Demoer"
    content: |
        Rediger EMLX akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
