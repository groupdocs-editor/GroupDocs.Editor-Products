...
############################# Head ############################
head_title: "EPUB-redigeerder — Wysig EPUB in Java"
head_description: "Hoe om EPUB in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig EPUB in Java"
description: "Effektiewe en robuuste EPUB redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om EPUB in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die EPUB lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die EPUB-lêer
        * Skep en stel die `EbookEditOptions`-klasinstansie vir die EPUB-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry EPUB-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde EPUB-lêer deur gebruik te maak van `EpubSaveOptions`- of `Azw3SaveOptions`-klas vir die stoor in onderskeidelik ePub- of AZW3-formate
...
demos:
    enable: true
    title: "EPUB Redigeerder Regstreekse Demo's"
    content: |
        Wysig EPUB op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
