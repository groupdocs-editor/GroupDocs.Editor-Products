...
############################# Head ############################
head_title: "EPUB محرر - تحرير EPUB في Java"
head_description: "كيفية تعديل EPUB في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير EPUB في Java"
description: "تحرير EPUB فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل EPUB في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات EPUB باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف EPUB
        * قم بإنشاء وتعيين مثيل فئة `EbookEditOptions` لتنسيق الملف EPUB
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند EPUB بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف EPUB الذي تم تحريره باستخدام فئة `EpubSaveOptions` أو` Azw3SaveOptions` للحفظ في تنسيقات ePub أو AZW3 على التوالي
...
demos:
    enable: true
    title: "EPUB عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير EPUB الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
