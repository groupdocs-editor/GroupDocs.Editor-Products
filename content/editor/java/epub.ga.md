...
############################# Head ############################
head_title: "EPUB Eagarthóir — Cuir EPUB in eagar in {{ PlatformName}}"
head_description: "Conas EPUB in Java a chur in eagar ag úsáid cúpla líne de chód? Bain úsáid as APIanna próiseála doiciméad GroupDocs chun 30+ formáid comhaid a chur in eagar, a nuashonrú agus a shábháil."

############################# Header ############################
title: "Cuir EPUB in eagar in {{ PlatformName}}"
description: "Eagarthóireacht éifeachtach agus láidir EPUB ag baint úsáide as taobh an fhreastalaí GroupDocs.Editor le haghaidh APIanna {{ PlatformName}}, gan úsáid a bhaint as aon bhogearraí ar nós Microsoft nó Open Office."
...
steps:
    enable: true
    title_left: "Céimeanna chun EPUB a chur in eagar in Java"
    content_left: |
        Soláthraíonn [GroupDocs.Editor for Java](/ga/editor/java/) bealach éasca agus simplí d’fhorbróirí chun na comhaid EPUB a chur in eagar ag úsáid cúpla líne cód.
        ...
        * Glaoigh ar an modh `Editor.Save()` agus sábháil an comhad EPUB atá curtha in eagar ag úsáid rang `EpubSaveOptions` nó `Azw3SaveOptions` chun é a shábháil i bhformáidí ePub nó AZW3 faoi seach
...
demos:
    enable: true
    title: "EPUB Eagarthóir Beo Taispeántais"
    content: |
        Cuir EPUB in eagar faoi láthair trí chuairt a thabhairt ar [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
