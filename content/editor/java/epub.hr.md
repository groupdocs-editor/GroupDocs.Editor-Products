...
############################# Head ############################
head_title: "EPUB Editor — Uredite EPUB u Java"
head_description: "Kako urediti EPUB u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi EPUB u Java"
description: "Učinkovito i robusno EPUB uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje EPUB u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka EPUB pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznom stazom datoteke ili tokom bajtova i učitajte datoteku EPUB
        * Stvorite i postavite instancu klase `EbookEditOptions` za format datoteke EPUB
        * Pozovite metodu `Editor.Edit()` i dobijte EPUB dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu EPUB datoteku koristeći klasu `EpubSaveOptions` ili `Azw3SaveOptions` za spremanje u formate ePub odnosno AZW3
...
demos:
    enable: true
    title: "EPUB Demonstracije uređivača uživo"
    content: |
        Uredite EPUB odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
