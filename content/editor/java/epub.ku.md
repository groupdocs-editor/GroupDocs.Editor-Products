...
############################# Head ############################
head_title: "EPUB Edîtor — Biguherîne EPUB li Java"
head_description: "Meriv çawa EPUB di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne EPUB li Java"
description: "Guhertina bi bandor û bihêz a EPUB bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina EPUB di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên EPUB bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi riya pelê ya mecbûrî an herikîna baytê biafirîne û pelê EPUB bar bike.
        * Ji bo forma pelê EPUB mînaka pola `EbookEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya EPUB ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê EPUB-ya hatî guherandin bi karanîna pola `EpubSaveOptions` an jî `Azw3SaveOptions` hilînin ji bo tomarkirinê di formatên ePub an AZW3 de.
...
demos:
    enable: true
    title: "EPUB Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha EPUB biguherînin.
