...
############################# Head ############################
head_title: "EPUB Editor – Rediger EPUB i Java"
head_description: "Hvordan redigere EPUB i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger EPUB i Java"
description: "Effektiv og robust EPUB-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere EPUB i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere EPUB-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller bytestrøm og last inn EPUB-filen
        * Opprett og still inn klasseforekomsten `EbookEditOptions` for filformatet EPUB
        * Kall `Editor.Edit()`-metoden og skaff EPUB-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte EPUB-filen ved å bruke `EpubSaveOptions`- eller `Azw3SaveOptions`-klassen for lagring i henholdsvis ePub- eller AZW3-formater
...
demos:
    ...
    content: |
        Rediger EPUB akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
