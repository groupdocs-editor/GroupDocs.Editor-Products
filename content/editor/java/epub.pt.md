...
############################# Head ############################
head_title: "Editor EPUB — Edite EPUB em Java"
head_description: "Como editar EPUB em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite EPUB em Java"
description: "Edição eficaz e robusta do EPUB usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar EPUB em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos EPUB usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho de arquivo obrigatório ou fluxo de bytes e carregue o arquivo EPUB
        * Crie e defina a instância da classe `EbookEditOptions` para o formato de arquivo EPUB
        * Chame o método `Editor.Edit()` e obtenha o documento EPUB em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo editado EPUB usando a classe `EpubSaveOptions` ou `Azw3SaveOptions` para salvar nos formatos ePub ou AZW3 respectivamente
...
demos:
    enable: true
    title: "EPUB Editor de demonstrações ao vivo"
    content: |
        Edite EPUB agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
