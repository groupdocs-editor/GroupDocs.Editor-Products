...
############################# Head ############################
head_title: "EPUB Düzenleyici — EPUB öğesini Java içinde düzenleyin"
head_description: "EPUB, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "EPUB öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam EPUB düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde EPUB Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak EPUB dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
...
demos:
    enable: true
    title: "EPUB Editör Canlı Demoları"
    content: |
        EPUB dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
