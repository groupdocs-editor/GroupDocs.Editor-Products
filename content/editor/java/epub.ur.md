...
############################# Head ############################
head_title: "EPUB ایڈیٹر — EPUB میں Java میں ترمیم کریں"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے Java میں EPUB میں ترمیم کیسے کی جائے؟ 30+ فائل فارمیٹس میں ترمیم، اپ ڈیٹ اور محفوظ کرنے کے لیے GroupDocs دستاویزات پر کارروائی کرنے والے APIs کا استعمال کریں۔"

############################# Header ############################
title: "Java میں EPUB میں ترمیم کریں"
description: "مائیکروسافٹ یا اوپن آفس جیسے کسی سافٹ ویئر کے استعمال کے بغیر، Java APIs کے لیے سرور سائڈ GroupDocs.Editor کا استعمال کرتے ہوئے مؤثر اور مضبوط EPUB ترمیم۔"
...
steps:
    enable: true
    title_left: "Java میں EPUB میں ترمیم کرنے کے مراحل"
    content_left: |
        [GroupDocs.Editor for Java](/ur/editor/java/) ڈویلپرز کو کوڈ کی چند سطروں کا استعمال کرتے ہوئے EPUB فائلوں میں ترمیم کرنے کا ایک آسان اور سیدھا طریقہ فراہم کرتا ہے۔
        * لازمی فائل پاتھ یا بائٹ اسٹریم کے ساتھ 'ایڈیٹر' کلاس کی ایک مثال بنائیں اور EPUB فائل لوڈ کریں۔
        * EPUB فائل فارمیٹ کے لیے `EbookEditOptions` کلاس مثال بنائیں اور سیٹ کریں
        * 'Editor.Edit()' طریقہ کو کال کریں اور HTML فارمیٹ میں EPUB دستاویز حاصل کریں جو کسی بھی WYSIWYG ایڈیٹر کے ساتھ آسانی سے قابل تدوین ہو۔
        * بالترتیب ePub یا AZW3 فارمیٹس میں محفوظ کرنے کے لیے `Editor.Save()` طریقہ کو کال کریں اور ترمیم شدہ EPUB فائل کو `EpubSaveOptions` یا `Azw3SaveOptions` کلاس کا استعمال کرتے ہوئے محفوظ کریں۔
...
demos:
    enable: true
    title: "EPUB ایڈیٹر لائیو ڈیمو"
    content: |
        [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) ویب سائٹ پر جا کر ابھی EPUB میں ترمیم کریں۔
