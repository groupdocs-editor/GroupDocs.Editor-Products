...
############################# Head ############################
head_title: "FODP エディタ — Java の FODP を編集"
head_description: "数行のコードを使用して Java の FODP を編集するには? GroupDocs ドキュメント処理 API を使用して、30 以上のファイル形式を編集、更新、保存します。"

############################# Header ############################
title: "JavaのFODPを編集"
description: "Microsoft や Open Office などのソフトウェアを使用せずに、サーバー側の GroupDocs.Editor for Java API を使用した効果的で堅牢な FODP 編集。"
...
steps:
    enable: true
    title_left: "Java で FODP を編集する手順"
    content_left: |
        [GroupDocs.Editor for Java](/ja/editor/java/) は、開発者が数行のコードを使用して FODP ファイルを編集する簡単で直接的な方法を提供します。
