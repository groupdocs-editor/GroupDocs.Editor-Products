...
############################# Head ############################
head_title: "FODP redaktors — rediģējiet FODP platformā Java"
head_description: "Kā rediģēt FODP platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt FODP platformā Java"
description: "Efektīva un stabila FODP rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu FODP programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt FODP failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" gadījumu ar obligātu faila ceļu vai baitu straumi un neobligātu klasi "PresentationLoadOptions" un ielādējiet failu FODP.
        * Izveidojiet un iestatiet klases `PresentationEditOptions` instanci faila formātam FODP
        * Izsauciet metodi "Editor.Edit()" un iegūstiet FODP dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto FODP failu, izmantojot klasi "PresentationSaveOptions".
...
demos:
    enable: true
    title: "FODP Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet FODP tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
