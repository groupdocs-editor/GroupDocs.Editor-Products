...
############################# Head ############################
head_title: "FODP Editor — Edit FODP in Java"
head_description: "How to edit FODP in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit FODP in Java"
description: "Effective and robust FODP editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit FODP in Java"
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the FODP files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or byte stream and optional `PresentationLoadOptions` class and load the FODP file
        * Create & set the `PresentationEditOptions` class instance for the FODP file format
        * Call `Editor.Edit()` method and obtain FODP document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited FODP file using `PresentationSaveOptions` class
...
demos:
    ...
    content: |
        Edit FODP right now by visiting [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) website.  
