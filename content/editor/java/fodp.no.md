...
############################# Head ############################
head_title: "FODP Editor – Rediger FODP i Java"
head_description: "Hvordan redigere FODP i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger FODP i Java"
description: "Effektiv og robust FODP-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere FODP i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere FODP-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller bytestrøm og valgfri 'PresentationLoadOptions'-klasse og last inn FODP-filen
        * Opprett og still inn klasseforekomsten `PresentationEditOptions` for filformatet FODP
        * Kall `Editor.Edit()`-metoden og skaff FODP-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte FODP-filen ved å bruke klassen `PresentationSaveOptions`
...
demos:
    enable: true
    title: "FODP Editor Live Demoer"
    content: |
        Rediger FODP akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
