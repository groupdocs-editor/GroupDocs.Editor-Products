...
############################# Head ############################
head_title: "FODP Düzenleyici — FODP öğesini Java içinde düzenleyin"
head_description: "FODP, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "FODP öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam FODP düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde FODP Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak FODP dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışı ve isteğe bağlı "PresentationLoadOptions" sınıfı ile bir "Editor" sınıfı örneği oluşturun ve FODP dosyasını yükleyin
        * FODP dosya biçimi için "PresentationEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında FODP belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve düzenlenen FODP dosyasını `PresentationSaveOptions` sınıfını kullanarak kaydedin
...
demos:
    enable: true
    title: "FODP Editör Canlı Demoları"
    content: |
        FODP dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
