...
head_title: "FODS Editor untuk Java – Edit FODS"
head_description: "Edit FODS di Java menggunakan beberapa baris kode. API editor dokumen yang cepat dan tangguh untuk 30+ format file."

title: "Edit FODS di Jawa"
description: "Editor FODS yang andal dan cepat untuk aplikasi Java Anda tanpa perangkat lunak pihak ketiga seperti Microsoft Office atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah Mengedit FODS di Java"
    content_left: |
        [GroupDocs.Editor](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file FODS menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file FODS dengan path lengkap
        * Buat & atur EditOptions untuk jenis file FODS
        * Panggil metode Editor.edit dan dapatkan dokumen FODS dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggilan Editor.save metode dan simpan file FODS yang diedit
    ...
    code: |
        ```java
        // Muat file FODS ke Editor
        Editor editor = new Editor("source.fods");
        
        // Buka masukan FODS dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.edit();

        // Ambil konten dokumen FODS dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.getContent();

        // Perbarui konten dokumen FODS dengan cara tertentu
        string updatedContent = content.replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.fromMarkup(updatedContent, null);

        // Simpan dokumen FODS yang telah diedit
        editor.save(afterEdit, "edited.fods");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor FODS"
    content: |
        Edit FODS sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family).  
