...
############################# Head ############################
head_title: "FODS redaktors — rediģējiet FODS platformā Java"
head_description: "Kā rediģēt FODS platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt FODS platformā Java"
description: "Efektīva un stabila FODS rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu FODS programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt FODS failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi "SpreadsheetLoadOptions" un ielādējiet failu FODS
        * Izveidojiet un iestatiet klases `SpreadsheetEditOptions` instanci faila formātam FODS
        * Izsauciet metodi "Editor.Edit()" un iegūstiet FODS dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto FODS failu, izmantojot klasi "SpreadsheetSaveOptions"
...
demos:
    enable: true
    title: "FODS Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet FODS tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
