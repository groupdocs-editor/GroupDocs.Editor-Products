...
############################# Head ############################
head_title: "FODS Editor — Edit FODS in Java"
head_description: "How to edit FODS in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit FODS in Java"
description: "Effective and robust FODS editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit FODS in Java"
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the FODS files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or stream and optional `SpreadsheetLoadOptions` class and load the FODS file
        * Create & set the `SpreadsheetEditOptions` class instance for the FODS file format
        * Call `Editor.Edit()` method and obtain FODS document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited FODS file using `SpreadsheetSaveOptions` class
...
demos:
    ...
    content: |
        Edit FODS right now by visiting [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) website.  
