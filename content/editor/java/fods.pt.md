...
############################# Head ############################
head_title: "Editor FODS — Edite FODS em Java"
head_description: "Como editar FODS em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite FODS em Java"
description: "Edição eficaz e robusta do FODS usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar FODS em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos FODS usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `SpreadsheetLoadOptions` e carregue o arquivo FODS
        * Crie e defina a instância de classe `SpreadsheetEditOptions` para o formato de arquivo FODS
        * Chame o método `Editor.Edit()` e obtenha o documento FODS em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo FODS editado usando a classe `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "FODS Editor de demonstrações ao vivo"
    content: |
        Edite FODS agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
