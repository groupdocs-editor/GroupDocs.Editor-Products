...
############################# Head ############################
head_title: "HTM-redigeerder — Wysig HTM in Java"
head_description: "Hoe om HTM in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig HTM in Java"
description: "Effektiewe en robuuste HTM redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om HTM in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die HTM lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die HTM-lêer
        * Skep en stel die `TextEditOptions`-klasinstansie vir die HTM-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry HTM-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde HTM-lêer met `TextSaveOptions`-klas
...
demos:
    enable: true
    title: "HTM Redigeerder Regstreekse Demo's"
    content: |
        Wysig HTM op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
