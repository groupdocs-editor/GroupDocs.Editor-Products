...
############################# Head ############################
head_title: "HTM محرر - تحرير HTM في Java"
head_description: "كيفية تعديل HTM في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير HTM في Java"
description: "تحرير HTM فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل HTM في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات HTM باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف HTM
        * قم بإنشاء وتعيين مثيل فئة `TextEditOptions` لتنسيق الملف HTM
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند HTM بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف HTM المحرر باستخدام فئة `TextSaveOptions`
...
demos:
    enable: true
    title: "HTM عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير HTM الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
