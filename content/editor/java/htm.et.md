...
############################# Head ############################
head_title: "HTM redaktor – muutke HTM platvormil Java"
head_description: "Kuidas muuta HTM platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda HTM platvormil Java"
description: "Tõhus ja jõuline HTM redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud HTM muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi HTM failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või baidivooga ja laadige fail HTM
        * Looge ja määrake klassi eksemplar "TextEditOptions" failivormingu HTM jaoks
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument HTM, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail HTM klassi "TextSaveOptions" abil
...
demos:
    enable: true
    title: "HTM Reaalajas demode toimetaja"
    content: |
        Muutke HTM kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
