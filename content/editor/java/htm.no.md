...
############################# Head ############################
head_title: "HTM Editor – Rediger HTM i Java"
head_description: "Hvordan redigere HTM i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger HTM i Java"
description: "Effektiv og robust HTM-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere HTM i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere HTM-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller bytestrøm og last inn HTM-filen
        * Opprett og still inn klassen `TextEditOptions` for filformatet HTM
        * Kall `Editor.Edit()`-metoden og skaff HTM-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte HTM-filen med `TextSaveOptions`-klassen
...
demos:
    enable: true
    title: "HTM Editor Live Demoer"
    content: |
        Rediger HTM akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
