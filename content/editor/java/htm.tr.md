...
############################# Head ############################
head_title: "HTM Düzenleyici — HTM öğesini Java içinde düzenleyin"
head_description: "HTM, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "HTM öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam HTM düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde HTM Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak HTM dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışıyla bir "Editör" sınıfı örneği oluşturun ve HTM dosyasını yükleyin
        * HTM dosya biçimi için "TextEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında HTM belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve `TextSaveOptions` sınıfını kullanarak düzenlenmiş HTM dosyasını kaydedin
...
demos:
    enable: true
    title: "HTM Editör Canlı Demoları"
    content: |
        HTM dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
