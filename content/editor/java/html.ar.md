...
############################# Head ############################
head_title: "HTML محرر - تحرير HTML في Java"
head_description: "كيفية تعديل HTML في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير HTML في Java"
description: "تحرير HTML فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل HTML في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات HTML باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف HTML
        * قم بإنشاء وتعيين مثيل فئة `TextEditOptions` لتنسيق الملف HTML
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند HTML بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف HTML المحرر باستخدام فئة `TextSaveOptions`
...
demos:
    enable: true
    title: "HTML عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير HTML الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
