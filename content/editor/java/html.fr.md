...
############################# Head ############################
head_title: "Éditeur HTML : modifiez HTML dans Java"
head_description: "Comment modifier HTML dans Java en utilisant quelques lignes de code ? Utilisez les API de traitement de documents GroupDocs pour modifier, mettre à jour et enregistrer plus de 30 formats de fichiers."

############################# Header ############################
title: "Modifier HTML dans Java"
description: "Édition HTML efficace et robuste à l'aide de GroupDocs.Editor côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Étapes pour modifier HTML dans Java"
    content_left: |
        [GroupDocs.Editor for Java](/fr/editor/java/) offre aux développeurs un moyen simple et direct de modifier les fichiers HTML à l'aide de quelques lignes de code.
        * Créez une instance de la classe `Editor` avec un chemin de fichier obligatoire ou un flux d'octets et chargez le fichier HTML
        * Créez et définissez l'instance de classe `TextEditOptions` pour le format de fichier HTML
        * Appelez la méthode `Editor.Edit()` et obtenez le document HTML au format HTML facilement modifiable avec n'importe quel éditeur WYSIWYG.
        * Appelez la méthode `Editor.Save()` et enregistrez le fichier HTML modifié à l'aide de la classe `TextSaveOptions`
...
demos:
    enable: true
    title: "HTML démos en direct de l'éditeur"
    content: |
        Modifiez HTML dès maintenant en visitant le site Web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
