...
draft: false
############################# Head ############################
head_title: "HTML-редактор для Java — редактирование HTML"
head_description: "Редактируйте HTML в Java, используя несколько строк кода. Быстрый и надежный API редактора документов для более чем 30 форматов файлов."
############################# Header ############################
title: "Редактировать HTML в Java"
description: "Мощный и быстрый HTML-редактор для вашего Java-приложения без стороннего программного обеспечения, такого как Microsoft Office или Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](/ru/editor/java/) предоставляет разработчикам простой и понятный способ редактирования файлов HTML с помощью нескольких строк кода.
