...
############################# Head ############################
head_title: "Urejevalnik HTML — uredi HTML v Java"
head_description: "Kako urediti HTML v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi HTML v Java"
description: "Učinkovito in robustno urejanje HTML z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje HTML v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek HTML z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo datoteke ali tokom bajtov in naložite datoteko HTML
        * Ustvarite in nastavite primerek razreda `TextEditOptions` za obliko datoteke HTML
        * Pokličite metodo `Editor.Edit()` in pridobite dokument HTML v formatu HTML, ki ga je mogoče enostavno urejati s katerim koli urejevalnikom WYSIWYG.
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko HTML z uporabo razreda `TextSaveOptions`
...
demos:
    ...
    content: |
        Takoj uredite HTML tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
