...
############################# Head ############################
head_title: "HTML Düzenleyici — HTML öğesini Java içinde düzenleyin"
head_description: "HTML, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "HTML öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam HTML düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde HTML Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak HTML dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışıyla bir "Editör" sınıfı örneği oluşturun ve HTML dosyasını yükleyin
        * HTML dosya biçimi için "TextEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında HTML belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve `TextSaveOptions` sınıfını kullanarak düzenlenmiş HTML dosyasını kaydedin
...
demos:
    enable: true
    title: "HTML Editör Canlı Demoları"
    content: |
        HTML dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
