...
############################# Head ############################
head_title: "MBOX-redigeerder — Wysig MBOX in Java"
head_description: "Hoe om MBOX in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig MBOX in Java"
description: "Effektiewe en robuuste MBOX redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om MBOX in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die MBOX lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die MBOX-lêer
        * Skep en stel die `EmailEditOptions`-klasinstansie vir die MBOX-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry MBOX-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde MBOX-lêer met `EmailSaveOptions`-klas
...
demos:
    enable: true
    title: "MBOX Redigeerder Regstreekse Demo's"
    content: |
        Wysig MBOX op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
