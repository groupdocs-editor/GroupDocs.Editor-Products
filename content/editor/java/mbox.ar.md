...
############################# Head ############################
head_title: "MBOX محرر - تحرير MBOX في Java"
head_description: "كيفية تعديل MBOX في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير MBOX في Java"
description: "تحرير MBOX فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل MBOX في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات MBOX باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف MBOX
        * إنشاء وتعيين مثيل فئة "EmailEditOptions" لتنسيق الملف MBOX
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند MBOX بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع طريقة `Editor.Save ()` واحفظ الملف MBOX الذي تم تحريره باستخدام فئة `EmailSaveOptions`
...
demos:
    enable: true
    title: "MBOX عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير MBOX الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
