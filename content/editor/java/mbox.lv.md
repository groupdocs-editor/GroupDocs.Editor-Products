...
############################# Head ############################
head_title: "MBOX redaktors — rediģējiet MBOX platformā Java"
head_description: "Kā rediģēt MBOX platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt MBOX platformā Java"
description: "Efektīva un stabila MBOX rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu MBOX programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt MBOX failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu MBOX
        * Izveidojiet un iestatiet klases gadījumu `EmailEditOptions' faila formātam MBOX
        * Izsauciet metodi "Editor.Edit()" un iegūstiet MBOX dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto MBOX failu, izmantojot klasi "EmailSaveOptions".
...
demos:
    enable: true
    title: "MBOX Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet MBOX tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
