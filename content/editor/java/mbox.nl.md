...
############################# Head ############################
head_title: "MBOX Editor — Bewerk MBOX in Java"
head_description: "Hoe bewerk je MBOX in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk MBOX in Java"
description: "Effectieve en robuuste MBOX bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om MBOX te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de MBOX-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met een verplicht bestandspad of bytestream en laad het bestand MBOX
        * Maak en stel de klasse-instantie 'EmailEditOptions' in voor de bestandsindeling MBOX
        * Roep de `Editor.Edit()` methode aan en verkrijg een MBOX document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de methode 'Editor.Save()' aan en sla het bewerkte MBOX-bestand op met de klasse 'EmailSaveOptions'
...
demos:
    enable: true
    title: "MBOX Editor Live demo's"
    content: |
        Bewerk MBOX nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
