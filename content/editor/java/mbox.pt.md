...
############################# Head ############################
head_title: "Editor MBOX — Edite MBOX em Java"
head_description: "Como editar MBOX em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite MBOX em Java"
description: "Edição eficaz e robusta do MBOX usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar MBOX em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos MBOX usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho de arquivo obrigatório ou fluxo de bytes e carregue o arquivo MBOX
        * Crie e defina a instância da classe `EmailEditOptions` para o formato de arquivo MBOX
        * Chame o método `Editor.Edit()` e obtenha o documento MBOX em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo MBOX editado usando a classe `EmailSaveOptions`
...
demos:
    enable: true
    title: "MBOX Editor de demonstrações ao vivo"
    content: |
        Edite MBOX agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
