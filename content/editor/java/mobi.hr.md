...
############################# Head ############################
head_title: "MOBI Editor — Uredite MOBI u Java"
head_description: "Kako urediti MOBI u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi MOBI u Java"
description: "Učinkovito i robusno MOBI uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje MOBI u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka MOBI pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznom stazom datoteke ili tokom bajtova i učitajte datoteku MOBI
        * Stvorite i postavite instancu klase `EbookEditOptions` za format datoteke MOBI
        * Pozovite metodu `Editor.Edit()` i dobijte MOBI dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu MOBI datoteku koristeći klasu `EpubSaveOptions` ili `Azw3SaveOptions` za spremanje u formate ePub odnosno AZW3
...
demos:
    enable: true
    title: "MOBI Demonstracije uređivača uživo"
    content: |
        Uredite MOBI odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
