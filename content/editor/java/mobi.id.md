...
############################# Head ############################
head_title: "MOBI Editor — Edit MOBI di Java"
head_description: "Bagaimana cara mengedit MOBI di Java menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

############################# Header ############################
title: "Edit MOBI di Java"
description: "Pengeditan MOBI yang efektif dan kuat menggunakan GroupDocs.Editor sisi server untuk API Java, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit MOBI di Java"
    content_left: |
        [GroupDocs.Editor for Java](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file MOBI menggunakan beberapa baris kode.
        * Buat instance kelas `Editor` dengan jalur file wajib atau aliran byte dan muat file MOBI
        * Buat & setel instance kelas `EbookEditOptions` untuk format file MOBI
        * Panggil metode `Editor.Edit()` dan dapatkan dokumen MOBI dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil metode `Editor.Save()` dan simpan file MOBI yang telah diedit menggunakan kelas `EpubSaveOptions` atau `Azw3SaveOptions` untuk masing-masing disimpan ke dalam format ePub atau AZW3
...
demos:
    ...
    content: |
        Edit MOBI sekarang juga dengan mengunjungi situs web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
