...
############################# Head ############################
head_title: "MOBI Ritstjóri — Breyta MOBI í Java"
head_description: "Hvernig á að breyta MOBI í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta MOBI í Java"
description: "Árangursrík og öflug MOBI breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta MOBI í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta MOBI skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið MOBI skránni
        * Búðu til og stilltu `EbookEditOptions` flokkstilvikið fyrir MOBI skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu MOBI skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta MOBI skrá með því að nota `EpubSaveOptions` eða `Azw3SaveOptions` flokkinn til að vista í ePub eða AZW3 snið, hvort um sig
...
demos:
    enable: true
    title: "MOBI Ritstjóri Live kynningar"
    content: |
        Breyttu MOBI núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
