...
############################# Head ############################
head_title: "MOBI Edîtor — Biguherîne MOBI li Java"
head_description: "Meriv çawa MOBI di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne MOBI li Java"
description: "Guhertina bi bandor û bihêz a MOBI bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina MOBI di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên MOBI bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi riya pelê ya mecbûrî an herikîna baytê biafirîne û pelê MOBI bar bike.
        * Ji bo forma pelê MOBI mînaka pola `EbookEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya MOBI ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê MOBI-ya hatî guherandin bi karanîna pola `EpubSaveOptions` an jî `Azw3SaveOptions` hilînin ji bo tomarkirinê di formatên ePub an AZW3 de.
...
demos:
    enable: true
    title: "MOBI Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha MOBI biguherînin.
