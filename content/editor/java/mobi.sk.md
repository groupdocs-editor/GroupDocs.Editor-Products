...
############################# Head ############################
head_title: "Editor MOBI – Upravte MOBI v Java"
head_description: "Ako upraviť MOBI v Java pomocou niekoľkých riadkov kódu? Použite rozhrania API na spracovanie dokumentov GroupDocs na úpravu, aktualizáciu a uloženie viac ako 30 formátov súborov."

############################# Header ############################
title: "Upraviť MOBI v Java"
description: "Efektívne a robustné úpravy MOBI pomocou GroupDocs.Editor na strane servera pre Java API bez použitia akéhokoľvek softvéru ako Microsoft alebo Open Office."
...
steps:
    enable: true
    title_left: "Kroky na úpravu MOBI v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sk/editor/java/) poskytuje vývojárom jednoduchý a priamy spôsob úpravy súborov MOBI pomocou niekoľkých riadkov kódu.
        * Vytvorte inštanciu triedy `Editor` s povinnou cestou k súboru alebo bajtovým tokom a načítajte súbor MOBI
        * Vytvorte a nastavte inštanciu triedy `EbookEditOptions` pre formát súboru MOBI
        * Zavolajte metódu `Editor.Edit()` a získajte dokument MOBI vo formáte HTML, ktorý je možné ľahko upravovať pomocou ľubovoľného editora WYSIWYG.
        * Zavolajte metódu `Editor.Save()` a uložte upravený súbor MOBI pomocou triedy `EpubSaveOptions` alebo `Azw3SaveOptions` na uloženie do formátov ePub alebo AZW3
...
demos:
    enable: true
    title: "Živé ukážky editora MOBI"
    content: |
        Upravte MOBI hneď teraz na webovej stránke [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
