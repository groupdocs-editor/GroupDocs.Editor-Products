...
############################# Head ############################
head_title: "Редактор MOBI — редагуйте MOBI на Java"
head_description: "Як редагувати MOBI в Java, використовуючи декілька рядків коду? Використовуйте API-інтерфейси обробки документів GroupDocs для редагування, оновлення та збереження файлів у більш ніж 30 форматах."

############################# Header ############################
title: "Редагувати MOBI на Java"
description: "Ефективне та надійне редагування MOBI із використанням API GroupDocs.Editor for Java, що виконується на серверній стороні, без використання стороннього ПЗ типу Microsoft Office чи Open Office."
...
steps:
    enable: true
    title_left: "Кроки по редагуванню MOBI на Java"
    content_left: |
        [GroupDocs.Editor for Java](/uk/editor/java/) надає розробникам простий і зрозумілий спосіб редагування файлів MOBI за допомогою кількох рядків коду.
        * Створіть екземпляр класу `Editor` із вказанням обов'язкового шляху до файлу чи потік і завантажте файл MOBI
        * Створіть та налаштуйте екземпляр класу `EbookEditOptions` для формату файлу MOBI
        * Викличте метод `Editor.Edit()` і отримайте документ MOBI у форматі HTML, котрий легко редагується любим WYSIWYG-редактором.
        * Викличте метод `Editor.Save()` і збережіть відредагований файл MOBI, використовуючи класи `EpubSaveOptions` чи `Azw3SaveOptions` для збереження у формати ePub чи AZW3
...
demos:
    enable: true
    title: "Демоверсії редактора MOBI"
    content: |
        Відредагуйте MOBI прямо зараз, відвідав [живі демонстрації](https://products.groupdocs.app/editor/family). Жива демонстрація має наступні переваги
