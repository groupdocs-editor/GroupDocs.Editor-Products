...
############################# Head ############################
head_title: "MSG-redigeerder — Wysig MSG in Java"
head_description: "Hoe om MSG in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig MSG in Java"
description: "Effektiewe en robuuste MSG redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om MSG in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die MSG lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die MSG-lêer
        * Skep en stel die `EmailEditOptions`-klasinstansie vir die MSG-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry MSG-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde MSG-lêer met `EmailSaveOptions`-klas
...
demos:
    enable: true
    title: "MSG Redigeerder Regstreekse Demo's"
    content: |
        Wysig MSG op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
