...
############################# Head ############################
head_title: "MSG Ritstjóri — Breyta MSG í Java"
head_description: "Hvernig á að breyta MSG í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta MSG í Java"
description: "Árangursrík og öflug MSG breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta MSG í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta MSG skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið MSG skránni
        * Búðu til og stilltu `EmailEditOptions` flokkstilvikið fyrir MSG skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu MSG skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta MSG skrá með `EmailSaveOptions` flokki
...
demos:
    enable: true
    title: "MSG Ritstjóri Live kynningar"
    content: |
        Breyttu MSG núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
