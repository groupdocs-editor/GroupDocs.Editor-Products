...
############################# Head ############################
head_title: "MSG Editor — Redigera MSG i Java"
head_description: "Hur redigerar man MSG i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera MSG i Java"
description: "Effektiv och robust MSG-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera MSG i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera MSG-filerna med några rader kod.
        * Skapa en instans av klassen "Editor" med obligatorisk sökväg eller byteström och ladda MSG-filen
        * Skapa och ställ in klassinstansen `EmailEditOptions` för filformatet MSG
        * Anropa `Editor.Edit()`-metoden och skaffa MSG-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade MSG-filen med klassen `EmailSaveOptions`
...
demos:
    ...
    content: |
        Redigera MSG just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
