...
############################# Head ############################
head_title: "ODP Επεξεργαστής — Επεξεργασία ODP στο Java"
head_description: "Πώς να επεξεργαστείτε το ODP στο Java χρησιμοποιώντας μερικές γραμμές κώδικα; Χρησιμοποιήστε τα API επεξεργασίας εγγράφων του GroupDocs για να επεξεργαστείτε, να ενημερώσετε και να αποθηκεύσετε 30+ μορφές αρχείων."

############################# Header ############################
title: "Επεξεργασία ODP στο Java"
description: "Αποτελεσματική και ισχυρή επεξεργασία ODP χρησιμοποιώντας την πλευρά του διακομιστή GroupDocs.Editor για API Java, χωρίς τη χρήση λογισμικού όπως η Microsoft ή το Open Office."
...
steps:
    enable: true
    title_left: "Βήματα για την επεξεργασία του ODP στο Java"
    content_left: |
        Το [GroupDocs.Editor for Java](/el/editor/java/) παρέχει έναν εύκολο και απλό τρόπο για τους προγραμματιστές να επεξεργάζονται τα αρχεία ODP χρησιμοποιώντας μερικές γραμμές κώδικα.
        * Δημιουργήστε μια παρουσία της κλάσης "Editor" με υποχρεωτική διαδρομή αρχείου ή ροή byte και προαιρετική κατηγορία "PresentationLoadOptions" και φορτώστε το αρχείο ODP
        * Δημιουργήστε και ορίστε την παρουσία κλάσης "PresentationEditOptions" για τη μορφή αρχείου ODP
        * Καλέστε τη μέθοδο `Editor.Edit()` και αποκτήστε έγγραφο ODP σε μορφή HTML που είναι εύκολα επεξεργάσιμο με οποιοδήποτε πρόγραμμα επεξεργασίας WYSIWYG.
        * Καλέστε τη μέθοδο "Editor.Save()" και αποθηκεύστε το επεξεργασμένο αρχείο ODP χρησιμοποιώντας την κλάση "PresentationSaveOptions"
...
demos:
    enable: true
    title: "ODP Ζωντανές επιδείξεις επεξεργασίας"
    content: |
        Επεξεργαστείτε το ODP τώρα, μεταβαίνοντας στον ιστότοπο [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
