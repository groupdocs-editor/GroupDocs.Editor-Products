...
############################# Head ############################
head_title: "ODP Խմբագիր — Խմբագրել ODP Java-ում"
head_description: "Ինչպե՞ս խմբագրել ODP-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել ODP-ը Java-ում"
description: "Արդյունավետ և ուժեղ ODP խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "ODP-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու ODP ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ՝ ֆայլի պարտադիր ճանապարհով կամ բայթ հոսքով և «PresentationLoadOptions» ընտրովի դասով և բեռնեք ODP ֆայլը:
        * Ստեղծեք և սահմանեք «PresentationEditOptions» դասի օրինակը ODP ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք ODP փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված ODP ֆայլը՝ օգտագործելով «PresentationSaveOptions» դասը:
...
demos:
    enable: true
    title: "ODP Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք ODP-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
