...
head_title: "ODP Editor untuk Java – Edit ODP"
head_description: "Edit ODP di Java menggunakan beberapa baris kode. API editor dokumen yang cepat dan tangguh untuk 30+ format file."

title: "Edit ODP di Jawa"
description: "Editor ODP yang andal dan cepat untuk aplikasi Java Anda tanpa perangkat lunak pihak ketiga seperti Microsoft Office atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah Mengedit ODP di Java"
    content_left: |
        [GroupDocs.Editor](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file ODP menggunakan beberapa baris kode.
        ...
        * Panggilan Editor.save metode dan simpan file ODP yang diedit
...
demos:
    ...
    content: |
        Edit ODP sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family).  
