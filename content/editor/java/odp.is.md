...
############################# Head ############################
head_title: "ODP Ritstjóri — Breyta ODP í Java"
head_description: "Hvernig á að breyta ODP í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta ODP í Java"
description: "Árangursrík og öflug ODP breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta ODP í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta ODP skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og valfrjálsum `PresentationLoadOptions` flokki og hlaðið ODP skránni
        * Búðu til og stilltu `PresentationEditOptions` flokkstilvikið fyrir ODP skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu ODP skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta ODP skrá með `PresentationSaveOptions` flokki
...
demos:
    enable: true
    title: "ODP Ritstjóri Live kynningar"
    content: |
        Breyttu ODP núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
