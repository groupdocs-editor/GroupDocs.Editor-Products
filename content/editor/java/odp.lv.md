...
############################# Head ############################
head_title: "ODP redaktors — rediģējiet ODP platformā Java"
head_description: "Kā rediģēt ODP platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt ODP platformā Java"
description: "Efektīva un stabila ODP rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu ODP programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt ODP failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" gadījumu ar obligātu faila ceļu vai baitu straumi un neobligātu klasi "PresentationLoadOptions" un ielādējiet failu ODP.
        * Izveidojiet un iestatiet klases `PresentationEditOptions` instanci faila formātam ODP
        * Izsauciet metodi "Editor.Edit()" un iegūstiet ODP dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto ODP failu, izmantojot klasi "PresentationSaveOptions".
...
demos:
    enable: true
    title: "ODP Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet ODP tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
