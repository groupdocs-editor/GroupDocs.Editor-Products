...
############################# Head ############################
head_title: "ODP Editor — Edit ODP dalam Java"
head_description: "Bagaimana untuk mengedit ODP dalam Java menggunakan beberapa baris kod? Gunakan API pemprosesan dokumen GroupDocs untuk mengedit, mengemas kini dan menyimpan 30+ format fail."

############################# Header ############################
title: "Edit ODP dalam Java"
description: "Pengeditan ODP yang berkesan dan mantap menggunakan GroupDocs.Editor sebelah pelayan untuk API Java, tanpa menggunakan sebarang perisian seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit ODP dalam Java"
    content_left: |
        [GroupDocs.Editor for Java](/ms/editor/java/) menyediakan cara yang mudah dan mudah untuk pembangun mengedit fail ODP menggunakan beberapa baris kod.
        * Buat contoh kelas `Editor` dengan laluan fail mandatori atau strim bait dan kelas `PresentationLoadOptions` pilihan dan muatkan fail ODP
        * Cipta & tetapkan contoh kelas `PresentationEditOptions` untuk format fail ODP
        * Panggil kaedah `Editor.Edit()` dan dapatkan ODP dokumen dalam format HTML yang boleh diedit dengan mudah dengan mana-mana editor WYSIWYG.
        * Panggil kaedah `Editor.Save()` dan simpan fail ODP yang diedit menggunakan kelas `PresentationSaveOptions`
...
demos:
    enable: true
    title: "ODP Demo Langsung Editor"
    content: |
        Edit ODP sekarang dengan melawati tapak web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
