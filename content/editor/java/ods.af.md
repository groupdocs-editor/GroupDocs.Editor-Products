...
############################# Head ############################
head_title: "ODS-redigeerder — Wysig ODS in Java"
head_description: "Hoe om ODS in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig ODS in Java"
description: "Effektiewe en robuuste ODS redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om ODS in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die ODS lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor` klas met verpligte lêerpad of stroom en opsionele `SpreadsheetLoadOptions` klas en laai die ODS lêer
        * Skep en stel die `SpreadsheetEditOptions`-klasinstansie vir die ODS-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry ODS-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde ODS-lêer deur gebruik te maak van `SpreadsheetSaveOptions`-klas
...
demos:
    enable: true
    title: "ODS Redigeerder Regstreekse Demo's"
    content: |
        Wysig ODS op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
