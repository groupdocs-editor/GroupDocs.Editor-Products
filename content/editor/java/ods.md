...
############################# Head ############################
head_title: "ODS Editor — Edit ODS in Java"
head_description: "How to edit ODS in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit ODS in Java"
description: "Effective and robust ODS editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit ODS in Java"
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the ODS files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or stream and optional `SpreadsheetLoadOptions` class and load the ODS file
        * Create & set the `SpreadsheetEditOptions` class instance for the ODS file format
        * Call `Editor.Edit()` method and obtain ODS document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited ODS file using `SpreadsheetSaveOptions` class
...
demos:
    ...
    content: |
        Edit ODS right now by visiting [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) website.  
