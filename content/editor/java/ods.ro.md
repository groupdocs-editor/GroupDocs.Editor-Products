...
############################# Head ############################
head_title: "Editor ODS — Editați ODS în Java"
head_description: "Cum se editează ODS în Java folosind câteva rânduri de cod? Utilizați API-urile de procesare a documentelor GroupDocs pentru a edita, actualiza și salva peste 30 de formate de fișiere."

############################# Header ############################
title: "Editați ODS în Java"
description: "Editare ODS eficientă și robustă folosind GroupDocs.Editor pe partea de server pentru API-urile Java, fără utilizarea vreunui software precum Microsoft sau Open Office."
...
steps:
    enable: true
    title_left: "Pași pentru a edita ODS în Java"
    content_left: |
        [GroupDocs.Editor for Java](/ro/editor/java/) oferă dezvoltatorilor o modalitate simplă și simplă de a edita fișierele ODS folosind câteva rânduri de cod.
        * Creați o instanță a clasei `Editor` cu calea fișierului sau fluxul obligatoriu și clasa opțională `SpreadsheetLoadOptions` și încărcați fișierul ODS
        * Creați și setați instanța clasei `SpreadsheetEditOptions` pentru formatul de fișier ODS
        * Apelați metoda `Editor.Edit()` și obțineți documentul ODS în format HTML care este ușor de editat cu orice editor WYSIWYG.
        * Apelați metoda `Editor.Save()` și salvați fișierul editat ODS folosind clasa `SpreadsheetSaveOptions`
...
demos:
    ...
    content: |
        Editați ODS chiar acum, vizitând site-ul [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
