...
############################# Head ############################
head_title: "ODT-redigeerder — Wysig ODT in Java"
head_description: "Hoe om ODT in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig ODT in Java"
description: "Effektiewe en robuuste ODT redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om ODT in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die ODT lêers te wysig deur 'n paar reëls kode te gebruik.
