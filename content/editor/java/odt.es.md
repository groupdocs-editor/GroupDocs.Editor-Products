...
############################# Head ############################
head_title: "Editor ODT: edite ODT en Java"
head_description: "¿Cómo editar ODT en Java usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar ODT en Java"
description: "Edición de ODT efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de Java, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar ODT en Java"
    content_left: |
        [GroupDocs.Editor for Java](/es/editor/java/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos ODT usando unas pocas líneas de código.
        * Cree una instancia de la clase 'Editor' con una ruta de archivo o secuencia obligatoria y una clase 'WordProcessingLoadOptions' opcional y cargue el archivo ODT
        * Cree y configure la instancia de la clase `WordProcessingEditOptions` para el formato de archivo ODT
        * Llame al método `Editor.Edit()` y obtenga el documento ODT en formato HTML que se puede editar fácilmente con cualquier editor WYSIWYG.
        * Llame al método `Editor.Save()` y guarde el archivo ODT editado usando la clase `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "ODT Demostraciones en vivo del editor"
    content: |
        Edite ODT ahora mismo visitando el sitio web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
