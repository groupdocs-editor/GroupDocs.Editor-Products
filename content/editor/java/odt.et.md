...
############################# Head ############################
head_title: "ODT redaktor – muutke ODT platvormil Java"
head_description: "Kuidas muuta ODT platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda ODT platvormil Java"
description: "Tõhus ja jõuline ODT redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud ODT muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi ODT failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "WordProcessingLoadOptions" ja laadige fail ODT
        * Looge ja määrake failivormingule ODT klassi eksemplar "WordProcessingEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument ODT, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail ODT klassi "WordProcessingSaveOptions" abil
...
demos:
    enable: true
    title: "ODT Reaalajas demode toimetaja"
    content: |
        Muutke ODT kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
