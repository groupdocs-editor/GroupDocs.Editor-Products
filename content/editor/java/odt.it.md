...
############################# Head ############################
head_title: "Editor ODT: modifica ODT in Java"
head_description: "Come modificare ODT in Java utilizzando poche righe di codice? Usa le API di elaborazione dei documenti di GroupDocs per modificare, aggiornare e salvare oltre 30 formati di file."

############################# Header ############################
title: "Modifica ODT in Java"
description: "Modifica ODT efficace e affidabile utilizzando GroupDocs.Editor lato server per API Java, senza l'uso di software come Microsoft o Open Office."
...
steps:
    enable: true
    title_left: "Passaggi per modificare ODT in Java"
    content_left: |
        [GroupDocs.Editor for Java](/it/editor/java/) fornisce agli sviluppatori un modo semplice e diretto per modificare i file ODT utilizzando poche righe di codice.
        * Crea un'istanza della classe `Editor` con percorso file o flusso obbligatorio e classe `WordProcessingLoadOptions` facoltativa e carica il file ODT
        * Crea e imposta l'istanza della classe `WordProcessingEditOptions` per il formato file ODT
        * Chiama il metodo `Editor.Edit()` e ottieni il documento ODT in formato HTML facilmente modificabile con qualsiasi editor WYSIWYG.
        * Chiama il metodo `Editor.Save()` e salva il file ODT modificato usando la classe `WordProcessingSaveOptions`
...
demos:
    ...
    content: |
        Modifica ODT in questo momento visitando il sito web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
