...
############################# Head ############################
head_title: "ODT redaktors — rediģējiet ODT platformā Java"
head_description: "Kā rediģēt ODT platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt ODT platformā Java"
description: "Efektīva un stabila ODT rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu ODT programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt ODT failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu ODT.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam ODT
        * Izsauciet metodi "Editor.Edit()" un iegūstiet ODT dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto ODT failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "ODT Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet ODT tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
