...
############################# Head ############################
head_title: "ODT Editor — Edit ODT dalam Java"
head_description: "Bagaimana untuk mengedit ODT dalam Java menggunakan beberapa baris kod? Gunakan API pemprosesan dokumen GroupDocs untuk mengedit, mengemas kini dan menyimpan 30+ format fail."

############################# Header ############################
title: "Edit ODT dalam Java"
description: "Pengeditan ODT yang berkesan dan mantap menggunakan GroupDocs.Editor sebelah pelayan untuk API Java, tanpa menggunakan sebarang perisian seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit ODT dalam Java"
    content_left: |
        [GroupDocs.Editor for Java](/ms/editor/java/) menyediakan cara yang mudah dan mudah untuk pembangun mengedit fail ODT menggunakan beberapa baris kod.
        * Buat contoh kelas `Editor` dengan laluan fail atau strim mandatori dan kelas `WordProcessingLoadOptions` pilihan dan muatkan fail ODT
        * Cipta & tetapkan contoh kelas `WordProcessingEditOptions` untuk format fail ODT
        * Panggil kaedah `Editor.Edit()` dan dapatkan ODT dokumen dalam format HTML yang boleh diedit dengan mudah dengan mana-mana editor WYSIWYG.
        * Panggil kaedah `Editor.Save()` dan simpan fail ODT yang diedit menggunakan kelas `WordProcessingSaveOptions`
...
demos:
    enable: true
    title: "ODT Demo Langsung Editor"
    content: |
        Edit ODT sekarang dengan melawati tapak web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
