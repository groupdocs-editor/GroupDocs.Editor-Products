...
############################# Head ############################
head_title: "ODT Editor — Bewerk ODT in Java"
head_description: "Hoe bewerk je ODT in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk ODT in Java"
description: "Effectieve en robuuste ODT bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om ODT te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de ODT-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of -stream en optionele klasse 'WordProcessingLoadOptions' en laad het bestand ODT
        * Maak en stel de klasse-instantie 'WordProcessingEditOptions' in voor de bestandsindeling ODT
        * Roep de `Editor.Edit()` methode aan en verkrijg een ODT document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de methode 'Editor.Save()' aan en sla het bewerkte ODT-bestand op met de klasse 'WordProcessingSaveOptions'
...
demos:
    enable: true
    title: "ODT Editor Live demo's"
    content: |
        Bewerk ODT nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
