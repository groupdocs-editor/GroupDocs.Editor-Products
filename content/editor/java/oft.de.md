...
############################# Head ############################
head_title: "OFT-Editor – Bearbeiten Sie OFT in Java"
head_description: "Wie bearbeite ich OFT in Java mit ein paar Zeilen Code? Verwenden Sie GroupDocs-APIs zur Dokumentenverarbeitung, um mehr als 30 Dateiformate zu bearbeiten, zu aktualisieren und zu speichern."

############################# Header ############################
title: "Bearbeiten Sie OFT in Java"
description: "Effektive und robuste OFT-Bearbeitung mit serverseitigem GroupDocs.Editor für Java-APIs, ohne die Verwendung von Software wie Microsoft oder Open Office."
...
steps:
    enable: true
    title_left: "Schritte zum Bearbeiten von OFT in Java"
    content_left: |
        [GroupDocs.Editor for Java](/de/editor/java/) bietet Entwicklern eine einfache und unkomplizierte Möglichkeit, die OFT-Dateien mit wenigen Codezeilen zu bearbeiten.
        * Erstellen Sie eine Instanz der Klasse „Editor“ mit obligatorischem Dateipfad oder Bytestream und laden Sie die Datei OFT
        * Erstellen und legen Sie die Klasseninstanz „EmailEditOptions“ für das Dateiformat OFT fest
        * Rufen Sie die Methode `Editor.Edit()` auf und erhalten Sie ein OFT-Dokument im HTML-Format, das mit jedem WYSIWYG-Editor einfach bearbeitet werden kann.
        * Rufen Sie die Methode „Editor.Save()“ auf und speichern Sie die bearbeitete OFT-Datei mit der Klasse „EmailSaveOptions“.
...
demos:
    enable: true
    title: "OFT Editor-Live-Demos"
    content: |
        Bearbeiten Sie OFT jetzt, indem Sie die Website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) besuchen. Die Live-Demo hat die folgenden Vorteile
