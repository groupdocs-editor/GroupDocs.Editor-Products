...
############################# Head ############################
head_title: "OFT Ritstjóri — Breyta OFT í Java"
head_description: "Hvernig á að breyta OFT í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta OFT í Java"
description: "Árangursrík og öflug OFT breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta OFT í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta OFT skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið OFT skránni
        * Búðu til og stilltu `EmailEditOptions` flokkstilvikið fyrir OFT skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu OFT skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta OFT skrá með `EmailSaveOptions` flokki
...
demos:
    enable: true
    title: "OFT Ritstjóri Live kynningar"
    content: |
        Breyttu OFT núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
