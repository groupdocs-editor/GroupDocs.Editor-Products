...
############################# Head ############################
head_title: "OFT 编辑器 - 在 Java 中编辑 OFT"
head_description: "如何使用几行代码在 Java 中编辑 OFT？使用 GroupDocs 文档处理 API 编辑、更新和保存 30 多种文件格式。"

############################# Header ############################
title: "在 Java 中编辑 OFT"
description: "使用用于 Java API 的服务器端 GroupDocs.Editor 进行有效且强大的 OFT 编辑，无需使用 Microsoft 或 Open Office 等任何软件。"
...
steps:
    enable: true
    title_left: "在 Java 中编辑 OFT 的步骤"
    content_left: |
        [GroupDocs.Editor for Java](/zh/editor/java/) 为开发人员提供了一种使用几行代码编辑 OFT 文件的简单直接的方法。
