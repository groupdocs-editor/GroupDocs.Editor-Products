...
############################# Head ############################
head_title: "OST محرر - تحرير OST في Java"
head_description: "كيفية تعديل OST في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير OST في Java"
description: "تحرير OST فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل OST في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات OST باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف OST
        * إنشاء وتعيين مثيل فئة "EmailEditOptions" لتنسيق الملف OST
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند OST بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع طريقة `Editor.Save ()` واحفظ الملف OST الذي تم تحريره باستخدام فئة `EmailSaveOptions`
...
demos:
    enable: true
    title: "OST عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير OST الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
