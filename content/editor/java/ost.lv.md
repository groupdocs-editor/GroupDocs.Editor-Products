...
############################# Head ############################
head_title: "OST redaktors — rediģējiet OST platformā Java"
head_description: "Kā rediģēt OST platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt OST platformā Java"
description: "Efektīva un stabila OST rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu OST programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt OST failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu OST
        * Izveidojiet un iestatiet klases gadījumu `EmailEditOptions' faila formātam OST
        * Izsauciet metodi "Editor.Edit()" un iegūstiet OST dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto OST failu, izmantojot klasi "EmailSaveOptions".
...
demos:
    enable: true
    title: "OST Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet OST tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
