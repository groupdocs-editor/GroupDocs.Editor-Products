...
############################# Head ############################
head_title: "Editor OST — Edite OST em Java"
head_description: "Como editar OST em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite OST em Java"
description: "Edição eficaz e robusta do OST usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar OST em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos OST usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho de arquivo obrigatório ou fluxo de bytes e carregue o arquivo OST
        * Crie e defina a instância da classe `EmailEditOptions` para o formato de arquivo OST
        * Chame o método `Editor.Edit()` e obtenha o documento OST em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo OST editado usando a classe `EmailSaveOptions`
...
demos:
    enable: true
    title: "OST Editor de demonstrações ao vivo"
    content: |
        Edite OST agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
