...
############################# Head ############################
head_title: "OST Editor — Redigera OST i Java"
head_description: "Hur redigerar man OST i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera OST i Java"
description: "Effektiv och robust OST-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera OST i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera OST-filerna med några rader kod.
        * Skapa en instans av klassen "Editor" med obligatorisk sökväg eller byteström och ladda OST-filen
        * Skapa och ställ in klassinstansen `EmailEditOptions` för filformatet OST
        * Anropa `Editor.Edit()`-metoden och skaffa OST-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade OST-filen med klassen `EmailSaveOptions`
...
demos:
    ...
    content: |
        Redigera OST just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
