...
############################# Head ############################
head_title: "OST Düzenleyici — OST öğesini Java içinde düzenleyin"
head_description: "OST, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "OST öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam OST düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde OST Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak OST dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışıyla bir "Editör" sınıfı örneği oluşturun ve OST dosyasını yükleyin
        * OST dosya biçimi için "EmailEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında OST belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve `EmailSaveOptions` sınıfını kullanarak düzenlenmiş OST dosyasını kaydedin
...
demos:
    enable: true
    title: "OST Editör Canlı Demoları"
    content: |
        OST dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
