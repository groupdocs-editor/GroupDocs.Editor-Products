...
head_description: "Hvordan redigerer man OTP i Java ved hjælp af et par linjer kode? Brug GroupDocs-dokumenter, der behandler API'er til at redigere, opdatere og gemme mere end 30 filformater."

############################# Header ############################
title: "Rediger OTP i Java"
description: "Effektiv og robust OTP redigering ved hjælp af serverside GroupDocs.Editor til Java API'er, uden brug af software som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trin til redigering af OTP i Java"
    content_left: |
        [GroupDocs.Editor for Java](/da/editor/java/) giver en nem og ligetil måde for udviklere at redigere OTP-filerne ved hjælp af et par linjer kode.
        * Opret en forekomst af `Editor`-klassen med obligatorisk filsti eller byte-stream og valgfri `PresentationLoadOptions`-klasse og indlæs OTP-filen
        * Opret og indstil klasseforekomsten `PresentationEditOptions` for filformatet OTP
        * Kald `Editor.Edit()`-metoden og få et OTP-dokument i HTML-format, der nemt kan redigeres med enhver WYSIWYG-editor.
        * Kald `Editor.Save()`-metoden og gem den redigerede OTP-fil ved hjælp af klassen `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Rediger OTP lige nu ved at besøge webstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
