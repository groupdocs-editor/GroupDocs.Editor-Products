...
############################# Head ############################
head_title: "OTP-Editor – Bearbeiten Sie OTP in Java"
head_description: "Wie bearbeite ich OTP in Java mit ein paar Zeilen Code? Verwenden Sie GroupDocs-APIs zur Dokumentenverarbeitung, um mehr als 30 Dateiformate zu bearbeiten, zu aktualisieren und zu speichern."

############################# Header ############################
title: "Bearbeiten Sie OTP in Java"
description: "Effektive und robuste OTP-Bearbeitung mit serverseitigem GroupDocs.Editor für Java-APIs, ohne die Verwendung von Software wie Microsoft oder Open Office."
...
steps:
    enable: true
    title_left: "Schritte zum Bearbeiten von OTP in Java"
    content_left: |
        [GroupDocs.Editor for Java](/de/editor/java/) bietet Entwicklern eine einfache und unkomplizierte Möglichkeit, die OTP-Dateien mit wenigen Codezeilen zu bearbeiten.
        * Erstellen Sie eine Instanz der Klasse „Editor“ mit obligatorischem Dateipfad oder Bytestream und optionaler Klasse „PresentationLoadOptions“ und laden Sie die Datei OTP
        * Erstellen und legen Sie die Klasseninstanz „PresentationEditOptions“ für das Dateiformat OTP fest
        * Rufen Sie die Methode `Editor.Edit()` auf und erhalten Sie ein OTP-Dokument im HTML-Format, das mit jedem WYSIWYG-Editor einfach bearbeitet werden kann.
        * Rufen Sie die Methode „Editor.Save()“ auf und speichern Sie die bearbeitete OTP-Datei mit der Klasse „PresentationSaveOptions“.
...
demos:
    ...
    content: |
        Bearbeiten Sie OTP jetzt, indem Sie die Website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) besuchen. Die Live-Demo hat die folgenden Vorteile
