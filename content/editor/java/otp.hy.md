...
############################# Head ############################
head_title: "OTP Խմբագիր — Խմբագրել OTP Java-ում"
head_description: "Ինչպե՞ս խմբագրել OTP-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել OTP-ը Java-ում"
description: "Արդյունավետ և ուժեղ OTP խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "OTP-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու OTP ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ՝ ֆայլի պարտադիր ճանապարհով կամ բայթ հոսքով և «PresentationLoadOptions» ընտրովի դասով և բեռնեք OTP ֆայլը:
        * Ստեղծեք և սահմանեք «PresentationEditOptions» դասի օրինակը OTP ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք OTP փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված OTP ֆայլը՝ օգտագործելով «PresentationSaveOptions» դասը:
...
demos:
    enable: true
    title: "OTP Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք OTP-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
