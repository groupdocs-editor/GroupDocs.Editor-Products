...
############################# Head ############################
head_title: "OTP redaktors — rediģējiet OTP platformā Java"
head_description: "Kā rediģēt OTP platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt OTP platformā Java"
description: "Efektīva un stabila OTP rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu OTP programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt OTP failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" gadījumu ar obligātu faila ceļu vai baitu straumi un neobligātu klasi "PresentationLoadOptions" un ielādējiet failu OTP.
        * Izveidojiet un iestatiet klases `PresentationEditOptions` instanci faila formātam OTP
        * Izsauciet metodi "Editor.Edit()" un iegūstiet OTP dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto OTP failu, izmantojot klasi "PresentationSaveOptions".
...
demos:
    enable: true
    title: "OTP Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet OTP tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
