...
############################# Head ############################
head_title: "OTP Editor — Redigera OTP i Java"
head_description: "Hur redigerar man OTP i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera OTP i Java"
description: "Effektiv och robust OTP-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera OTP i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera OTP-filerna med några rader kod.
        * Skapa en instans av klassen `Editor` med obligatorisk sökväg eller byteström och valfri klass `PresentationLoadOptions` och ladda OTP-filen
        * Skapa och ställ in klassinstansen `PresentationEditOptions` för filformatet OTP
        * Anropa `Editor.Edit()`-metoden och skaffa OTP-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade OTP-filen med klassen `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Redigera OTP just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
