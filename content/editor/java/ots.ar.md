...
############################# Head ############################
head_title: "OTS محرر - تحرير OTS في Java"
head_description: "كيفية تعديل OTS في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير OTS في Java"
description: "تحرير OTS فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل OTS في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات OTS باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق وفئة "SpreadsheetLoadOptions" الاختيارية وتحميل الملف OTS
        * إنشاء وتعيين مثيل فئة `SpreadsheetEditOptions` لتنسيق الملف OTS
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند OTS بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف OTS الذي تم تحريره باستخدام فئة `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "OTS عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير OTS الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
