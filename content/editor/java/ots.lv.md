...
############################# Head ############################
head_title: "OTS redaktors — rediģējiet OTS platformā Java"
head_description: "Kā rediģēt OTS platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt OTS platformā Java"
description: "Efektīva un stabila OTS rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu OTS programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt OTS failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi "SpreadsheetLoadOptions" un ielādējiet failu OTS
        * Izveidojiet un iestatiet klases `SpreadsheetEditOptions` instanci faila formātam OTS
        * Izsauciet metodi "Editor.Edit()" un iegūstiet OTS dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto OTS failu, izmantojot klasi "SpreadsheetSaveOptions"
...
demos:
    enable: true
    title: "OTS Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet OTS tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
