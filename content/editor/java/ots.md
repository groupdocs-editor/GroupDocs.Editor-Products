...
############################# Head ############################
head_title: "OTS Editor — Edit OTS in Java"
head_description: "How to edit OTS in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit OTS in Java"
description: "Effective and robust OTS editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit OTS in Java"
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the OTS files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or stream and optional `SpreadsheetLoadOptions` class and load the OTS file
        * Create & set the `SpreadsheetEditOptions` class instance for the OTS file format
        * Call `Editor.Edit()` method and obtain OTS document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited OTS file using `SpreadsheetSaveOptions` class
