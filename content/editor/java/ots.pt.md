...
############################# Head ############################
head_title: "Editor OTS — Edite OTS em Java"
head_description: "Como editar OTS em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite OTS em Java"
description: "Edição eficaz e robusta do OTS usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar OTS em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos OTS usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `SpreadsheetLoadOptions` e carregue o arquivo OTS
        * Crie e defina a instância de classe `SpreadsheetEditOptions` para o formato de arquivo OTS
        * Chame o método `Editor.Edit()` e obtenha o documento OTS em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo OTS editado usando a classe `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "OTS Editor de demonstrações ao vivo"
    content: |
        Edite OTS agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
