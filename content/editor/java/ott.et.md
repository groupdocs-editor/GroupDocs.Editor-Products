...
############################# Head ############################
head_title: "OTT redaktor – muutke OTT platvormil Java"
head_description: "Kuidas muuta OTT platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda OTT platvormil Java"
description: "Tõhus ja jõuline OTT redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud OTT muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi OTT failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "WordProcessingLoadOptions" ja laadige fail OTT
        * Looge ja määrake failivormingule OTT klassi eksemplar "WordProcessingEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument OTT, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail OTT klassi "WordProcessingSaveOptions" abil
...
demos:
    enable: true
    title: "OTT Reaalajas demode toimetaja"
    content: |
        Muutke OTT kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
