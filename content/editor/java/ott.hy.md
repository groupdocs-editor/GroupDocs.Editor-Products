...
############################# Head ############################
head_title: "OTT Խմբագիր — Խմբագրել OTT Java-ում"
head_description: "Ինչպե՞ս խմբագրել OTT-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել OTT-ը Java-ում"
description: "Արդյունավետ և ուժեղ OTT խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "OTT-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու OTT ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ ֆայլի պարտադիր ուղով կամ հոսքով և ընտրովի «WordProcessingLoadOptions» դասով և բեռնեք OTT ֆայլը:
        * Ստեղծեք և սահմանեք «WordProcessingEditOptions» դասի օրինակը OTT ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք OTT փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված OTT ֆայլը՝ օգտագործելով «WordProcessingSaveOptions» դասը
...
demos:
    enable: true
    title: "OTT Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք OTT-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
