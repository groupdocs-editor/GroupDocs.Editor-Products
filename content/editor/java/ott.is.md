...
############################# Head ############################
head_title: "OTT Ritstjóri — Breyta OTT í Java"
head_description: "Hvernig á að breyta OTT í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta OTT í Java"
description: "Árangursrík og öflug OTT breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta OTT í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta OTT skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `WordProcessingLoadOptions` flokki og hlaðið OTT skránni
        * Búðu til og stilltu `WordProcessingEditOptions` flokkatilvikið fyrir OTT skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu OTT skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta OTT skrá með `WordProcessingSaveOptions` flokki
...
demos:
    enable: true
    title: "OTT Ritstjóri Live kynningar"
    content: |
        Breyttu OTT núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
