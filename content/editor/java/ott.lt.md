...
############################# Head ############################
head_title: "OTT redaktorius – redaguoti OTT Java"
head_description: "Kaip redaguoti OTT Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti OTT Java"
description: "Efektyvus ir patikimas OTT redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti OTT Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti OTT failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba srautu ir pasirenkama „WordProcessingLoadOptions“ klase ir įkelkite failą OTT
        * Sukurkite ir nustatykite „WordProcessingEditOptions“ klasės egzempliorių failo formatui OTT
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite OTT dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą OTT failą naudodami klasę „WordProcessingSaveOptions“
...
demos:
    enable: true
    title: "OTT Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite OTT dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
