...
############################# Head ############################
head_title: "OTT redaktors — rediģējiet OTT platformā Java"
head_description: "Kā rediģēt OTT platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt OTT platformā Java"
description: "Efektīva un stabila OTT rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu OTT programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt OTT failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi WordProcessingLoadOptions un ielādējiet failu OTT.
        * Izveidojiet un iestatiet klases `WordProcessingEditOptions` instanci faila formātam OTT
        * Izsauciet metodi "Editor.Edit()" un iegūstiet OTT dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto OTT failu, izmantojot klasi "WordProcessingSaveOptions"
...
demos:
    enable: true
    title: "OTT Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet OTT tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
