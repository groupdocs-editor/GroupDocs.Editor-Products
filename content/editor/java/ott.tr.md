...
############################# Head ############################
head_title: "OTT Düzenleyici — OTT öğesini Java içinde düzenleyin"
head_description: "OTT, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "OTT öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam OTT düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde OTT Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak OTT dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
