...
############################# Head ############################
head_title: "Editor POT — Editați POT în Java"
head_description: "Cum se editează POT în Java folosind câteva rânduri de cod? Utilizați API-urile de procesare a documentelor GroupDocs pentru a edita, actualiza și salva peste 30 de formate de fișiere."

############################# Header ############################
title: "Editați POT în Java"
description: "Editare POT eficientă și robustă folosind GroupDocs.Editor pe partea de server pentru API-urile Java, fără utilizarea vreunui software precum Microsoft sau Open Office."
...
steps:
    enable: true
    title_left: "Pași pentru a edita POT în Java"
    content_left: |
        [GroupDocs.Editor for Java](/ro/editor/java/) oferă dezvoltatorilor o modalitate simplă și simplă de a edita fișierele POT folosind câteva rânduri de cod.
        * Creați o instanță a clasei `Editor` cu calea fișierului obligatorie sau fluxul de octeți și clasa opțională `PresentationLoadOptions` și încărcați fișierul POT
        * Creați și setați instanța clasei `PresentationEditOptions` pentru formatul de fișier POT
        * Apelați metoda `Editor.Edit()` și obțineți documentul POT în format HTML care este ușor de editat cu orice editor WYSIWYG.
        * Apelați metoda `Editor.Save()` și salvați fișierul editat POT folosind clasa `PresentationSaveOptions`
...
demos:
    enable: true
    title: "POT Editor Demo live"
    content: |
        Editați POT chiar acum, vizitând site-ul [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
