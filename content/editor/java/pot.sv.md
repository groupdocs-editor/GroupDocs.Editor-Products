...
############################# Head ############################
head_title: "POT Editor — Redigera POT i Java"
head_description: "Hur redigerar man POT i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera POT i Java"
description: "Effektiv och robust POT-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera POT i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera POT-filerna med några rader kod.
        * Skapa en instans av klassen `Editor` med obligatorisk sökväg eller byteström och valfri klass `PresentationLoadOptions` och ladda POT-filen
        * Skapa och ställ in klassinstansen `PresentationEditOptions` för filformatet POT
        * Anropa `Editor.Edit()`-metoden och skaffa POT-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade POT-filen med klassen `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Redigera POT just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
