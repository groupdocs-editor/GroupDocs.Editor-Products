...
head_title: "POTM Editor untuk Java – Edit POTM"
head_description: "Edit POTM di Java menggunakan beberapa baris kode. API editor dokumen yang cepat dan tangguh untuk 30+ format file."

title: "Edit POTM di Jawa"
description: "Editor POTM yang andal dan cepat untuk aplikasi Java Anda tanpa perangkat lunak pihak ketiga seperti Microsoft Office atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah Mengedit POTM di Java"
    content_left: |
        [GroupDocs.Editor](/id/editor/java/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file POTM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file POTM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file POTM
        * Panggil metode Editor.edit dan dapatkan dokumen POTM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggilan Editor.save metode dan simpan file POTM yang diedit
    ...
    code: |
        ```java
        // Muat file POTM ke Editor
        Editor editor = new Editor("source.potm");
        
        // Buka masukan POTM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.edit();

        // Ambil konten dokumen POTM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.getContent();

        // Perbarui konten dokumen POTM dengan cara tertentu
        string updatedContent = content.replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.fromMarkup(updatedContent, null);

        // Simpan dokumen POTM yang telah diedit
        editor.save(afterEdit, "edited.potm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor POTM"
    content: |
        Edit POTM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family).  
