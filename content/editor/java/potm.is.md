...
############################# Head ############################
head_title: "POTM Ritstjóri — Breyta POTM í Java"
head_description: "Hvernig á að breyta POTM í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta POTM í Java"
description: "Árangursrík og öflug POTM breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta POTM í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta POTM skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og valfrjálsum `PresentationLoadOptions` flokki og hlaðið POTM skránni
        * Búðu til og stilltu `PresentationEditOptions` flokkstilvikið fyrir POTM skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu POTM skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta POTM skrá með `PresentationSaveOptions` flokki
...
demos:
    enable: true
    title: "POTM Ritstjóri Live kynningar"
    content: |
        Breyttu POTM núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
