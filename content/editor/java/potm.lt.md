...
############################# Head ############################
head_title: "POTM redaktorius – redaguoti POTM Java"
head_description: "Kaip redaguoti POTM Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti POTM Java"
description: "Efektyvus ir patikimas POTM redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti POTM Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti POTM failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba baitų srautu ir pasirenkama „PresentationLoadOptions“ klase ir įkelkite failą POTM
        * Sukurkite ir nustatykite „PresentationEditOptions“ klasės egzempliorių failo formatui POTM
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite POTM dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą POTM failą naudodami klasę „PresentationSaveOptions“
...
demos:
    enable: true
    title: "POTM Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite POTM dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
