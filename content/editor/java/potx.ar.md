...
############################# Head ############################
head_title: "POTX محرر - تحرير POTX في Java"
head_description: "كيفية تعديل POTX في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير POTX في Java"
description: "تحرير POTX فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل POTX في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات POTX باستخدام بضعة أسطر من التعليمات البرمجية.
        * إنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق بايت وفئة اختيارية "PresentationLoadOptions" وتحميل الملف POTX
        * قم بإنشاء وتعيين مثيل فئة `PresentationEditOptions` لتنسيق الملف POTX
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند POTX بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * قم باستدعاء طريقة `Editor.Save ()` واحفظ الملف POTX المحرر باستخدام فئة `PresentationSaveOptions`
...
demos:
    enable: true
    title: "POTX عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير POTX الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
