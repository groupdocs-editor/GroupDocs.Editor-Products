...
############################# Head ############################
head_title: "POTX redaktors — rediģējiet POTX platformā Java"
head_description: "Kā rediģēt POTX platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt POTX platformā Java"
description: "Efektīva un stabila POTX rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu POTX programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt POTX failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" gadījumu ar obligātu faila ceļu vai baitu straumi un neobligātu klasi "PresentationLoadOptions" un ielādējiet failu POTX.
        * Izveidojiet un iestatiet klases `PresentationEditOptions` instanci faila formātam POTX
        * Izsauciet metodi "Editor.Edit()" un iegūstiet POTX dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto POTX failu, izmantojot klasi "PresentationSaveOptions".
...
demos:
    enable: true
    title: "POTX Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet POTX tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
