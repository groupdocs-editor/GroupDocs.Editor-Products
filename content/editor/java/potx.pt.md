...
############################# Head ############################
head_title: "Editor POTX — Edite POTX em Java"
head_description: "Como editar POTX em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite POTX em Java"
description: "Edição eficaz e robusta do POTX usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar POTX em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos POTX usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho de arquivo obrigatório ou fluxo de bytes e classe opcional `PresentationLoadOptions` e carregue o arquivo POTX
        * Crie e defina a instância de classe `PresentationEditOptions` para o formato de arquivo POTX
        * Chame o método `Editor.Edit()` e obtenha o documento POTX em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo POTX editado usando a classe `PresentationSaveOptions`
...
demos:
    enable: true
    title: "POTX Editor de demonstrações ao vivo"
    content: |
        Edite POTX agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
