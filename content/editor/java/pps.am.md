...
############################# Head ############################
head_title: "PPS አርታዒ — PPSን በJava አርትዕ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም PPSን በJava ውስጥ እንዴት ማስተካከል ይቻላል? 30+ የፋይል ቅርጸቶችን ለማርትዕ፣ ለማዘመን እና ለማስቀመጥ GroupDocs ሰነዶችን የሚያስኬዱ ኤፒአይዎችን ይጠቀሙ።"

############################# Header ############################
title: "PPSን በJava ውስጥ ያርትዑ"
description: "ውጤታማ እና ጠንካራ PPS አርትዖት የአገልጋይ ጎን GroupDocs.Editor ለJava APIs፣ እንደ Microsoft ወይም Open Office ያሉ ሶፍትዌሮችን ሳይጠቀም።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ PPSን ለማርትዕ ደረጃዎች"
    content_left: |
        [GroupDocs.Editor for Java](/am/አርታዒ/java/) ገንቢዎች ጥቂት የኮድ መስመሮችን በመጠቀም PPS ፋይሎችን እንዲያርትዑ ቀላል እና ቀጥተኛ መንገድን ይሰጣል።
        * የግዴታ የፋይል ዱካ ወይም ባይት ዥረት እና አማራጭ `PresentationLoadOptions` ክፍል ያለው የ«አርታዒ» ክፍልን ይፍጠሩ እና PPS ፋይሉን ይጫኑ
        * ለPPS ፋይል ቅርጸት የ‹PresentationEditOptions› ክፍልን ይፍጠሩ እና ያቀናብሩ
        * ወደ `Editor.Edit()` ዘዴ ይደውሉ እና በማንኛውም WYSIWYG-አርታዒ በቀላሉ የሚስተካከል PPS ሰነድ በኤችቲኤምኤል ቅርጸት ያግኙ።
        * የ‹Editor.Save()› ዘዴን ይደውሉ እና የ‹PresentationSaveOptions› ክፍልን በመጠቀም የተስተካከለውን PPS ፋይል ያስቀምጡ።
...
demos:
    enable: true
    title: "PPS የቀጥታ ማሳያዎች አርታዒ"
    content: |
        የ[GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) ድር ጣቢያን በመጎብኘት አሁኑኑ PPSን ያርትዑ።
