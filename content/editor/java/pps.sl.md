...
############################# Head ############################
head_title: "Urejevalnik PPS — uredi PPS v Java"
head_description: "Kako urediti PPS v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi PPS v Java"
description: "Učinkovito in robustno urejanje PPS z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje PPS v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek PPS z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo do datoteke ali tokom bajtov in neobveznim razredom `PresentationLoadOptions` ter naložite datoteko PPS
        * Ustvarite in nastavite primerek razreda `PresentationEditOptions` za obliko datoteke PPS
        * Pokličite metodo `Editor.Edit()` in pridobite dokument PPS v formatu HTML, ki ga je mogoče enostavno urejati s katerim koli urejevalnikom WYSIWYG.
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko PPS z uporabo razreda `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Takoj uredite PPS tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
