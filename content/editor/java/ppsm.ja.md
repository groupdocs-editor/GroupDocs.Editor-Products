...
head_title: "PPSM Editor for Java –PPSMを編集します"
head_description: "数行のコードを使用して、JavaでPPSMを編集します。 30以上のファイル形式用の高速で堅牢なドキュメントエディタAPI."

title: "JavaでPPSMを編集する"
description: "MicrosoftOfficeやOpenOfficeなどのサードパーティソフトウェアを使用しない、Javaアプリケーション用の強力で高速なPPSMエディタ."
...
steps:
    enable: true
    title_left: "JavaでPPSMを編集する手順"
    content_left: |
        [GroupDocs.Editor](/editor/java/)は、開発者が数行のコードを使用してPPSMファイルを編集するための簡単で簡単な方法を提供します。
