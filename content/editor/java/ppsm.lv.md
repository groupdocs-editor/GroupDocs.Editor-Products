...
############################# Head ############################
head_title: "PPSM redaktors — rediģējiet PPSM platformā Java"
head_description: "Kā rediģēt PPSM platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt PPSM platformā Java"
description: "Efektīva un stabila PPSM rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu PPSM programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt PPSM failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" gadījumu ar obligātu faila ceļu vai baitu straumi un neobligātu klasi "PresentationLoadOptions" un ielādējiet failu PPSM.
        * Izveidojiet un iestatiet klases `PresentationEditOptions` instanci faila formātam PPSM
        * Izsauciet metodi "Editor.Edit()" un iegūstiet PPSM dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto PPSM failu, izmantojot klasi "PresentationSaveOptions".
...
demos:
    enable: true
    title: "PPSM Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet PPSM tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
