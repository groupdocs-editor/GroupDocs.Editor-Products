...
############################# Head ############################
head_title: "PPSM Editor — Bewerk PPSM in Java"
head_description: "Hoe bewerk je PPSM in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk PPSM in Java"
description: "Effectieve en robuuste PPSM bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om PPSM te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de PPSM-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of bytestream en optionele klasse 'PresentationLoadOptions' en laad het bestand PPSM
        * Maak en stel de klasse-instantie 'PresentationEditOptions' in voor de bestandsindeling PPSM
        * Roep de `Editor.Edit()` methode aan en verkrijg een PPSM document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de methode 'Editor.Save()' aan en sla het bewerkte PPSM-bestand op met de klasse 'PresentationSaveOptions'
...
demos:
    enable: true
    title: "PPSM Editor Live demo's"
    content: |
        Bewerk PPSM nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
