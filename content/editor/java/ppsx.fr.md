...
############################# Head ############################
head_title: "Éditeur PPSX : modifiez PPSX dans Java"
head_description: "Comment modifier PPSX dans Java en utilisant quelques lignes de code ? Utilisez les API de traitement de documents GroupDocs pour modifier, mettre à jour et enregistrer plus de 30 formats de fichiers."

############################# Header ############################
title: "Modifier PPSX dans Java"
description: "Édition PPSX efficace et robuste à l'aide de GroupDocs.Editor côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Étapes pour modifier PPSX dans Java"
    content_left: |
        [GroupDocs.Editor for Java](/fr/editor/java/) offre aux développeurs un moyen simple et direct de modifier les fichiers PPSX à l'aide de quelques lignes de code.
        * Créez une instance de la classe `Editor` avec un chemin de fichier obligatoire ou un flux d'octets et une classe facultative `PresentationLoadOptions` et chargez le fichier PPSX
        * Créer et définir l'instance de classe `PresentationEditOptions` pour le format de fichier PPSX
        * Appelez la méthode `Editor.Edit()` et obtenez le document PPSX au format HTML facilement modifiable avec n'importe quel éditeur WYSIWYG.
        * Appelez la méthode `Editor.Save()` et enregistrez le fichier PPSX modifié à l'aide de la classe `PresentationSaveOptions`
...
demos:
    enable: true
    title: "PPSX démos en direct de l'éditeur"
    content: |
        Modifiez PPSX dès maintenant en visitant le site Web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
