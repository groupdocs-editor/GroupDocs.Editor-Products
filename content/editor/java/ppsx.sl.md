...
############################# Head ############################
head_title: "Urejevalnik PPSX — uredi PPSX v Java"
head_description: "Kako urediti PPSX v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi PPSX v Java"
description: "Učinkovito in robustno urejanje PPSX z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje PPSX v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek PPSX z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo do datoteke ali tokom bajtov in neobveznim razredom `PresentationLoadOptions` ter naložite datoteko PPSX
        * Ustvarite in nastavite primerek razreda `PresentationEditOptions` za obliko datoteke PPSX
        * Pokličite metodo `Editor.Edit()` in pridobite dokument PPSX v formatu HTML, ki ga je mogoče enostavno urejati s katerim koli urejevalnikom WYSIWYG.
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko PPSX z uporabo razreda `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Takoj uredite PPSX tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
