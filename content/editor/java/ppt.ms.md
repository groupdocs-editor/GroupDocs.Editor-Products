...
############################# Head ############################
head_title: "PPT Editor — Edit PPT dalam Java"
head_description: "Bagaimana untuk mengedit PPT dalam Java menggunakan beberapa baris kod? Gunakan API pemprosesan dokumen GroupDocs untuk mengedit, mengemas kini dan menyimpan 30+ format fail."

############################# Header ############################
title: "Edit PPT dalam Java"
description: "Pengeditan PPT yang berkesan dan mantap menggunakan GroupDocs.Editor sebelah pelayan untuk API Java, tanpa menggunakan sebarang perisian seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit PPT dalam Java"
    content_left: |
        [GroupDocs.Editor for Java](/ms/editor/java/) menyediakan cara yang mudah dan mudah untuk pembangun mengedit fail PPT menggunakan beberapa baris kod.
        * Buat contoh kelas `Editor` dengan laluan fail mandatori atau strim bait dan kelas `PresentationLoadOptions` pilihan dan muatkan fail PPT
        * Cipta & tetapkan contoh kelas `PresentationEditOptions` untuk format fail PPT
        * Panggil kaedah `Editor.Edit()` dan dapatkan PPT dokumen dalam format HTML yang boleh diedit dengan mudah dengan mana-mana editor WYSIWYG.
        * Panggil kaedah `Editor.Save()` dan simpan fail PPT yang diedit menggunakan kelas `PresentationSaveOptions`
...
demos:
    enable: true
    title: "PPT Demo Langsung Editor"
    content: |
        Edit PPT sekarang dengan melawati tapak web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
