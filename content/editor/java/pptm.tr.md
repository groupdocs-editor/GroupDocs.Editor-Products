...
############################# Head ############################
head_title: "PPTM Düzenleyici — PPTM öğesini Java içinde düzenleyin"
head_description: "PPTM, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "PPTM öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam PPTM düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde PPTM Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak PPTM dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışı ve isteğe bağlı "PresentationLoadOptions" sınıfı ile bir "Editor" sınıfı örneği oluşturun ve PPTM dosyasını yükleyin
        * PPTM dosya biçimi için "PresentationEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında PPTM belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve düzenlenen PPTM dosyasını `PresentationSaveOptions` sınıfını kullanarak kaydedin
...
demos:
    enable: true
    title: "PPTM Editör Canlı Demoları"
    content: |
        PPTM dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
