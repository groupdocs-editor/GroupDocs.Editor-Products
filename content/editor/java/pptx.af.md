...
############################# Head ############################
head_title: "PPTX-redigeerder — Wysig PPTX in Java"
head_description: "Hoe om PPTX in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig PPTX in Java"
description: "Effektiewe en robuuste PPTX redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om PPTX in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die PPTX lêers te wysig deur 'n paar reëls kode te gebruik.
