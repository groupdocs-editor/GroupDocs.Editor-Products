...
############################# Head ############################
head_title: "PPTX Editor — Uredite PPTX u Java"
head_description: "Kako urediti PPTX u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi PPTX u Java"
description: "Učinkovito i robusno PPTX uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje PPTX u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka PPTX pomoću nekoliko redaka koda.
        * Stvorite instancu klase `Uređivač` s obaveznim putem datoteke ili tokom bajtova i izbornom klasom `PresentationLoadOptions` i učitajte datoteku PPTX
        * Stvorite i postavite instancu klase `PresentationEditOptions` za format datoteke PPTX
        * Pozovite metodu `Editor.Edit()` i dobijte PPTX dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu datoteku PPTX pomoću klase `PresentationSaveOptions`
...
demos:
    enable: true
    title: "PPTX Demonstracije uređivača uživo"
    content: |
        Uredite PPTX odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
