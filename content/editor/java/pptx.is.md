...
############################# Head ############################
head_title: "PPTX Ritstjóri — Breyta PPTX í Java"
head_description: "Hvernig á að breyta PPTX í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta PPTX í Java"
description: "Árangursrík og öflug PPTX breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta PPTX í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta PPTX skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og valfrjálsum `PresentationLoadOptions` flokki og hlaðið PPTX skránni
        * Búðu til og stilltu `PresentationEditOptions` flokkstilvikið fyrir PPTX skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu PPTX skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta PPTX skrá með `PresentationSaveOptions` flokki
...
demos:
    enable: true
    title: "PPTX Ritstjóri Live kynningar"
    content: |
        Breyttu PPTX núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
