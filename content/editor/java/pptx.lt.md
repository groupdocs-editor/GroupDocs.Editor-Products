...
############################# Head ############################
head_title: "PPTX redaktorius – redaguoti PPTX Java"
head_description: "Kaip redaguoti PPTX Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti PPTX Java"
description: "Efektyvus ir patikimas PPTX redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti PPTX Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti PPTX failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba baitų srautu ir pasirenkama „PresentationLoadOptions“ klase ir įkelkite failą PPTX
        * Sukurkite ir nustatykite „PresentationEditOptions“ klasės egzempliorių failo formatui PPTX
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite PPTX dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą PPTX failą naudodami klasę „PresentationSaveOptions“
...
demos:
    enable: true
    title: "PPTX Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite PPTX dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
