...
############################# Head ############################
head_title: "PST-redigeerder — Wysig PST in Java"
head_description: "Hoe om PST in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig PST in Java"
description: "Effektiewe en robuuste PST redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om PST in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die PST lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die PST-lêer
        * Skep en stel die `EmailEditOptions`-klasinstansie vir die PST-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry PST-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde PST-lêer met `EmailSaveOptions`-klas
...
demos:
    enable: true
    title: "PST Redigeerder Regstreekse Demo's"
    content: |
        Wysig PST op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
