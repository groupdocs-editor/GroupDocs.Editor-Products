...
############################# Head ############################
head_title: "PST محرر - تحرير PST في Java"
head_description: "كيفية تعديل PST في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير PST في Java"
description: "تحرير PST فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل PST في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات PST باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف PST
        * إنشاء وتعيين مثيل فئة "EmailEditOptions" لتنسيق الملف PST
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند PST بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع طريقة `Editor.Save ()` واحفظ الملف PST الذي تم تحريره باستخدام فئة `EmailSaveOptions`
...
demos:
    enable: true
    title: "PST عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير PST الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
