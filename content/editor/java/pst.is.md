...
############################# Head ############################
head_title: "PST Ritstjóri — Breyta PST í Java"
head_description: "Hvernig á að breyta PST í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta PST í Java"
description: "Árangursrík og öflug PST breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta PST í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta PST skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið PST skránni
        * Búðu til og stilltu `EmailEditOptions` flokkstilvikið fyrir PST skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu PST skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta PST skrá með `EmailSaveOptions` flokki
...
demos:
    enable: true
    title: "PST Ritstjóri Live kynningar"
    content: |
        Breyttu PST núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
