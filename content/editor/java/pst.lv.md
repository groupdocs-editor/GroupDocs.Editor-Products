...
############################# Head ############################
head_title: "PST redaktors — rediģējiet PST platformā Java"
head_description: "Kā rediģēt PST platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt PST platformā Java"
description: "Efektīva un stabila PST rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu PST programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt PST failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu PST
        * Izveidojiet un iestatiet klases gadījumu `EmailEditOptions' faila formātam PST
        * Izsauciet metodi "Editor.Edit()" un iegūstiet PST dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto PST failu, izmantojot klasi "EmailSaveOptions".
...
demos:
    enable: true
    title: "PST Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet PST tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
