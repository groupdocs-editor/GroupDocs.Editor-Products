...
############################# Head ############################
head_title: "PST Editor — Redigera PST i Java"
head_description: "Hur redigerar man PST i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera PST i Java"
description: "Effektiv och robust PST-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera PST i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera PST-filerna med några rader kod.
        * Skapa en instans av klassen "Editor" med obligatorisk sökväg eller byteström och ladda PST-filen
        * Skapa och ställ in klassinstansen `EmailEditOptions` för filformatet PST
        * Anropa `Editor.Edit()`-metoden och skaffa PST-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade PST-filen med klassen `EmailSaveOptions`
...
demos:
    ...
    content: |
        Redigera PST just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
