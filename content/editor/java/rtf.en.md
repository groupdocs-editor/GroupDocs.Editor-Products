...
############################# Head ############################
head_title: "RTF Editor — Edit RTF in Java"
head_description: "How to edit RTF in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit RTF in Java"
description: "Effective and robust RTF editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the RTF files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or stream and optional `WordProcessingLoadOptions` class and load the RTF file
        * Create & set the `WordProcessingEditOptions` class instance for the RTF file format
        * Call `Editor.Edit()` method and obtain RTF document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited RTF file using `WordProcessingSaveOptions` class
