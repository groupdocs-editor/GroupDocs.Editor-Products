...
############################# Head ############################
head_title: "RTF Ritstjóri — Breyta RTF í Java"
head_description: "Hvernig á að breyta RTF í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta RTF í Java"
description: "Árangursrík og öflug RTF breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta RTF í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta RTF skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `WordProcessingLoadOptions` flokki og hlaðið RTF skránni
        * Búðu til og stilltu `WordProcessingEditOptions` flokkatilvikið fyrir RTF skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu RTF skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta RTF skrá með `WordProcessingSaveOptions` flokki
...
demos:
    enable: true
    title: "RTF Ritstjóri Live kynningar"
    content: |
        Breyttu RTF núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
