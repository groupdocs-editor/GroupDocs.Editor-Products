...
steps:
    enable: true
    title_left: "Кроки по редагуванню RTF на Java"
    content_left: |
        [GroupDocs.Editor for Java](/uk/editor/java/) надає розробникам простий і зрозумілий спосіб редагування файлів RTF за допомогою кількох рядків коду.
