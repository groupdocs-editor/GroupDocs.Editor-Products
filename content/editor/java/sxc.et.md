...
############################# Head ############################
head_title: "SXC redaktor – muutke SXC platvormil Java"
head_description: "Kuidas muuta SXC platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda SXC platvormil Java"
description: "Tõhus ja jõuline SXC redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud SXC muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi SXC failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "SpreadsheetLoadOptions" ja laadige fail SXC
        * Looge ja määrake failivormingu SXC klassi eksemplar "SpreadsheetEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument SXC, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail SXC klassi `SpreadsheetSaveOptions' abil
...
demos:
    enable: true
    title: "SXC Reaalajas demode toimetaja"
    content: |
        Muutke SXC kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
