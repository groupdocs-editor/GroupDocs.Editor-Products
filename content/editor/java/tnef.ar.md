...
############################# Head ############################
head_title: "TNEF محرر - تحرير TNEF في Java"
head_description: "كيفية تعديل TNEF في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير TNEF في Java"
description: "تحرير TNEF فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل TNEF في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات TNEF باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف TNEF
        * إنشاء وتعيين مثيل فئة "EmailEditOptions" لتنسيق الملف TNEF
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند TNEF بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع طريقة `Editor.Save ()` واحفظ الملف TNEF الذي تم تحريره باستخدام فئة `EmailSaveOptions`
...
demos:
    enable: true
    title: "TNEF عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير TNEF الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
