...
############################# Head ############################
head_title: "TNEF Editor — Uredite TNEF u Java"
head_description: "Kako urediti TNEF u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi TNEF u Java"
description: "Učinkovito i robusno TNEF uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje TNEF u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka TNEF pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznom stazom datoteke ili tokom bajtova i učitajte datoteku TNEF
        * Stvorite i postavite instancu klase `EmailEditOptions` za format datoteke TNEF
        * Pozovite metodu `Editor.Edit()` i dobijte TNEF dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu datoteku TNEF pomoću klase `EmailSaveOptions`
...
demos:
    enable: true
    title: "TNEF Demonstracije uređivača uživo"
    content: |
        Uredite TNEF odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
