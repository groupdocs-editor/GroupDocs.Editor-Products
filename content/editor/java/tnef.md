...
############################# Head ############################
head_title: "TNEF Editor — Edit TNEF in Java"
head_description: "How to edit TNEF in Java using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit TNEF in Java"
description: "Effective and robust TNEF editing using server side GroupDocs.Editor for Java APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit TNEF in Java"
    content_left: |
        [GroupDocs.Editor for Java](/editor/java/) provides an easy and straightforward way for developers to edit the TNEF files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or byte stream and load the TNEF file
        * Create & set the `EmailEditOptions` class instance for the TNEF file format
        * Call `Editor.Edit()` method and obtain TNEF document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited TNEF file using `EmailSaveOptions` class
...
demos:
    ...
    content: |
        Edit TNEF right now by visiting [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) website.  
