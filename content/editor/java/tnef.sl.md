...
############################# Head ############################
head_title: "Urejevalnik TNEF — uredi TNEF v Java"
head_description: "Kako urediti TNEF v Java z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi TNEF v Java"
description: "Učinkovito in robustno urejanje TNEF z API-ji GroupDocs.Editor na strežniški strani za Java, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje TNEF v Java"
    content_left: |
        [GroupDocs.Editor for Java](/sl/editor/java/) ponuja razvijalcem enostaven in preprost način za urejanje datotek TNEF z uporabo nekaj vrstic kode.
        * Ustvarite primerek razreda `Urejevalnik` z obvezno potjo datoteke ali tokom bajtov in naložite datoteko TNEF
        * Ustvarite in nastavite primerek razreda `EmailEditOptions` za obliko datoteke TNEF
        * Pokličite metodo `Editor.Edit()` in pridobite dokument TNEF v formatu HTML, ki ga je mogoče enostavno urejati s katerim koli urejevalnikom WYSIWYG.
        * Pokličite metodo `Editor.Save()` in shranite urejeno datoteko TNEF z uporabo razreda `EmailSaveOptions`
...
demos:
    ...
    content: |
        Takoj uredite TNEF tako, da obiščete spletno mesto [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
