...
############################# Head ############################
head_title: "TSV Խմբագիր — Խմբագրել TSV Java-ում"
head_description: "Ինչպե՞ս խմբագրել TSV-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել TSV-ը Java-ում"
description: "Արդյունավետ և ուժեղ TSV խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "TSV-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու TSV ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ՝ ֆայլի պարտադիր ուղով կամ բայթ հոսքով և բեռնեք TSV ֆայլը
        * Ստեղծեք «DelimitedTextEditOptions» դասի օրինակը TSV ֆայլի ձևաչափի համար և նշեք պարտադիր տողերի բաժանարար կոնստրուկտորում:
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք TSV փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված TSV ֆայլը՝ օգտագործելով «DelimitedTextSaveOptions» դասի օրինակը ցանկալի բաժանիչով:
...
demos:
    enable: true
    title: "TSV Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք TSV-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
