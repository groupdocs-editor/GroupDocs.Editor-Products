...
############################# Head ############################
head_title: "TXT Ritstjóri — Breyta TXT í Java"
head_description: "Hvernig á að breyta TXT í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta TXT í Java"
description: "Árangursrík og öflug TXT breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta TXT í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta TXT skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða bætistraumi og hlaðið TXT skránni
        * Búðu til og stilltu `TextEditOptions` flokkatilvikið fyrir TXT skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu TXT skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta TXT skrá með `TextSaveOptions` flokki
...
demos:
    enable: true
    title: "TXT Ritstjóri Live kynningar"
    content: |
        Breyttu TXT núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
