...
############################# Head ############################
head_title: "TXT redaktorius – redaguoti TXT Java"
head_description: "Kaip redaguoti TXT Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti TXT Java"
description: "Efektyvus ir patikimas TXT redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti TXT Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti TXT failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba baitų srautu ir įkelkite failą TXT
        * Sukurkite ir nustatykite „TextEditOptions“ klasės egzempliorių failo formatui TXT
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite TXT dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą TXT failą naudodami klasę „TextSaveOptions“
...
demos:
    enable: true
    title: "TXT Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite TXT dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
