...
############################# Head ############################
head_title: "TXT redaktors — rediģējiet TXT platformā Java"
head_description: "Kā rediģēt TXT platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt TXT platformā Java"
description: "Efektīva un stabila TXT rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu TXT programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt TXT failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu TXT
        * Izveidojiet un iestatiet klases `TextEditOptions` gadījumu faila formātam TXT
        * Izsauciet metodi "Editor.Edit()" un iegūstiet TXT dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto TXT failu, izmantojot klasi "TextSaveOptions".
...
demos:
    enable: true
    title: "TXT Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet TXT tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
