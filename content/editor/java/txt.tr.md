...
############################# Head ############################
head_title: "TXT Düzenleyici — TXT öğesini Java içinde düzenleyin"
head_description: "TXT, birkaç satır kod kullanarak Java içinde nasıl düzenlenir? 30'dan fazla dosya biçimini düzenlemek, güncellemek ve kaydetmek için API'leri işleyen GroupDocs belgelerini kullanın."

############################# Header ############################
title: "TXT öğesini Java içinde düzenleyin"
description: "Microsoft veya Open Office gibi herhangi bir yazılım kullanmadan Java API'leri için sunucu tarafı GroupDocs.Editor kullanarak etkili ve sağlam TXT düzenleme."
...
steps:
    enable: true
    title_left: "Java içinde TXT Düzenleme Adımları"
    content_left: |
        [GroupDocs.Editor for Java](/tr/editor/java/), geliştiricilerin birkaç satır kod kullanarak TXT dosyalarını düzenlemeleri için kolay ve anlaşılır bir yol sağlar.
        * Zorunlu dosya yolu veya bayt akışıyla bir "Editör" sınıfı örneği oluşturun ve TXT dosyasını yükleyin
        * TXT dosya biçimi için "TextEditOptions" sınıf örneğini oluşturun ve ayarlayın
        * `Editor.Edit()` yöntemini çağırın ve herhangi bir WYSIWYG editörüyle kolayca düzenlenebilen HTML formatında TXT belgesini alın.
        * `Editor.Save()` yöntemini çağırın ve `TextSaveOptions` sınıfını kullanarak düzenlenmiş TXT dosyasını kaydedin
...
demos:
    enable: true
    title: "TXT Editör Canlı Demoları"
    content: |
        TXT dosyasını hemen [GroupDocs.Editor Canlı Demoları](https://products.groupdocs.app/editor/family) web sitesini ziyaret ederek düzenleyin.
