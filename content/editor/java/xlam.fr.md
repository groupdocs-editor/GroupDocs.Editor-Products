...
############################# Head ############################
head_title: "Éditeur XLAM : modifiez XLAM dans Java"
head_description: "Comment modifier XLAM dans Java en utilisant quelques lignes de code ? Utilisez les API de traitement de documents GroupDocs pour modifier, mettre à jour et enregistrer plus de 30 formats de fichiers."

############################# Header ############################
title: "Modifier XLAM dans Java"
description: "Édition XLAM efficace et robuste à l'aide de GroupDocs.Editor côté serveur pour les API Java, sans l'utilisation de logiciels tels que Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Étapes pour modifier XLAM dans Java"
    content_left: |
        [GroupDocs.Editor for Java](/fr/editor/java/) offre aux développeurs un moyen simple et direct de modifier les fichiers XLAM à l'aide de quelques lignes de code.
        * Créez une instance de la classe `Editor` avec un chemin de fichier ou un flux obligatoire et une classe facultative `SpreadsheetLoadOptions` et chargez le fichier XLAM
        * Créez et définissez l'instance de classe `SpreadsheetEditOptions` pour le format de fichier XLAM
        * Appelez la méthode `Editor.Edit()` et obtenez le document XLAM au format HTML facilement modifiable avec n'importe quel éditeur WYSIWYG.
        * Appelez la méthode `Editor.Save()` et enregistrez le fichier XLAM modifié à l'aide de la classe `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLAM démos en direct de l'éditeur"
    content: |
        Modifiez XLAM dès maintenant en visitant le site Web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
