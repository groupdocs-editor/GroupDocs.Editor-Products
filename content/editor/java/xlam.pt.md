...
############################# Head ############################
head_title: "Editor XLAM — Edite XLAM em Java"
head_description: "Como editar XLAM em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite XLAM em Java"
description: "Edição eficaz e robusta do XLAM usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar XLAM em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos XLAM usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `SpreadsheetLoadOptions` e carregue o arquivo XLAM
        * Crie e defina a instância de classe `SpreadsheetEditOptions` para o formato de arquivo XLAM
        * Chame o método `Editor.Edit()` e obtenha o documento XLAM em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo XLAM editado usando a classe `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLAM Editor de demonstrações ao vivo"
    content: |
        Edite XLAM agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
