...
############################# Head ############################
head_title: "XLS አርታዒ — XLSን በJava አርትዕ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም XLSን በJava ውስጥ እንዴት ማስተካከል ይቻላል? 30+ የፋይል ቅርጸቶችን ለማርትዕ፣ ለማዘመን እና ለማስቀመጥ GroupDocs ሰነዶችን የሚያስኬዱ ኤፒአይዎችን ይጠቀሙ።"

############################# Header ############################
title: "XLSን በJava ውስጥ ያርትዑ"
description: "ውጤታማ እና ጠንካራ XLS አርትዖት የአገልጋይ ጎን GroupDocs.Editor ለJava APIs፣ እንደ Microsoft ወይም Open Office ያሉ ሶፍትዌሮችን ሳይጠቀም።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ XLSን ለማርትዕ ደረጃዎች"
    content_left: |
        [GroupDocs.Editor for Java](/am/አርታዒ/java/) ገንቢዎች ጥቂት የኮድ መስመሮችን በመጠቀም XLS ፋይሎችን እንዲያርትዑ ቀላል እና ቀጥተኛ መንገድን ይሰጣል።
        * የግዴታ የፋይል ዱካ ወይም ዥረት ያለው የ«አርታዒ» ክፍል ምሳሌ እና አማራጭ `SpreadsheetLoadOptions» ክፍል ይፍጠሩ እና XLS ፋይሉን ይጫኑ
        * ለXLS ፋይል ቅርጸት `SpreadsheetEditOptions` ክፍልን ይፍጠሩ እና ያቀናብሩ
        * ወደ `Editor.Edit()` ዘዴ ይደውሉ እና በማንኛውም WYSIWYG-አርታዒ በቀላሉ የሚስተካከል XLS ሰነድ በኤችቲኤምኤል ቅርጸት ያግኙ።
        * የ«Editor.Save()» ዘዴ ይደውሉ እና የተስተካከለ XLS ፋይልን `SpreadsheetSaveOptions` ክፍልን በመጠቀም ያስቀምጡ
...
demos:
    enable: true
    title: "XLS የቀጥታ ማሳያዎች አርታዒ"
    content: |
        የ[GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) ድር ጣቢያን በመጎብኘት አሁኑኑ XLSን ያርትዑ።
