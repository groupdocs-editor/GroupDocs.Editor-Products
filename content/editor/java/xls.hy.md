...
############################# Head ############################
head_title: "XLS Խմբագիր — Խմբագրել XLS Java-ում"
head_description: "Ինչպե՞ս խմբագրել XLS-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել XLS-ը Java-ում"
description: "Արդյունավետ և ուժեղ XLS խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "XLS-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու XLS ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
