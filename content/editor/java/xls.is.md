...
############################# Head ############################
head_title: "XLS Ritstjóri — Breyta XLS í Java"
head_description: "Hvernig á að breyta XLS í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta XLS í Java"
description: "Árangursrík og öflug XLS breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta XLS í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta XLS skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `SpreadsheetLoadOptions` flokki og hlaðið XLS skránni
        * Búðu til og stilltu `SpreadsheetEditOptions` flokkstilvikið fyrir XLS skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu XLS skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta XLS skrá með því að nota `SpreadsheetSaveOptions` flokkinn
...
demos:
    enable: true
    title: "XLS Ritstjóri Live kynningar"
    content: |
        Breyttu XLS núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
