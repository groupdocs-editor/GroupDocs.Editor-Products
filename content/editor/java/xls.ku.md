...
############################# Head ############################
head_title: "XLS Edîtor — Biguherîne XLS li Java"
head_description: "Meriv çawa XLS di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne XLS li Java"
description: "Guhertina bi bandor û bihêz a XLS bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina XLS di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên XLS bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi rêça pelê ya mecbûrî an bi rêk û çîna `SpreadsheetLoadOptions` ya bijarte biafirîne û pelê XLS bar bike.
        * Ji bo forma pelê XLS mînaka pola `SpreadsheetEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya XLS ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê hatî guherandin XLS bi karanîna pola `SpreadsheetSaveOptions` hilînin.
...
demos:
    enable: true
    title: "XLS Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha XLS biguherînin.
