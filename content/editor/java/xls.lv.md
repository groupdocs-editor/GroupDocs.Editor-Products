...
############################# Head ############################
head_title: "XLS redaktors — rediģējiet XLS platformā Java"
head_description: "Kā rediģēt XLS platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt XLS platformā Java"
description: "Efektīva un stabila XLS rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu XLS programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt XLS failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi "SpreadsheetLoadOptions" un ielādējiet failu XLS
        * Izveidojiet un iestatiet klases `SpreadsheetEditOptions` instanci faila formātam XLS
        * Izsauciet metodi "Editor.Edit()" un iegūstiet XLS dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto XLS failu, izmantojot klasi "SpreadsheetSaveOptions"
...
demos:
    enable: true
    title: "XLS Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet XLS tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
