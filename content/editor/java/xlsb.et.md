...
############################# Head ############################
head_title: "XLSB redaktor – muutke XLSB platvormil Java"
head_description: "Kuidas muuta XLSB platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda XLSB platvormil Java"
description: "Tõhus ja jõuline XLSB redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud XLSB muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi XLSB failide redigeerimiseks, kasutades paari koodirida.
