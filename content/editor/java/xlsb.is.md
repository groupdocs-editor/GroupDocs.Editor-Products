...
############################# Head ############################
head_title: "XLSB Ritstjóri — Breyta XLSB í Java"
head_description: "Hvernig á að breyta XLSB í Java með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta XLSB í Java"
description: "Árangursrík og öflug XLSB breyting með því að nota GroupDocs.Editor á netþjóni fyrir Java API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta XLSB í Java"
    content_left: |
        [GroupDocs.Editor for Java](/is/editor/java/) veitir forriturum auðvelda og einfalda leið til að breyta XLSB skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `SpreadsheetLoadOptions` flokki og hlaðið XLSB skránni
        * Búðu til og stilltu `SpreadsheetEditOptions` flokkstilvikið fyrir XLSB skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu XLSB skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta XLSB skrá með því að nota `SpreadsheetSaveOptions` flokkinn
...
demos:
    enable: true
    title: "XLSB Ritstjóri Live kynningar"
    content: |
        Breyttu XLSB núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
