...
############################# Head ############################
head_title: "XLSB Edîtor — Biguherîne XLSB li Java"
head_description: "Meriv çawa XLSB di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne XLSB li Java"
description: "Guhertina bi bandor û bihêz a XLSB bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina XLSB di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên XLSB bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi rêça pelê ya mecbûrî an bi rêk û çîna `SpreadsheetLoadOptions` ya bijarte biafirîne û pelê XLSB bar bike.
        * Ji bo forma pelê XLSB mînaka pola `SpreadsheetEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya XLSB ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê hatî guherandin XLSB bi karanîna pola `SpreadsheetSaveOptions` hilînin.
...
demos:
    enable: true
    title: "XLSB Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha XLSB biguherînin.
