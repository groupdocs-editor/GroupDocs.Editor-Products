...
############################# Head ############################
head_title: "Editor XLSB — Edite XLSB em Java"
head_description: "Como editar XLSB em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite XLSB em Java"
description: "Edição eficaz e robusta do XLSB usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar XLSB em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos XLSB usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `SpreadsheetLoadOptions` e carregue o arquivo XLSB
        * Crie e defina a instância de classe `SpreadsheetEditOptions` para o formato de arquivo XLSB
        * Chame o método `Editor.Edit()` e obtenha o documento XLSB em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo XLSB editado usando a classe `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLSB Editor de demonstrações ao vivo"
    content: |
        Edite XLSB agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
