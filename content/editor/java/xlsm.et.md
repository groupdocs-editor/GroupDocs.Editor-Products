...
############################# Head ############################
head_title: "XLSM redaktor – muutke XLSM platvormil Java"
head_description: "Kuidas muuta XLSM platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda XLSM platvormil Java"
description: "Tõhus ja jõuline XLSM redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud XLSM muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi XLSM failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "SpreadsheetLoadOptions" ja laadige fail XLSM
        * Looge ja määrake failivormingu XLSM klassi eksemplar "SpreadsheetEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument XLSM, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail XLSM klassi `SpreadsheetSaveOptions' abil
...
demos:
    enable: true
    title: "XLSM Reaalajas demode toimetaja"
    content: |
        Muutke XLSM kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
