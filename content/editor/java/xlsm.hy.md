...
############################# Head ############################
head_title: "XLSM Խմբագիր — Խմբագրել XLSM Java-ում"
head_description: "Ինչպե՞ս խմբագրել XLSM-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել XLSM-ը Java-ում"
description: "Արդյունավետ և ուժեղ XLSM խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "XLSM-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու XLSM ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ՝ ֆայլի պարտադիր ճանապարհով կամ հոսքով և ընտրովի «SpreadsheetLoadOptions» դասով և բեռնեք XLSM ֆայլը:
        * Ստեղծեք և սահմանեք «SpreadsheetEditOptions» դասի օրինակը XLSM ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք XLSM փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված XLSM ֆայլը՝ օգտագործելով «SpreadsheetSaveOptions» դասը
...
demos:
    enable: true
    title: "XLSM Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք XLSM-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
