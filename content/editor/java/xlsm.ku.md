...
############################# Head ############################
head_title: "XLSM Edîtor — Biguherîne XLSM li Java"
head_description: "Meriv çawa XLSM di Java de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne XLSM li Java"
description: "Guhertina bi bandor û bihêz a XLSM bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên Java, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina XLSM di Java de"
    content_left: |
        [GroupDocs.Editor for Java](/ku/editor/java/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên XLSM bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi rêça pelê ya mecbûrî an bi rêk û çîna `SpreadsheetLoadOptions` ya bijarte biafirîne û pelê XLSM bar bike.
        * Ji bo forma pelê XLSM mînaka pola `SpreadsheetEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya XLSM ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê hatî guherandin XLSM bi karanîna pola `SpreadsheetSaveOptions` hilînin.
...
demos:
    enable: true
    title: "XLSM Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha XLSM biguherînin.
