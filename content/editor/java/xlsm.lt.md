...
############################# Head ############################
head_title: "XLSM redaktorius – redaguoti XLSM Java"
head_description: "Kaip redaguoti XLSM Java naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti XLSM Java"
description: "Efektyvus ir patikimas XLSM redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą Java API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti XLSM Java"
    content_left: |
        [GroupDocs.Editor for Java](/lt/editor/java/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti XLSM failus naudojant kelias kodo eilutes.
        * Sukurkite „Editor“ klasės egzempliorių su privalomu failo keliu arba srautu ir pasirenkama „SpreadsheetLoadOptions“ klase ir įkelkite failą XLSM
        * Sukurkite ir nustatykite „SpreadsheetEditOptions“ klasės egzempliorių failo formatui XLSM
        * Iškvieskite metodą „Editor.Edit()“ ir gaukite XLSM dokumentą HTML formatu, kurį būtų lengva redaguoti naudojant bet kurį WYSIWYG redaktorių.
        * Iškvieskite metodą „Editor.Save()“ ir išsaugokite redaguotą XLSM failą naudodami klasę „SpreadsheetSaveOptions“
...
demos:
    enable: true
    title: "XLSM Tiesioginės demonstracinės versijos redaktorius"
    content: |
        Redaguokite XLSM dabar apsilankę [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) svetainėje.
