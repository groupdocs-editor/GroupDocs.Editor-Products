...
############################# Head ############################
head_title: "XLSM redaktors — rediģējiet XLSM platformā Java"
head_description: "Kā rediģēt XLSM platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt XLSM platformā Java"
description: "Efektīva un stabila XLSM rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu XLSM programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt XLSM failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi "SpreadsheetLoadOptions" un ielādējiet failu XLSM
        * Izveidojiet un iestatiet klases `SpreadsheetEditOptions` instanci faila formātam XLSM
        * Izsauciet metodi "Editor.Edit()" un iegūstiet XLSM dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto XLSM failu, izmantojot klasi "SpreadsheetSaveOptions"
...
demos:
    enable: true
    title: "XLSM Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet XLSM tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
