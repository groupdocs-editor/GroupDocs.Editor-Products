...
############################# Head ############################
head_title: "XLSM Editor — Bewerk XLSM in Java"
head_description: "Hoe bewerk je XLSM in Java met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk XLSM in Java"
description: "Effectieve en robuuste XLSM bewerking met Server-side GroupDocs.Editor voor Java API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om XLSM te bewerken in Java"
    content_left: |
        [GroupDocs.Editor for Java](/nl/editor/java/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de XLSM-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of -stream en optionele klasse 'SpreadsheetLoadOptions' en laad het bestand XLSM
        * Maak en stel de klasse-instantie `SpreadsheetEditOptions` in voor de bestandsindeling XLSM
        * Roep de `Editor.Edit()` methode aan en verkrijg een XLSM document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de `Editor.Save()`-methode aan en sla het bewerkte XLSM-bestand op met de klasse `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLSM Editor Live demo's"
    content: |
        Bewerk XLSM nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
