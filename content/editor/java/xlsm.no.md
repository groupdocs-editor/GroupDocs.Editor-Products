...
############################# Head ############################
head_title: "XLSM Editor – Rediger XLSM i Java"
head_description: "Hvordan redigere XLSM i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger XLSM i Java"
description: "Effektiv og robust XLSM-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere XLSM i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere XLSM-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av `Editor`-klassen med obligatorisk filbane eller strøm og valgfri `SpreadsheetLoadOptions`-klasse og last inn XLSM-filen
        * Opprett og still inn klasseforekomsten `SpreadsheetEditOptions` for filformatet XLSM
        * Kall `Editor.Edit()`-metoden og skaff XLSM-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte XLSM-filen med klassen `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLSM Editor Live Demoer"
    content: |
        Rediger XLSM akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
