...
############################# Head ############################
head_title: "XLSX محرر - تحرير XLSX في Java"
head_description: "كيفية تعديل XLSX في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير XLSX في Java"
description: "تحرير XLSX فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل XLSX في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات XLSX باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق وفئة "SpreadsheetLoadOptions" الاختيارية وتحميل الملف XLSX
        * إنشاء وتعيين مثيل فئة `SpreadsheetEditOptions` لتنسيق الملف XLSX
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند XLSX بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف XLSX الذي تم تحريره باستخدام فئة `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLSX عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير XLSX الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
