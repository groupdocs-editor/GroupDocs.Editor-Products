...
############################# Head ############################
head_title: "XLSX redaktors — rediģējiet XLSX platformā Java"
head_description: "Kā rediģēt XLSX platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt XLSX platformā Java"
description: "Efektīva un stabila XLSX rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu XLSX programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt XLSX failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Editor" instanci ar obligātu faila ceļu vai straumi un neobligātu klasi "SpreadsheetLoadOptions" un ielādējiet failu XLSX
        * Izveidojiet un iestatiet klases `SpreadsheetEditOptions` instanci faila formātam XLSX
        * Izsauciet metodi "Editor.Edit()" un iegūstiet XLSX dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto XLSX failu, izmantojot klasi "SpreadsheetSaveOptions"
...
demos:
    enable: true
    title: "XLSX Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet XLSX tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
