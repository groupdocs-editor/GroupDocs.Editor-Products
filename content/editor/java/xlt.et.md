...
############################# Head ############################
head_title: "XLT redaktor – muutke XLT platvormil Java"
head_description: "Kuidas muuta XLT platvormis Java, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda XLT platvormil Java"
description: "Tõhus ja jõuline XLT redigeerimine serveripoolse GroupDocs.Editori abil Java API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud XLT muutmiseks programmis Java"
    content_left: |
        [GroupDocs.Editor for Java](/et/editor/java/) pakub arendajatele lihtsat ja arusaadavat viisi XLT failide redigeerimiseks, kasutades paari koodirida.
        * Looge klassi "Editor" eksemplar koos kohustusliku failitee või vooga ja valikulise klassiga "SpreadsheetLoadOptions" ja laadige fail XLT
        * Looge ja määrake failivormingu XLT klassi eksemplar "SpreadsheetEditOptions"
        * Kutsuge meetod "Editor.Edit()" ja hankige HTML-vormingus dokument XLT, mida saab hõlpsasti redigeerida mis tahes WYSIWYG-redaktoriga.
        * Kutsuge välja meetod "Editor.Save()" ja salvestage redigeeritud fail XLT klassi `SpreadsheetSaveOptions' abil
...
demos:
    enable: true
    title: "XLT Reaalajas demode toimetaja"
    content: |
        Muutke XLT kohe, külastades veebisaiti [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
