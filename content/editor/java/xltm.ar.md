...
############################# Head ############################
head_title: "XLTM محرر - تحرير XLTM في Java"
head_description: "كيفية تعديل XLTM في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير XLTM في Java"
description: "تحرير XLTM فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل XLTM في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات XLTM باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" مع مسار ملف إلزامي أو دفق وفئة "SpreadsheetLoadOptions" الاختيارية وتحميل الملف XLTM
        * إنشاء وتعيين مثيل فئة `SpreadsheetEditOptions` لتنسيق الملف XLTM
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند XLTM بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف XLTM الذي تم تحريره باستخدام فئة `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLTM عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير XLTM الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
