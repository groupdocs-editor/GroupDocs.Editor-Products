...
############################# Head ############################
head_title: "XLTM Editor — Redigera XLTM i Java"
head_description: "Hur redigerar man XLTM i Java med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera XLTM i Java"
description: "Effektiv och robust XLTM-redigering med hjälp av GroupDocs.Editor på serversidan för Java API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera XLTM i Java"
    content_left: |
        [GroupDocs.Editor for Java](/sv/editor/java/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera XLTM-filerna med några rader kod.
        * Skapa en instans av klassen `Editor` med obligatorisk sökväg eller ström och valfri klass `SpreadsheetLoadOptions` och ladda XLTM-filen
        * Skapa och ställ in klassinstansen `SpreadsheetEditOptions` för filformatet XLTM
        * Anropa `Editor.Edit()`-metoden och skaffa XLTM-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade XLTM-filen med klassen `SpreadsheetSaveOptions`
...
demos:
    ...
    content: |
        Redigera XLTM just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
