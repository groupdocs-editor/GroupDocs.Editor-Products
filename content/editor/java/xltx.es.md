...
############################# Head ############################
head_title: "Editor XLTX: edite XLTX en Java"
head_description: "¿Cómo editar XLTX en Java usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar XLTX en Java"
description: "Edición de XLTX efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de Java, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar XLTX en Java"
    content_left: |
        [GroupDocs.Editor for Java](/es/editor/java/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos XLTX usando unas pocas líneas de código.
        * Cree una instancia de la clase 'Editor' con una ruta de archivo o secuencia obligatoria y una clase 'SpreadsheetLoadOptions' opcional y cargue el archivo XLTX
        * Cree y configure la instancia de la clase `SpreadsheetEditOptions` para el formato de archivo XLTX
        * Llame al método `Editor.Edit()` y obtenga el documento XLTX en formato HTML que se puede editar fácilmente con cualquier editor WYSIWYG.
        * Llame al método `Editor.Save()` y guarde el archivo XLTX editado usando la clase `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLTX Demostraciones en vivo del editor"
    content: |
        Edite XLTX ahora mismo visitando el sitio web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
