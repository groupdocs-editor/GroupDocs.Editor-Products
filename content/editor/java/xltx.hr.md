...
############################# Head ############################
head_title: "XLTX Editor — Uredite XLTX u Java"
head_description: "Kako urediti XLTX u Java pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi XLTX u Java"
description: "Učinkovito i robusno XLTX uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je Java, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje XLTX u Java"
    content_left: |
        [GroupDocs.Editor for Java](/hr/editor/java/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka XLTX pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznim putem datoteke ili streamom i izbornom klasom `SpreadsheetLoadOptions` i učitajte datoteku XLTX
        * Stvorite i postavite instancu klase `SpreadsheetEditOptions` za format datoteke XLTX
        * Pozovite metodu `Editor.Edit()` i dobijte XLTX dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu XLTX datoteku pomoću klase `SpreadsheetSaveOptions`
...
demos:
    enable: true
    title: "XLTX Demonstracije uređivača uživo"
    content: |
        Uredite XLTX odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
