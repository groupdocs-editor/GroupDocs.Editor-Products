...
############################# Head ############################
head_title: "XLTX Խմբագիր — Խմբագրել XLTX Java-ում"
head_description: "Ինչպե՞ս խմբագրել XLTX-ը Java-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել XLTX-ը Java-ում"
description: "Արդյունավետ և ուժեղ XLTX խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով Java API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "XLTX-ը Java-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for Java](/hy/editor/java/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու XLTX ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
        * Ստեղծեք «Editor» դասի օրինակ՝ ֆայլի պարտադիր ճանապարհով կամ հոսքով և ընտրովի «SpreadsheetLoadOptions» դասով և բեռնեք XLTX ֆայլը:
        * Ստեղծեք և սահմանեք «SpreadsheetEditOptions» դասի օրինակը XLTX ֆայլի ձևաչափի համար
        * Զանգահարեք «Editor.Edit()» մեթոդը և ստացեք XLTX փաստաթուղթ HTML ձևաչափով, որը հեշտությամբ կարելի է խմբագրել ցանկացած WYSIWYG խմբագրիչով:
        * Զանգահարեք «Editor.Save()» մեթոդը և պահպանեք խմբագրված XLTX ֆայլը՝ օգտագործելով «SpreadsheetSaveOptions» դասը
...
demos:
    enable: true
    title: "XLTX Խմբագիր կենդանի ցուցադրություններ"
    content: |
        Խմբագրեք XLTX-ը հենց հիմա՝ այցելելով [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) կայքը:
