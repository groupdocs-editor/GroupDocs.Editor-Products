...
############################# Head ############################
head_title: "XML-redigeerder — Wysig XML in Java"
head_description: "Hoe om XML in Java te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig XML in Java"
description: "Effektiewe en robuuste XML redigering deur bedienerkant GroupDocs.Editor vir Java API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om XML in Java te wysig"
    content_left: |
        [GroupDocs.Editor for Java](/af/editor/java/) bied 'n maklike en reguit manier vir ontwikkelaars om die XML lêers te wysig deur 'n paar reëls kode te gebruik.
        * Skep 'n instansie van `Editor`-klas met verpligte lêerpad of greepstroom en laai die XML-lêer
        * Skep en stel die `TextEditOptions`-klasinstansie vir die XML-lêerformaat
        * Roep `Editor.Edit()`-metode en verkry XML-dokument in HTML-formaat wat maklik met enige WYSIWYG-redigeerder geredigeer kan word.
        * Roep `Editor.Save()`-metode en stoor geredigeerde XML-lêer met `TextSaveOptions`-klas
...
demos:
    enable: true
    title: "XML Redigeerder Regstreekse Demo's"
    content: |
        Wysig XML op die oomblik deur [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) webwerf te besoek.
