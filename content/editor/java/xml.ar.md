...
############################# Head ############################
head_title: "XML محرر - تحرير XML في Java"
head_description: "كيفية تعديل XML في Java باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير XML في Java"
description: "تحرير XML فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات Java ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل XML في Java"
    content_left: |
        يوفر [GroupDocs.Editor for Java] (/ar/editor/java/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات XML باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" بمسار ملف إلزامي أو دفق بايت وتحميل الملف XML
        * قم بإنشاء وتعيين مثيل فئة `TextEditOptions` لتنسيق الملف XML
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند XML بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * استدع أسلوب `Editor.Save ()` واحفظ الملف XML المحرر باستخدام فئة `TextSaveOptions`
...
demos:
    enable: true
    title: "XML عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير XML الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
