...
############################# Head ############################
head_title: "XML redaktors — rediģējiet XML platformā Java"
head_description: "Kā rediģēt XML platformā Java, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt XML platformā Java"
description: "Efektīva un stabila XML rediģēšana, izmantojot servera puses GroupDocs.Editor Java API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu XML programmā Java"
    content_left: |
        [GroupDocs.Editor for Java](/lv/editor/java/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt XML failus, izmantojot dažas koda rindiņas.
        * Izveidojiet klases "Redaktors" gadījumu ar obligātu faila ceļu vai baitu straumi un ielādējiet failu XML
        * Izveidojiet un iestatiet klases `TextEditOptions` gadījumu faila formātam XML
        * Izsauciet metodi "Editor.Edit()" un iegūstiet XML dokumentu HTML formātā, kas ir viegli rediģējams ar jebkuru WYSIWYG redaktoru.
        * Izsauciet metodi "Editor.Save()" un saglabājiet rediģēto XML failu, izmantojot klasi "TextSaveOptions".
...
demos:
    enable: true
    title: "XML Tiešraides demonstrācijas redaktors"
    content: |
        Rediģējiet XML tūlīt, apmeklējot vietni [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
