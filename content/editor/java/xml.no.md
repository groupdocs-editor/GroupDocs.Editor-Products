...
############################# Head ############################
head_title: "XML Editor – Rediger XML i Java"
head_description: "Hvordan redigere XML i Java ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger XML i Java"
description: "Effektiv og robust XML-redigering ved bruk av GroupDocs.Editor på serversiden for Java APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere XML i Java"
    content_left: |
        [GroupDocs.Editor for Java](/no/editor/java/) gir utviklere en enkel og grei måte å redigere XML-filene ved å bruke noen få linjer med kode.
        * Opprett en forekomst av 'Editor'-klassen med obligatorisk filbane eller bytestrøm og last inn XML-filen
        * Opprett og still inn klassen `TextEditOptions` for filformatet XML
        * Kall `Editor.Edit()`-metoden og skaff XML-dokumentet i HTML-format som enkelt kan redigeres med hvilken som helst WYSIWYG-editor.
        * Kall `Editor.Save()`-metoden og lagre den redigerte XML-filen med `TextSaveOptions`-klassen
...
demos:
    ...
    content: |
        Rediger XML akkurat nå ved å gå til nettstedet [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
