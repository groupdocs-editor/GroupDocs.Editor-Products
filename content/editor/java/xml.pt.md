...
############################# Head ############################
head_title: "Editor XML — Edite XML em Java"
head_description: "Como editar XML em Java usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite XML em Java"
description: "Edição eficaz e robusta do XML usando o GroupDocs.Editor do lado do servidor para APIs do Java, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar XML em Java"
    content_left: |
        [GroupDocs.Editor for Java](/pt/editor/java/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos XML usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho de arquivo obrigatório ou fluxo de bytes e carregue o arquivo XML
        * Crie e defina a instância de classe `TextEditOptions` para o formato de arquivo XML
        * Chame o método `Editor.Edit()` e obtenha o documento XML em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo XML editado usando a classe `TextSaveOptions`
...
demos:
    enable: true
    title: "XML Editor de demonstrações ao vivo"
    content: |
        Edite XML agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
