...
head_title: "CSV Editor – Edit CSV di C# .NET"
head_description: "Bagaimana cara mengedit CSV di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting CSV di C#"
description: "Pengeditan CSV yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit CSV di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file CSV menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file CSV dengan path lengkap
        * Buat & atur EditOptions untuk jenis file CSV
        * Panggil metode Editor.Edit dan dapatkan dokumen CSV dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file CSV yang diedit
    ...
    code: |
        ```cs
        // Muat file CSV ke Editor
        Editor editor = new Editor("source.csv");
        
        // Buka masukan CSV dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen CSV dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen CSV dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen CSV yang telah diedit
        editor.Save(afterEdit, "edited.csv");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor CSV"
    content: |
        Edit CSV sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
