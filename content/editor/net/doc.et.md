...
############################# Head ############################
head_title: "DOC redaktor – muutke DOC platvormil C# .NET"
head_description: "Kuidas muuta DOC platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda DOC platvormil C# .NET"
description: "Tõhus ja jõuline DOC redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud DOC muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi DOC failide redigeerimiseks, kasutades paari koodirida.
