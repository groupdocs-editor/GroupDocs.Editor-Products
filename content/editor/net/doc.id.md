...
head_title: "DOC Editor – Edit DOC di C# .NET"
head_description: "Bagaimana cara mengedit DOC di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting DOC di C#"
description: "Pengeditan DOC yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit DOC di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file DOC menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file DOC dengan path lengkap
        * Buat & atur EditOptions untuk jenis file DOC
        * Panggil metode Editor.Edit dan dapatkan dokumen DOC dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file DOC yang diedit
    ...
    code: |
        ```cs
        // Muat file DOC ke Editor
        Editor editor = new Editor("source.doc");
        
        // Buka masukan DOC dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen DOC dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen DOC dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen DOC yang telah diedit
        editor.Save(afterEdit, "edited.doc");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor DOC"
    content: |
        Edit DOC sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
