...
head_title: "DOCM Editor – Edit DOCM di C# .NET"
head_description: "Bagaimana cara mengedit DOCM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting DOCM di C#"
description: "Pengeditan DOCM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit DOCM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file DOCM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file DOCM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file DOCM
        * Panggil metode Editor.Edit dan dapatkan dokumen DOCM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file DOCM yang diedit
    ...
    code: |
        ```cs
        // Muat file DOCM ke Editor
        Editor editor = new Editor("source.docm");
        
        // Buka masukan DOCM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen DOCM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen DOCM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen DOCM yang telah diedit
        editor.Save(afterEdit, "edited.docm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor DOCM"
    content: |
        Edit DOCM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
