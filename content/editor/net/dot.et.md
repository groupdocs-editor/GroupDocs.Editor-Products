...
############################# Head ############################
head_title: "DOT redaktor – muutke DOT platvormil C# .NET"
head_description: "Kuidas muuta DOT platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda DOT platvormil C# .NET"
description: "Tõhus ja jõuline DOT redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud DOT muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi DOT failide redigeerimiseks, kasutades paari koodirida.
