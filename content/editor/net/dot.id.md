...
head_title: "DOT Editor – Edit DOT di C# .NET"
head_description: "Bagaimana cara mengedit DOT di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting DOT di C#"
description: "Pengeditan DOT yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit DOT di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file DOT menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file DOT dengan path lengkap
        * Buat & atur EditOptions untuk jenis file DOT
        * Panggil metode Editor.Edit dan dapatkan dokumen DOT dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file DOT yang diedit
    ...
    code: |
        ```cs
        // Muat file DOT ke Editor
        Editor editor = new Editor("source.dot");
        
        // Buka masukan DOT dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen DOT dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen DOT dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen DOT yang telah diedit
        editor.Save(afterEdit, "edited.dot");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor DOT"
    content: |
        Edit DOT sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
