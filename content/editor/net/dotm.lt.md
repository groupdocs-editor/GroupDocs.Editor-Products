...
############################# Head ############################
head_title: "DOTM redaktorius – redaguoti DOTM C# .NET"
head_description: "Kaip redaguoti DOTM C# .NET naudojant kelias kodo eilutes? Naudokite GroupDocs dokumentų apdorojimo API, kad galėtumėte redaguoti, atnaujinti ir išsaugoti daugiau nei 30 failų formatų."

############################# Header ############################
title: "Redaguoti DOTM C# .NET"
description: "Efektyvus ir patikimas DOTM redagavimas naudojant serverio pusės GroupDocs.Editor, skirtą C# .NET API, nenaudojant jokios programinės įrangos, pvz., Microsoft ar Open Office."
...
steps:
    enable: true
    title_left: "Veiksmai, kaip redaguoti DOTM C#"
    content_left: |
        [GroupDocs.Editor for .NET](/lt/editor/net/) suteikia kūrėjams paprastą ir nesudėtingą būdą redaguoti DOTM failus naudojant kelias kodo eilutes.
