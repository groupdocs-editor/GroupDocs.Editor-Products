...
############################# Head ############################
head_title: "DOTX redaktor – muutke DOTX platvormil C# .NET"
head_description: "Kuidas muuta DOTX platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda DOTX platvormil C# .NET"
description: "Tõhus ja jõuline DOTX redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud DOTX muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi DOTX failide redigeerimiseks, kasutades paari koodirida.
