...
############################# Head ############################
head_title: "EMLX-redigeerder — Wysig EMLX in C# .NET"
head_description: "Hoe om EMLX in C# .NET te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig EMLX in C# .NET"
description: "Effektiewe en robuuste EMLX redigering deur bedienerkant GroupDocs.Editor vir C# .NET API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om EMLX in C# te wysig"
    content_left: |
        [GroupDocs.Editor for .NET](/af/editor/net/) bied 'n maklike en reguit manier vir ontwikkelaars om die EMLX lêers te wysig deur 'n paar reëls kode te gebruik.
