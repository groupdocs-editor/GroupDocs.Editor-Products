...
############################# Head ############################
head_title: "EPUB redaktor – muutke EPUB platvormil C# .NET"
head_description: "Kuidas muuta EPUB platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda EPUB platvormil C# .NET"
description: "Tõhus ja jõuline EPUB redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud EPUB muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi EPUB failide redigeerimiseks, kasutades paari koodirida.
