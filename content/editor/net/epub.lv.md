...
############################# Head ############################
head_title: "EPUB redaktors — rediģējiet EPUB platformā C# .NET"
head_description: "Kā rediģēt EPUB platformā C# .NET, izmantojot dažas koda rindiņas? Izmantojiet GroupDocs dokumentu apstrādes API, lai rediģētu, atjauninātu un saglabātu vairāk nekā 30 failu formātus."

############################# Header ############################
title: "Rediģēt EPUB platformā C# .NET"
description: "Efektīva un stabila EPUB rediģēšana, izmantojot servera puses GroupDocs.Editor C# .NET API, neizmantojot tādu programmatūru kā Microsoft vai Open Office."
...
steps:
    enable: true
    title_left: "Darbības, lai rediģētu EPUB programmā C#"
    content_left: |
        [GroupDocs.Editor for .NET](/lv/editor/net/) nodrošina vienkāršu un vienkāršu veidu, kā izstrādātāji var rediģēt EPUB failus, izmantojot dažas koda rindiņas.
