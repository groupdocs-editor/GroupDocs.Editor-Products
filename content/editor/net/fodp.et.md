...
############################# Head ############################
head_title: "FODP redaktor – muutke FODP platvormil C# .NET"
head_description: "Kuidas muuta FODP platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda FODP platvormil C# .NET"
description: "Tõhus ja jõuline FODP redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud FODP muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi FODP failide redigeerimiseks, kasutades paari koodirida.
