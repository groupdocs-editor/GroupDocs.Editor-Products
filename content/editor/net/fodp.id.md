...
head_title: "FODP Editor – Edit FODP di C# .NET"
head_description: "Bagaimana cara mengedit FODP di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting FODP di C#"
description: "Pengeditan FODP yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit FODP di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file FODP menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file FODP dengan path lengkap
        * Buat & atur EditOptions untuk jenis file FODP
        * Panggil metode Editor.Edit dan dapatkan dokumen FODP dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file FODP yang diedit
    ...
    code: |
        ```cs
        // Muat file FODP ke Editor
        Editor editor = new Editor("source.fodp");
        
        // Buka masukan FODP dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen FODP dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen FODP dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen FODP yang telah diedit
        editor.Save(afterEdit, "edited.fodp");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor FODP"
    content: |
        Edit FODP sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
