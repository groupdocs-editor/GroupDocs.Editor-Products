...
############################# Head ############################
head_title: "FODS Խմբագիր — Խմբագրել FODS C# .NET-ում"
head_description: "Ինչպե՞ս խմբագրել FODS-ը C# .NET-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել FODS-ը C# .NET-ում"
description: "Արդյունավետ և ուժեղ FODS խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով C# .NET API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "FODS-ը C#-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for .NET](/hy/editor/net/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու FODS ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
