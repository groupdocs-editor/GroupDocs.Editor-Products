...
############################# Head ############################
head_title: "HTM redaktor – muutke HTM platvormil C# .NET"
head_description: "Kuidas muuta HTM platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda HTM platvormil C# .NET"
description: "Tõhus ja jõuline HTM redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud HTM muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi HTM failide redigeerimiseks, kasutades paari koodirida.
