...
############################# Head ############################
head_title: "HTM Editor — Uredite HTM u C# .NET"
head_description: "Kako urediti HTM u C# .NET pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi HTM u C# .NET"
description: "Učinkovito i robusno HTM uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je C# .NET, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje HTM u C#"
    content_left: |
        [GroupDocs.Editor for .NET](/hr/editor/net/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka HTM pomoću nekoliko redaka koda.
