...
head_title: "HTM Editor – Edit HTM di C# .NET"
head_description: "Bagaimana cara mengedit HTM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting HTM di C#"
description: "Pengeditan HTM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit HTM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file HTM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file HTM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file HTM
        * Panggil metode Editor.Edit dan dapatkan dokumen HTM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file HTM yang diedit
    ...
    code: |
        ```cs
        // Muat file HTM ke Editor
        Editor editor = new Editor("source.htm");
        
        // Buka masukan HTM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen HTM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen HTM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen HTM yang telah diedit
        editor.Save(afterEdit, "edited.htm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor HTM"
    content: |
        Edit HTM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
