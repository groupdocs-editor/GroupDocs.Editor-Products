...
############################# Head ############################
head_title: "HTM Edîtor — Biguherîne HTM li C# .NET"
head_description: "Meriv çawa HTM di C# .NET de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne HTM li C# .NET"
description: "Guhertina bi bandor û bihêz a HTM bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên C# .NET, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina HTM di C# de"
    content_left: |
        [GroupDocs.Editor for .NET](/ku/editor/net/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên HTM bi karanîna çend rêzikên kodê biguherînin.
