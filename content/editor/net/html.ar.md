...
############################# Head ############################
head_title: "HTML محرر - تحرير HTML في C# .NET"
head_description: "كيفية تعديل HTML في C# .NET باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير HTML في C# .NET"
description: "تحرير HTML فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات C# .NET ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل HTML في C#"
    content_left: |
        يوفر [GroupDocs.Editor for .NET] (/ar/editor/net/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات HTML باستخدام بضعة أسطر من التعليمات البرمجية.
