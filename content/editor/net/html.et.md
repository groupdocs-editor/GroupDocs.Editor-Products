...
############################# Head ############################
head_title: "HTML redaktor – muutke HTML platvormil C# .NET"
head_description: "Kuidas muuta HTML platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda HTML platvormil C# .NET"
description: "Tõhus ja jõuline HTML redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud HTML muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi HTML failide redigeerimiseks, kasutades paari koodirida.
