...
############################# Head ############################
head_title: "MOBI محرر - تحرير MOBI في C# .NET"
head_description: "كيفية تعديل MOBI في C# .NET باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير MOBI في C# .NET"
description: "تحرير MOBI فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات C# .NET ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل MOBI في C#"
    content_left: |
        يوفر [GroupDocs.Editor for .NET] (/ar/editor/net/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات MOBI باستخدام بضعة أسطر من التعليمات البرمجية.
