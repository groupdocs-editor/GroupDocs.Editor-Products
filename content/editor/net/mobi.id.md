...
head_title: "MOBI Editor – Edit MOBI di C# .NET"
head_description: "Bagaimana cara mengedit MOBI di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting MOBI di C#"
description: "Pengeditan MOBI yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit MOBI di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file MOBI menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file MOBI dengan path lengkap
        * Buat & atur EditOptions untuk jenis file MOBI
        * Panggil metode Editor.Edit dan dapatkan dokumen MOBI dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file MOBI yang diedit
    ...
    code: |
        ```cs
        // Muat file MOBI ke Editor
        Editor editor = new Editor("source.mobi");
        
        // Buka masukan MOBI dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen MOBI dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen MOBI dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen MOBI yang telah diedit
        editor.Save(afterEdit, "edited.mobi");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor MOBI"
    content: |
        Edit MOBI sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
