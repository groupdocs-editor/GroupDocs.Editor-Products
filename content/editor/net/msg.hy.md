...
############################# Head ############################
head_title: "MSG Խմբագիր — Խմբագրել MSG C# .NET-ում"
head_description: "Ինչպե՞ս խմբագրել MSG-ը C# .NET-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել MSG-ը C# .NET-ում"
description: "Արդյունավետ և ուժեղ MSG խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով C# .NET API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "MSG-ը C#-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for .NET](/hy/editor/net/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու MSG ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
