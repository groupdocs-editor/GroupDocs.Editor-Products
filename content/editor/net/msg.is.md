...
############################# Head ############################
head_title: "MSG Ritstjóri — Breyta MSG í C# .NET"
head_description: "Hvernig á að breyta MSG í C# .NET með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta MSG í C# .NET"
description: "Árangursrík og öflug MSG breyting með því að nota GroupDocs.Editor á netþjóni fyrir C# .NET API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta MSG í C#"
    content_left: |
        [GroupDocs.Editor for .NET](/is/editor/net/) veitir forriturum auðvelda og einfalda leið til að breyta MSG skránum með því að nota nokkrar línur af kóða.
