...
############################# Head ############################
head_title: "MSG Editor – Rediger MSG i C# .NET"
head_description: "Hvordan redigere MSG i C# .NET ved å bruke noen få linjer med kode? Bruk GroupDocs-dokumenter som behandler APIer for å redigere, oppdatere og lagre 30+ filformater."

############################# Header ############################
title: "Rediger MSG i C# .NET"
description: "Effektiv og robust MSG-redigering ved bruk av GroupDocs.Editor på serversiden for C# .NET APIer, uten bruk av programvare som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Trinn for å redigere MSG i C#"
    content_left: |
        [GroupDocs.Editor for .NET](/no/editor/net/) gir utviklere en enkel og grei måte å redigere MSG-filene ved å bruke noen få linjer med kode.
