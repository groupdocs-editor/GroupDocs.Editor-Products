...
############################# Head ############################
head_title: "ODP redaktor – muutke ODP platvormil C# .NET"
head_description: "Kuidas muuta ODP platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda ODP platvormil C# .NET"
description: "Tõhus ja jõuline ODP redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud ODP muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi ODP failide redigeerimiseks, kasutades paari koodirida.
