...
head_title: "ODP Editor – Edit ODP di C# .NET"
head_description: "Bagaimana cara mengedit ODP di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting ODP di C#"
description: "Pengeditan ODP yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit ODP di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file ODP menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file ODP dengan path lengkap
        * Buat & atur EditOptions untuk jenis file ODP
        * Panggil metode Editor.Edit dan dapatkan dokumen ODP dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file ODP yang diedit
    ...
    code: |
        ```cs
        // Muat file ODP ke Editor
        Editor editor = new Editor("source.odp");
        
        // Buka masukan ODP dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen ODP dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen ODP dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen ODP yang telah diedit
        editor.Save(afterEdit, "edited.odp");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor ODP"
    content: |
        Edit ODP sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
