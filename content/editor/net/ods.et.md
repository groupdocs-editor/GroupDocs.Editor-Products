...
############################# Head ############################
head_title: "ODS redaktor – muutke ODS platvormil C# .NET"
head_description: "Kuidas muuta ODS platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda ODS platvormil C# .NET"
description: "Tõhus ja jõuline ODS redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud ODS muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi ODS failide redigeerimiseks, kasutades paari koodirida.
