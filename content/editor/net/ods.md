...
############################# Head ############################
head_title: "ODS Editor — Edit ODS in C# .NET"
head_description: "How to edit ODS in C# .NET using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit ODS in C# .NET"
description: "Effective and robust ODS editing using server side GroupDocs.Editor for C# .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit ODS in C#"
    content_left: |
        [GroupDocs.Editor for .NET](/editor/net/) provides an easy and straightforward way for developers to edit the ODS files using a few lines of code.
