...
############################# Head ############################
head_title: "ODT redaktor – muutke ODT platvormil C# .NET"
head_description: "Kuidas muuta ODT platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda ODT platvormil C# .NET"
description: "Tõhus ja jõuline ODT redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud ODT muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi ODT failide redigeerimiseks, kasutades paari koodirida.
