...
head_title: "ODT Editor – Edit ODT di C# .NET"
head_description: "Bagaimana cara mengedit ODT di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting ODT di C#"
description: "Pengeditan ODT yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit ODT di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file ODT menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file ODT dengan path lengkap
        * Buat & atur EditOptions untuk jenis file ODT
        * Panggil metode Editor.Edit dan dapatkan dokumen ODT dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file ODT yang diedit
    ...
    code: |
        ```cs
        // Muat file ODT ke Editor
        Editor editor = new Editor("source.odt");
        
        // Buka masukan ODT dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen ODT dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen ODT dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen ODT yang telah diedit
        editor.Save(afterEdit, "edited.odt");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor ODT"
    content: |
        Edit ODT sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
