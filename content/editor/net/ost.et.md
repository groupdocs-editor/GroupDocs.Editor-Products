...
############################# Head ############################
head_title: "OST redaktor – muutke OST platvormil C# .NET"
head_description: "Kuidas muuta OST platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda OST platvormil C# .NET"
description: "Tõhus ja jõuline OST redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud OST muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi OST failide redigeerimiseks, kasutades paari koodirida.
