...
head_title: "OTP Editor – Edit OTP di C# .NET"
head_description: "Bagaimana cara mengedit OTP di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting OTP di C#"
description: "Pengeditan OTP yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit OTP di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file OTP menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file OTP dengan path lengkap
        * Buat & atur EditOptions untuk jenis file OTP
        * Panggil metode Editor.Edit dan dapatkan dokumen OTP dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file OTP yang diedit
    ...
    code: |
        ```cs
        // Muat file OTP ke Editor
        Editor editor = new Editor("source.otp");
        
        // Buka masukan OTP dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen OTP dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen OTP dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen OTP yang telah diedit
        editor.Save(afterEdit, "edited.otp");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor OTP"
    content: |
        Edit OTP sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
