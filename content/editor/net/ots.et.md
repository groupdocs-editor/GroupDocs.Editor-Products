...
############################# Head ############################
head_title: "OTS redaktor – muutke OTS platvormil C# .NET"
head_description: "Kuidas muuta OTS platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda OTS platvormil C# .NET"
description: "Tõhus ja jõuline OTS redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud OTS muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi OTS failide redigeerimiseks, kasutades paari koodirida.
