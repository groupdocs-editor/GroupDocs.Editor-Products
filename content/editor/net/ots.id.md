...
head_title: "OTS Editor – Edit OTS di C# .NET"
head_description: "Bagaimana cara mengedit OTS di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting OTS di C#"
description: "Pengeditan OTS yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit OTS di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file OTS menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file OTS dengan path lengkap
        * Buat & atur EditOptions untuk jenis file OTS
        * Panggil metode Editor.Edit dan dapatkan dokumen OTS dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file OTS yang diedit
    ...
    code: |
        ```cs
        // Muat file OTS ke Editor
        Editor editor = new Editor("source.ots");
        
        // Buka masukan OTS dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen OTS dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen OTS dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen OTS yang telah diedit
        editor.Save(afterEdit, "edited.ots");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor OTS"
    content: |
        Edit OTS sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
