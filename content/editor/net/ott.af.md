...
############################# Head ############################
head_title: "OTT-redigeerder — Wysig OTT in C# .NET"
head_description: "Hoe om OTT in C# .NET te wysig deur 'n paar reëls kode te gebruik? Gebruik GroupDocs-dokumente wat API's verwerk om 30+ lêerformate te redigeer, op te dateer en te stoor."

############################# Header ############################
title: "Wysig OTT in C# .NET"
description: "Effektiewe en robuuste OTT redigering deur bedienerkant GroupDocs.Editor vir C# .NET API's te gebruik, sonder die gebruik van enige sagteware soos Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappe om OTT in C# te wysig"
    content_left: |
        [GroupDocs.Editor for .NET](/af/editor/net/) bied 'n maklike en reguit manier vir ontwikkelaars om die OTT lêers te wysig deur 'n paar reëls kode te gebruik.
