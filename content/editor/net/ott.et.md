...
############################# Head ############################
head_title: "OTT redaktor – muutke OTT platvormil C# .NET"
head_description: "Kuidas muuta OTT platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda OTT platvormil C# .NET"
description: "Tõhus ja jõuline OTT redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud OTT muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi OTT failide redigeerimiseks, kasutades paari koodirida.
