...
############################# Head ############################
head_title: "PDF محرر - تحرير PDF في C# .NET"
head_description: "كيفية تعديل PDF في C# .NET باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير PDF في C# .NET"
description: "تحرير PDF فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات C# .NET ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل PDF في C#"
    content_left: |
        يوفر [GroupDocs.Editor for .NET] (/ar/editor/net/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات PDF باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" باستخدام مسار ملف إلزامي أو دفق وفئة "PdfLoadOptions" اختيارية لملف PDF (لا ينطبق على XPS) وتحميل الملف PDF
        * قم بإنشاء وتعيين مثيل فئة `Pdf EditOptions` لتنسيق الملف PDF
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند PDF بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * قم باستدعاء طريقة `Editor.Save ()` واحفظ الملف PDF المعدل باستخدام فئة `Pdf SaveOptions`
...
demos:
    enable: true
    title: "PDF عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير PDF الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
