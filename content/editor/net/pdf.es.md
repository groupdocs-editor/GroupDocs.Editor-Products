...
############################# Head ############################
head_title: "Editor PDF: edite PDF en C# .NET"
head_description: "¿Cómo editar PDF en C# .NET usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar PDF en C# .NET"
description: "Edición de PDF efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de C# .NET, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar PDF en C#"
    content_left: |
        [GroupDocs.Editor for .NET](/es/editor/net/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos PDF usando unas pocas líneas de código.
        * Cree una instancia de la clase 'Editor' con ruta de archivo obligatoria o secuencia y clase 'PdfLoadOptions' opcional para PDF (no aplicable para XPS) y cargue el archivo PDF
        * Cree y configure la instancia de clase `PdfEditOptions` para el formato de archivo PDF
        * Llame al método `Editor.Edit()` y obtenga el documento PDF en formato HTML que se puede editar fácilmente con cualquier editor WYSIWYG.
        * Llame al método `Editor.Save()` y guarde el archivo PDF editado usando la clase `PdfSaveOptions`
...
demos:
    enable: true
    title: "PDF Demostraciones en vivo del editor"
    content: |
        Edite PDF ahora mismo visitando el sitio web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
