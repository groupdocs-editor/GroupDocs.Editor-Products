...
############################# Head ############################
head_title: "PDF Ritstjóri — Breyta PDF í C# .NET"
head_description: "Hvernig á að breyta PDF í C# .NET með því að nota nokkrar línur af kóða? Notaðu GroupDocs skjalavinnslu API til að breyta, uppfæra og vista 30+ skráarsnið."

############################# Header ############################
title: "Breyta PDF í C# .NET"
description: "Árangursrík og öflug PDF breyting með því að nota GroupDocs.Editor á netþjóni fyrir C# .NET API, án þess að nota nokkurn hugbúnað eins og Microsoft eða Open Office."
...
steps:
    enable: true
    title_left: "Skref til að breyta PDF í C#"
    content_left: |
        [GroupDocs.Editor for .NET](/is/editor/net/) veitir forriturum auðvelda og einfalda leið til að breyta PDF skránum með því að nota nokkrar línur af kóða.
        * Búðu til tilvik af `Editor` flokki með lögboðinni skráarslóð eða straumi og valfrjálsum `PdfLoadOptions` flokki fyrir PDF (á ekki við fyrir XPS) og hlaðið PDF skránni
        * Búðu til og stilltu `PdfEditOptions` flokkatilvikið fyrir PDF skráarsniðið
        * Hringdu í `Editor.Edit()` aðferðina og fáðu PDF skjal á HTML sniði sem auðvelt er að breyta með hvaða WYSIWYG ritstjóra sem er.
        * Hringdu í `Editor.Save()` aðferðina og vistaðu breytta PDF skrá með `PdfSaveOptions` flokki
...
demos:
    enable: true
    title: "PDF Ritstjóri Live kynningar"
    content: |
        Breyttu PDF núna með því að fara á vefsíðu [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
