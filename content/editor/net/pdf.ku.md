...
############################# Head ############################
head_title: "PDF Edîtor — Biguherîne PDF li C# .NET"
head_description: "Meriv çawa PDF di C# .NET de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne PDF li C# .NET"
description: "Guhertina bi bandor û bihêz a PDF bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên C# .NET, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina PDF di C# de"
    content_left: |
        [GroupDocs.Editor for .NET](/ku/editor/net/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên PDF bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi rêça pelê ya mecbûrî an tîrêj û çîna `PdfLoadOptions` ya bijarte ji bo PDF-ê (ji bo XPS-ê ne derbasdar e) biafirîne û pelê PDF bar bike.
        * Ji bo forma pelê PDF mînaka pola `PdfEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya PDF ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê hatî guherandin PDF bi karanîna pola `PdfSaveOptions` hilînin.
...
demos:
    enable: true
    title: "PDF Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha PDF biguherînin.
