...
############################# Head ############################
head_title: "PDF Editor — Edit PDF dalam C# .NET"
head_description: "Bagaimana untuk mengedit PDF dalam C# .NET menggunakan beberapa baris kod? Gunakan API pemprosesan dokumen GroupDocs untuk mengedit, mengemas kini dan menyimpan 30+ format fail."

############################# Header ############################
title: "Edit PDF dalam C# .NET"
description: "Pengeditan PDF yang berkesan dan mantap menggunakan GroupDocs.Editor sebelah pelayan untuk API C# .NET, tanpa menggunakan sebarang perisian seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit PDF dalam C#"
    content_left: |
        [GroupDocs.Editor for .NET](/ms/editor/net/) menyediakan cara yang mudah dan mudah untuk pembangun mengedit fail PDF menggunakan beberapa baris kod.
        * Buat contoh kelas `Editor` dengan laluan fail atau strim mandatori dan kelas `PdfLoadOptions` pilihan untuk PDF (tidak berkenaan untuk XPS) dan muatkan fail PDF
        * Cipta & tetapkan contoh kelas `PdfEditOptions` untuk format fail PDF
        * Panggil kaedah `Editor.Edit()` dan dapatkan PDF dokumen dalam format HTML yang boleh diedit dengan mudah dengan mana-mana editor WYSIWYG.
        * Panggil kaedah `Editor.Save()` dan simpan fail PDF yang diedit menggunakan kelas `PdfSaveOptions`
...
demos:
    enable: true
    title: "PDF Demo Langsung Editor"
    content: |
        Edit PDF sekarang dengan melawati tapak web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
