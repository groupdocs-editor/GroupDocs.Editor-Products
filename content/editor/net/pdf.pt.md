...
############################# Head ############################
head_title: "Editor PDF — Edite PDF em C# .NET"
head_description: "Como editar PDF em C# .NET usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite PDF em C# .NET"
description: "Edição eficaz e robusta do PDF usando o GroupDocs.Editor do lado do servidor para APIs do C# .NET, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar PDF em C#"
    content_left: |
        [GroupDocs.Editor for .NET](/pt/editor/net/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos PDF usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `PdfLoadOptions` para PDF (não aplicável para XPS) e carregue o arquivo PDF
        * Crie e defina a instância de classe `PdfEditOptions` para o formato de arquivo PDF
        * Chame o método `Editor.Edit()` e obtenha o documento PDF em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo PDF editado usando a classe `PdfSaveOptions`
...
demos:
    enable: true
    title: "PDF Editor de demonstrações ao vivo"
    content: |
        Edite PDF agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
