...
############################# Head ############################
head_title: "PDF ผู้แก้ไข — แก้ไข PDF ใน C# .NET"
head_description: "วิธีแก้ไข PDF ใน C# .NET โดยใช้โค้ดสองสามบรรทัด ใช้ API การประมวลผลเอกสาร GroupDocs เพื่อแก้ไข อัปเดต และบันทึกรูปแบบไฟล์มากกว่า 30 รูปแบบ"

############################# Header ############################
title: "แก้ไข PDF ใน C# .NET"
description: "การแก้ไข PDF ที่มีประสิทธิภาพและมีประสิทธิภาพโดยใช้ GroupDocs.Editor ฝั่งเซิร์ฟเวอร์สำหรับ API ของ C# .NET โดยไม่ต้องใช้ซอฟต์แวร์ใดๆ เช่น Microsoft หรือ Open Office"
...
steps:
    enable: true
    title_left: "ขั้นตอนในการแก้ไข PDF ใน C#"
    content_left: |
        [GroupDocs.Editor for .NET](/th/editor/net/) เป็นวิธีที่ง่ายและตรงไปตรงมาสำหรับนักพัฒนาในการแก้ไขไฟล์ PDF โดยใช้โค้ดสองสามบรรทัด
        * สร้างอินสแตนซ์ของคลาส `Editor` พร้อมพาธไฟล์หรือสตรีมที่บังคับ และคลาส `PdfLoadOptions` ที่เป็นตัวเลือกสำหรับ PDF (ใช้ไม่ได้กับ XPS) และโหลดไฟล์ PDF
        * สร้างและตั้งค่าอินสแตนซ์คลาส `PdfEditOptions` สำหรับรูปแบบไฟล์ PDF
        * เรียกใช้เมธอด `Editor.Edit()` และรับเอกสาร PDF ในรูปแบบ HTML ที่แก้ไขได้อย่างง่ายดายด้วยตัวแก้ไข WYSIWYG ใดๆ
        * เรียกเมธอด `Editor.Save()` และบันทึกไฟล์ PDF ที่แก้ไขแล้วโดยใช้คลาส `PdfSaveOptions
...
demos:
    enable: true
    title: "PDF การสาธิตสดของบรรณาธิการ"
    content: |
        แก้ไข PDF ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family)
