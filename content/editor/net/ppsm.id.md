...
head_title: "PPSM Editor – Edit PPSM di C# .NET"
head_description: "Bagaimana cara mengedit PPSM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting PPSM di C#"
description: "Pengeditan PPSM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit PPSM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file PPSM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file PPSM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file PPSM
        * Panggil metode Editor.Edit dan dapatkan dokumen PPSM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file PPSM yang diedit
    ...
    code: |
        ```cs
        // Muat file PPSM ke Editor
        Editor editor = new Editor("source.ppsm");
        
        // Buka masukan PPSM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen PPSM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen PPSM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen PPSM yang telah diedit
        editor.Save(afterEdit, "edited.ppsm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor PPSM"
    content: |
        Edit PPSM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
