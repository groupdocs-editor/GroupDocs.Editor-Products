...
############################# Head ############################
head_title: "PPT Editor — Redigera PPT i C# .NET"
head_description: "Hur redigerar man PPT i C# .NET med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera PPT i C# .NET"
description: "Effektiv och robust PPT-redigering med hjälp av GroupDocs.Editor på serversidan för C# .NET API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera PPT i C#"
    content_left: |
        [GroupDocs.Editor for .NET](/sv/editor/net/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera PPT-filerna med några rader kod.
        * Skapa en instans av klassen `Editor` med obligatorisk sökväg eller byteström och valfri klass `PresentationLoadOptions` och ladda PPT-filen
        * Skapa och ställ in klassinstansen `PresentationEditOptions` för filformatet PPT
        * Anropa `Editor.Edit()`-metoden och skaffa PPT-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade PPT-filen med klassen `PresentationSaveOptions`
...
demos:
    ...
    content: |
        Redigera PPT just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
