...
head_title: "PPTM Editor – Edit PPTM di C# .NET"
head_description: "Bagaimana cara mengedit PPTM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting PPTM di C#"
description: "Pengeditan PPTM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit PPTM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file PPTM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file PPTM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file PPTM
        * Panggil metode Editor.Edit dan dapatkan dokumen PPTM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file PPTM yang diedit
    ...
    code: |
        ```cs
        // Muat file PPTM ke Editor
        Editor editor = new Editor("source.pptm");
        
        // Buka masukan PPTM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen PPTM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen PPTM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen PPTM yang telah diedit
        editor.Save(afterEdit, "edited.pptm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor PPTM"
    content: |
        Edit PPTM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
