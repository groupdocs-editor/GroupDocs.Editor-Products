...
############################# Head ############################
head_title: "PST redaktor – muutke PST platvormil C# .NET"
head_description: "Kuidas muuta PST platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda PST platvormil C# .NET"
description: "Tõhus ja jõuline PST redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud PST muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi PST failide redigeerimiseks, kasutades paari koodirida.
