...
############################# Head ############################
head_title: "PST szerkesztő – PST szerkesztése a C# .NET alkalmazásban"
head_description: "Hogyan szerkeszthető a(z) PST a(z) C# .NET alkalmazásban néhány sornyi kóddal? Használja a GroupDocs dokumentumfeldolgozó API-it több mint 30 fájlformátum szerkesztéséhez, frissítéséhez és mentéséhez."

############################# Header ############################
title: "PST szerkesztése itt: C# .NET"
description: "Hatékony és robusztus PST szerkesztés a szerveroldali GroupDocs.Editor segítségével a C# .NET API-khoz, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office."
...
steps:
    enable: true
    title_left: "A PST szerkesztésének lépései a C# nyelven"
    content_left: |
        A [GroupDocs.Editor for .NET](/hu/editor/net/) egyszerű és egyértelmű módot biztosít a fejlesztők számára a PST fájlok szerkesztésére néhány sornyi kód használatával.
