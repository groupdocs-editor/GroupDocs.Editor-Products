...
############################# Head ############################
head_title: "RTF redaktor – muutke RTF platvormil C# .NET"
head_description: "Kuidas muuta RTF platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda RTF platvormil C# .NET"
description: "Tõhus ja jõuline RTF redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud RTF muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi RTF failide redigeerimiseks, kasutades paari koodirida.
