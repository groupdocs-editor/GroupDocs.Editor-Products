...
############################# Head ############################
head_title: "SXC redaktor – muutke SXC platvormil C# .NET"
head_description: "Kuidas muuta SXC platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda SXC platvormil C# .NET"
description: "Tõhus ja jõuline SXC redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud SXC muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi SXC failide redigeerimiseks, kasutades paari koodirida.
