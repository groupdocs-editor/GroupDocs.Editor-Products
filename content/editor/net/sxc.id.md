...
head_title: "SXC Editor – Edit SXC di C# .NET"
head_description: "Bagaimana cara mengedit SXC di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting SXC di C#"
description: "Pengeditan SXC yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit SXC di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file SXC menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file SXC dengan path lengkap
        * Buat & atur EditOptions untuk jenis file SXC
        * Panggil metode Editor.Edit dan dapatkan dokumen SXC dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file SXC yang diedit
    ...
    code: |
        ```cs
        // Muat file SXC ke Editor
        Editor editor = new Editor("source.sxc");
        
        // Buka masukan SXC dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen SXC dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen SXC dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen SXC yang telah diedit
        editor.Save(afterEdit, "edited.sxc");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor SXC"
    content: |
        Edit SXC sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
