...
head_title: "TSV Editor – Edit TSV di C# .NET"
head_description: "Bagaimana cara mengedit TSV di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting TSV di C#"
description: "Pengeditan TSV yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit TSV di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file TSV menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file TSV dengan path lengkap
        * Buat & atur EditOptions untuk jenis file TSV
        * Panggil metode Editor.Edit dan dapatkan dokumen TSV dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file TSV yang diedit
    ...
    code: |
        ```cs
        // Muat file TSV ke Editor
        Editor editor = new Editor("source.tsv");
        
        // Buka masukan TSV dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen TSV dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen TSV dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen TSV yang telah diedit
        editor.Save(afterEdit, "edited.tsv");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor TSV"
    content: |
        Edit TSV sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
