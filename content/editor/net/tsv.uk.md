...
steps:
    ...
    content_left: |
        ...
        * Створіть екземпляр класу `Editor` із вказанням обов'язкового шляху до файлу чи байтового потоку і завантажте файл TSV
        * Створіть екземпляр класу `DelimitedTextEditOptions` для редагування TSV-файлів та у конструкторі вкажіть обов'язковий строковий розділювач
