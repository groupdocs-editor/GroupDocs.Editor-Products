...
############################# Head ############################
head_title: "TXT አርታዒ — TXTን በC# .NET አርትዕ"
head_description: "ጥቂት የኮድ መስመሮችን በመጠቀም TXTን በC# .NET ውስጥ እንዴት ማስተካከል ይቻላል? 30+ የፋይል ቅርጸቶችን ለማርትዕ፣ ለማዘመን እና ለማስቀመጥ GroupDocs ሰነዶችን የሚያስኬዱ ኤፒአይዎችን ይጠቀሙ።"

############################# Header ############################
title: "TXTን በC# .NET ውስጥ ያርትዑ"
description: "ውጤታማ እና ጠንካራ TXT አርትዖት የአገልጋይ ጎን GroupDocs.Editor ለC# .NET APIs፣ እንደ Microsoft ወይም Open Office ያሉ ሶፍትዌሮችን ሳይጠቀም።"
...
steps:
    enable: true
    title_left: "በC# ውስጥ TXTን ለማርትዕ ደረጃዎች"
    content_left: |
        [GroupDocs.Editor for .NET](/am/አርታዒ/net/) ገንቢዎች ጥቂት የኮድ መስመሮችን በመጠቀም TXT ፋይሎችን እንዲያርትዑ ቀላል እና ቀጥተኛ መንገድን ይሰጣል።
        * የግዴታ የፋይል ዱካ ወይም ባይት ዥረት ያለው የ«አርታዒ» ክፍል ምሳሌ ይፍጠሩ እና TXT ፋይሉን ይጫኑ
        * ለTXT ፋይል ቅርጸት `TextEditOptions` ክፍልን ይፍጠሩ እና ያቀናብሩ
        * ወደ `Editor.Edit()` ዘዴ ይደውሉ እና በማንኛውም WYSIWYG-አርታዒ በቀላሉ የሚስተካከል TXT ሰነድ በኤችቲኤምኤል ቅርጸት ያግኙ።
        * የ‹Editor.Save()› ዘዴ ይደውሉ እና የተስተካከለ TXT ፋይልን `TextSaveOptions` ክፍልን በመጠቀም ያስቀምጡ
...
demos:
    enable: true
    title: "TXT የቀጥታ ማሳያዎች አርታዒ"
    content: |
        የ[GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) ድር ጣቢያን በመጎብኘት አሁኑኑ TXTን ያርትዑ።
