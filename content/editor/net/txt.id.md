...
head_title: "TXT Editor – Edit TXT di C# .NET"
head_description: "Bagaimana cara mengedit TXT di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting TXT di C#"
description: "Pengeditan TXT yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit TXT di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file TXT menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file TXT dengan path lengkap
        * Buat & atur EditOptions untuk jenis file TXT
        * Panggil metode Editor.Edit dan dapatkan dokumen TXT dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file TXT yang diedit
    ...
    code: |
        ```cs
        // Muat file TXT ke Editor
        Editor editor = new Editor("source.txt");
        
        // Buka masukan TXT dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen TXT dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen TXT dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen TXT yang telah diedit
        editor.Save(afterEdit, "edited.txt");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor TXT"
    content: |
        Edit TXT sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
