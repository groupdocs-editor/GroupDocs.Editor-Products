...
head_title: "XLAM Editor – Edit XLAM di C# .NET"
head_description: "Bagaimana cara mengedit XLAM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting XLAM di C#"
description: "Pengeditan XLAM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit XLAM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file XLAM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file XLAM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file XLAM
        * Panggil metode Editor.Edit dan dapatkan dokumen XLAM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file XLAM yang diedit
    ...
    code: |
        ```cs
        // Muat file XLAM ke Editor
        Editor editor = new Editor("source.xlam");
        
        // Buka masukan XLAM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen XLAM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen XLAM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen XLAM yang telah diedit
        editor.Save(afterEdit, "edited.xlam");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor XLAM"
    content: |
        Edit XLAM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
