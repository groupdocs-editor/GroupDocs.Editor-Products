...
############################# Head ############################
head_title: "Urejevalnik XLSB — uredi XLSB v C# .NET"
head_description: "Kako urediti XLSB v C# .NET z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi XLSB v C# .NET"
description: "Učinkovito in robustno urejanje XLSB z API-ji GroupDocs.Editor na strežniški strani za C# .NET, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje XLSB v C#"
    content_left: |
        [GroupDocs.Editor for .NET](/sl/editor/net/) ponuja razvijalcem enostaven in preprost način za urejanje datotek XLSB z uporabo nekaj vrstic kode.
