...
############################# Head ############################
head_title: "XLSB Editor — Redigera XLSB i C# .NET"
head_description: "Hur redigerar man XLSB i C# .NET med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera XLSB i C# .NET"
description: "Effektiv och robust XLSB-redigering med hjälp av GroupDocs.Editor på serversidan för C# .NET API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera XLSB i C#"
    content_left: |
        [GroupDocs.Editor for .NET](/sv/editor/net/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera XLSB-filerna med några rader kod.
