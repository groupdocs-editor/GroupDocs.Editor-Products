...
############################# Head ############################
head_title: "Editor XLSM: edite XLSM en C# .NET"
head_description: "¿Cómo editar XLSM en C# .NET usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar XLSM en C# .NET"
description: "Edición de XLSM efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de C# .NET, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar XLSM en C#"
    content_left: |
        [GroupDocs.Editor for .NET](/es/editor/net/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos XLSM usando unas pocas líneas de código.
