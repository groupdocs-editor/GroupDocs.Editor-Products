...
############################# Head ############################
head_title: "XLSM Խմբագիր — Խմբագրել XLSM C# .NET-ում"
head_description: "Ինչպե՞ս խմբագրել XLSM-ը C# .NET-ում՝ օգտագործելով մի քանի տող կոդ: Օգտագործեք GroupDocs փաստաթղթերը մշակող API-ներ՝ խմբագրելու, թարմացնելու և պահելու 30+ ֆայլի ձևաչափեր:"

############################# Header ############################
title: "Խմբագրել XLSM-ը C# .NET-ում"
description: "Արդյունավետ և ուժեղ XLSM խմբագրում սերվերի կողմից GroupDocs.Editor-ի միջոցով C# .NET API-ների համար՝ առանց Microsoft-ի կամ Open Office-ի նման ծրագրերի օգտագործման:"
...
steps:
    enable: true
    title_left: "XLSM-ը C#-ում խմբագրելու քայլեր"
    content_left: |
        [GroupDocs.Editor for .NET](/hy/editor/net/) մշակողների համար տրամադրում է հեշտ և պարզ միջոց՝ խմբագրելու XLSM ֆայլերը՝ օգտագործելով մի քանի տող կոդ:
