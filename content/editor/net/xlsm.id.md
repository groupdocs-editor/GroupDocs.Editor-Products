...
head_title: "XLSM Editor – Edit XLSM di C# .NET"
head_description: "Bagaimana cara mengedit XLSM di C# .NET menggunakan beberapa baris kode? Gunakan API pemrosesan dokumen GroupDocs untuk mengedit, memperbarui, dan menyimpan 30+ format file."

title: "Sunting XLSM di C#"
description: "Pengeditan XLSM yang efektif dan kuat menggunakan sisi server GroupDocs.Editor untuk .NET API, tanpa menggunakan perangkat lunak apa pun seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit XLSM di C#"
    content_left: |
        [GroupDocs.Editor](/id/editor/net/) menyediakan cara mudah dan langsung bagi pengembang untuk mengedit file XLSM menggunakan beberapa baris kode.

        * Buat instance kelas Editor dan muat file XLSM dengan path lengkap
        * Buat & atur EditOptions untuk jenis file XLSM
        * Panggil metode Editor.Edit dan dapatkan dokumen XLSM dalam format HTML yang mudah diedit dengan editor WYSIWYG apa pun.
        * Panggil Editor. Simpan metode dan simpan file XLSM yang diedit
    ...
    code: |
        ```cs
        // Muat file XLSM ke Editor
        Editor editor = new Editor("source.xlsm");
        
        // Buka masukan XLSM dokumen untuk diedit — dapatkan dokumen perantara, yang dapat diedit
        EditableDocument beforeEdit = editor.Edit();

        // Ambil konten dokumen XLSM dan sumber daya terkait dari dokumen yang dapat diedit
        string content = beforeEdit.GetContent();

        // Perbarui konten dokumen XLSM dengan cara tertentu
        string updatedContent = content.Replace("Subtitle", "Edited subtitle");

        // Buat instance EditableDocument baru dari konten dan sumber daya yang diedit
        EditableDocument afterEdit = EditableDocument.FromMarkup(updatedContent, null);

        // Simpan dokumen XLSM yang telah diedit
        editor.Save(afterEdit, "edited.xlsm");
        ```
        
demos:
    enable: true
    title: "Demo Langsung Editor XLSM"
    content: |
        Edit XLSM sekarang dengan mengunjungi situs web [GroupDocs.Editor](https://products.groupdocs.app/editor/family). Demo langsung memiliki manfaat sebagai berikut.
