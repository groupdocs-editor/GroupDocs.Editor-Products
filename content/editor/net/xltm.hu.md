...
############################# Head ############################
head_title: "XLTM szerkesztő – XLTM szerkesztése a C# .NET alkalmazásban"
head_description: "Hogyan szerkeszthető a(z) XLTM a(z) C# .NET alkalmazásban néhány sornyi kóddal? Használja a GroupDocs dokumentumfeldolgozó API-it több mint 30 fájlformátum szerkesztéséhez, frissítéséhez és mentéséhez."

############################# Header ############################
title: "XLTM szerkesztése itt: C# .NET"
description: "Hatékony és robusztus XLTM szerkesztés a szerveroldali GroupDocs.Editor segítségével a C# .NET API-khoz, olyan szoftverek használata nélkül, mint a Microsoft vagy az Open Office."
...
steps:
    enable: true
    title_left: "A XLTM szerkesztésének lépései a C# nyelven"
    content_left: |
        A [GroupDocs.Editor for .NET](/hu/editor/net/) egyszerű és egyértelmű módot biztosít a fejlesztők számára a XLTM fájlok szerkesztésére néhány sornyi kód használatával.
