...
############################# Head ############################
head_title: "XLTM エディタ — C# .NET の XLTM を編集"
head_description: "数行のコードを使用して C# .NET の XLTM を編集するには? GroupDocs ドキュメント処理 API を使用して、30 以上のファイル形式を編集、更新、保存します。"

############################# Header ############################
title: "C# .NETのXLTMを編集"
description: "Microsoft や Open Office などのソフトウェアを使用せずに、サーバー側の GroupDocs.Editor for C# .NET API を使用した効果的で堅牢な XLTM 編集。"
...
steps:
    enable: true
    title_left: "C# で XLTM を編集する手順"
    content_left: |
        [GroupDocs.Editor for .NET](/ja/editor/net/) は、開発者が数行のコードを使用して XLTM ファイルを編集する簡単で直接的な方法を提供します。
