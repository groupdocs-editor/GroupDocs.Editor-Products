...
############################# Head ############################
head_title: "XLTM Editor — Edit XLTM in C# .NET"
head_description: "How to edit XLTM in C# .NET using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit XLTM in C# .NET"
description: "Effective and robust XLTM editing using server side GroupDocs.Editor for C# .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit XLTM in C#"
    content_left: |
        [GroupDocs.Editor for .NET](/editor/net/) provides an easy and straightforward way for developers to edit the XLTM files using a few lines of code.
        * Create an instance of `Editor` class with mandatory file path or stream and optional `SpreadsheetLoadOptions` class and load the XLTM file
        * Create & set the `SpreadsheetEditOptions` class instance for the XLTM file format
        * Call `Editor.Edit()` method and obtain XLTM document in HTML format that is easily editable with any WYSIWYG-editor.
        * Call `Editor.Save()` method and save edited XLTM file using `SpreadsheetSaveOptions` class
