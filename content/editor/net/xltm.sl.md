...
############################# Head ############################
head_title: "Urejevalnik XLTM — uredi XLTM v C# .NET"
head_description: "Kako urediti XLTM v C# .NET z uporabo nekaj vrstic kode? Uporabite API-je za obdelavo dokumentov GroupDocs za urejanje, posodabljanje in shranjevanje več kot 30 formatov datotek."

############################# Header ############################
title: "Uredi XLTM v C# .NET"
description: "Učinkovito in robustno urejanje XLTM z API-ji GroupDocs.Editor na strežniški strani za C# .NET, brez uporabe kakršne koli programske opreme, kot sta Microsoft ali Open Office."
...
steps:
    enable: true
    title_left: "Koraki za urejanje XLTM v C#"
    content_left: |
        [GroupDocs.Editor for .NET](/sl/editor/net/) ponuja razvijalcem enostaven in preprost način za urejanje datotek XLTM z uporabo nekaj vrstic kode.
