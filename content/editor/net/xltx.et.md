...
############################# Head ############################
head_title: "XLTX redaktor – muutke XLTX platvormil C# .NET"
head_description: "Kuidas muuta XLTX platvormis C# .NET, kasutades paari koodirida? Kasutage GroupDocsi dokumentide töötlemise API-sid, et redigeerida, värskendada ja salvestada 30+ failivormingut."

############################# Header ############################
title: "Muuda XLTX platvormil C# .NET"
description: "Tõhus ja jõuline XLTX redigeerimine serveripoolse GroupDocs.Editori abil C# .NET API-de jaoks ilma tarkvara, nagu Microsoft või Open Office, kasutamata."
...
steps:
    enable: true
    title_left: "Toimingud XLTX muutmiseks programmis C#"
    content_left: |
        [GroupDocs.Editor for .NET](/et/editor/net/) pakub arendajatele lihtsat ja arusaadavat viisi XLTX failide redigeerimiseks, kasutades paari koodirida.
