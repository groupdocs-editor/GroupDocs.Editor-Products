...
############################# Head ############################
head_title: "XPS محرر - تحرير XPS في C# .NET"
head_description: "كيفية تعديل XPS في C# .NET باستخدام بضعة أسطر من التعليمات البرمجية؟ استخدم مستندات GroupDocs لمعالجة واجهات برمجة التطبيقات لتحرير وتحديث وحفظ أكثر من 30 تنسيقًا للملفات."

############################# Header ############################
title: "تحرير XPS في C# .NET"
description: "تحرير XPS فعال وقوي باستخدام GroupDocs.Editor من جانب الخادم لواجهات برمجة تطبيقات C# .NET ، دون استخدام أي برامج مثل Microsoft أو Open Office."
...
steps:
    enable: true
    title_left: "خطوات تعديل XPS في C#"
    content_left: |
        يوفر [GroupDocs.Editor for .NET] (/ar/editor/net/) طريقة سهلة ومباشرة للمطورين لتعديل ملفات XPS باستخدام بضعة أسطر من التعليمات البرمجية.
        * قم بإنشاء مثيل لفئة "Editor" باستخدام مسار ملف إلزامي أو دفق وفئة "PdfLoadOptions" اختيارية لملف PDF (لا ينطبق على XPS) وتحميل الملف XPS
        * قم بإنشاء وتعيين مثيل فئة `Xps EditOptions` لتنسيق الملف XPS
        * قم باستدعاء طريقة `Editor.Edit ()` واحصل على مستند XPS بتنسيق HTML الذي يمكن تحريره بسهولة باستخدام أي محرر WYSIWYG.
        * قم باستدعاء طريقة `Editor.Save ()` واحفظ الملف XPS المعدل باستخدام فئة `Xps SaveOptions`
...
demos:
    enable: true
    title: "XPS عروض توضيحية مباشرة للمحرر"
    content: |
        قم بتحرير XPS الآن من خلال زيارة موقع ويب [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
