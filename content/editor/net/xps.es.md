...
############################# Head ############################
head_title: "Editor XPS: edite XPS en C# .NET"
head_description: "¿Cómo editar XPS en C# .NET usando unas pocas líneas de código? Utilice las API de procesamiento de documentos de GroupDocs para editar, actualizar y guardar más de 30 formatos de archivo."

############################# Header ############################
title: "Editar XPS en C# .NET"
description: "Edición de XPS efectiva y robusta usando GroupDocs.Editor del lado del servidor para las API de C# .NET, sin el uso de ningún software como Microsoft u Open Office."
...
steps:
    enable: true
    title_left: "Pasos para editar XPS en C#"
    content_left: |
        [GroupDocs.Editor for .NET](/es/editor/net/) proporciona una manera fácil y directa para que los desarrolladores editen los archivos XPS usando unas pocas líneas de código.
        * Cree una instancia de la clase 'Editor' con ruta de archivo obligatoria o secuencia y clase 'PdfLoadOptions' opcional para PDF (no aplicable para XPS) y cargue el archivo XPS
        * Cree y configure la instancia de clase `XpsEditOptions` para el formato de archivo XPS
        * Llame al método `Editor.Edit()` y obtenga el documento XPS en formato HTML que se puede editar fácilmente con cualquier editor WYSIWYG.
        * Llame al método `Editor.Save()` y guarde el archivo XPS editado usando la clase `XpsSaveOptions`
...
demos:
    enable: true
    title: "XPS Demostraciones en vivo del editor"
    content: |
        Edite XPS ahora mismo visitando el sitio web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
