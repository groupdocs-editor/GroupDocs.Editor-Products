...
############################# Head ############################
head_title: "XPS Editor — Uredite XPS u C# .NET"
head_description: "Kako urediti XPS u C# .NET pomoću nekoliko redaka koda? Koristite API-je za obradu dokumenata GroupDocs za uređivanje, ažuriranje i spremanje više od 30 formata datoteka."

############################# Header ############################
title: "Uredi XPS u C# .NET"
description: "Učinkovito i robusno XPS uređivanje koristeći GroupDocs.Editor na strani poslužitelja za API-je C# .NET, bez upotrebe bilo kakvog softvera poput Microsofta ili Open Officea."
...
steps:
    enable: true
    title_left: "Koraci za uređivanje XPS u C#"
    content_left: |
        [GroupDocs.Editor for .NET](/hr/editor/net/) programerima pruža jednostavan i jednostavan način za uređivanje datoteka XPS pomoću nekoliko redaka koda.
        * Napravite instancu klase `Uređivač` s obaveznim putem datoteke ili streamom i izbornom klasom `PdfLoadOptions` za PDF (nije primjenjivo za XPS) i učitajte datoteku XPS
        * Stvorite i postavite instancu klase `XpsEditOptions` za format datoteke XPS
        * Pozovite metodu `Editor.Edit()` i dobijte XPS dokument u HTML formatu koji je lako uređivati ​​bilo kojim WYSIWYG uređivačem.
        * Pozovite metodu `Editor.Save()` i spremite uređenu datoteku XPS pomoću klase `XpsSaveOptions`
...
demos:
    enable: true
    title: "XPS Demonstracije uređivača uživo"
    content: |
        Uredite XPS odmah tako da posjetite [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) web mjesto.
