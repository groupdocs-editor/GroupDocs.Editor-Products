...
############################# Head ############################
head_title: "XPS Edîtor — Biguherîne XPS li C# .NET"
head_description: "Meriv çawa XPS di C# .NET de bi çend rêzikên kodê biguherîne? Dokumentên GroupDocs-ê API-yên hilberandinê bikar bînin da ku 30+ formatên pelan biguherînin, nûve bikin û hilînin."

############################# Header ############################
title: "Biguherîne XPS li C# .NET"
description: "Guhertina bi bandor û bihêz a XPS bi karanîna aliyê serverê GroupDocs.Editor ji bo API-yên C# .NET, bêyî karanîna nermalava mîna Microsoft an Open Office."
...
steps:
    enable: true
    title_left: "Gavên Guhertina XPS di C# de"
    content_left: |
        [GroupDocs.Editor for .NET](/ku/editor/net/) ji bo pêşdebiran rêyek hêsan û rast peyda dike ku pelên XPS bi karanîna çend rêzikên kodê biguherînin.
        * Nimûneyek ji çîna `Edîtor` bi rêça pelê ya mecbûrî an tîrêj û çîna `PdfLoadOptions` ya bijarte ji bo PDF-ê (ji bo XPS-ê ne derbasdar e) biafirîne û pelê XPS bar bike.
        * Ji bo forma pelê XPS mînaka pola `XpsEditOptions` biafirîne û saz bike
        * Gazî rêbaza `Editor.Edit()` bikin û belgeya XPS ya bi formata HTML-ê ku bi her edîtorek WYSIWYG-ê bi hêsanî tê guherandin bistînin bistînin.
        * Gazî rêbaza `Editor.Save()` bikin û pelê hatî guherandin XPS bi karanîna pola `XpsSaveOptions` hilînin.
...
demos:
    enable: true
    title: "XPS Edîtor Demoyên Zindî"
    content: |
        Bi serdana malpera [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) niha XPS biguherînin.
