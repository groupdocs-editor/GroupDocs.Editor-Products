...
############################# Head ############################
head_title: "XPS Editor — Edit XPS dalam C# .NET"
head_description: "Bagaimana untuk mengedit XPS dalam C# .NET menggunakan beberapa baris kod? Gunakan API pemprosesan dokumen GroupDocs untuk mengedit, mengemas kini dan menyimpan 30+ format fail."

############################# Header ############################
title: "Edit XPS dalam C# .NET"
description: "Pengeditan XPS yang berkesan dan mantap menggunakan GroupDocs.Editor sebelah pelayan untuk API C# .NET, tanpa menggunakan sebarang perisian seperti Microsoft atau Open Office."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Mengedit XPS dalam C#"
    content_left: |
        [GroupDocs.Editor for .NET](/ms/editor/net/) menyediakan cara yang mudah dan mudah untuk pembangun mengedit fail XPS menggunakan beberapa baris kod.
        * Buat contoh kelas `Editor` dengan laluan fail atau strim mandatori dan kelas `PdfLoadOptions` pilihan untuk PDF (tidak berkenaan untuk XPS) dan muatkan fail XPS
        * Cipta & tetapkan contoh kelas `XpsEditOptions` untuk format fail XPS
        * Panggil kaedah `Editor.Edit()` dan dapatkan XPS dokumen dalam format HTML yang boleh diedit dengan mudah dengan mana-mana editor WYSIWYG.
        * Panggil kaedah `Editor.Save()` dan simpan fail XPS yang diedit menggunakan kelas `XpsSaveOptions`
...
demos:
    enable: true
    title: "XPS Demo Langsung Editor"
    content: |
        Edit XPS sekarang dengan melawati tapak web [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
