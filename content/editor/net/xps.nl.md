...
############################# Head ############################
head_title: "XPS Editor — Bewerk XPS in C# .NET"
head_description: "Hoe bewerk je XPS in C# .NET met een paar regels code? Gebruik API's voor het verwerken van documenten van GroupDocs om meer dan 30 bestandsindelingen te bewerken, bij te werken en op te slaan."

############################# Header ############################
title: "Bewerk XPS in C# .NET"
description: "Effectieve en robuuste XPS bewerking met Server-side GroupDocs.Editor voor C# .NET API's, zonder het gebruik van software zoals Microsoft of Open Office."
...
steps:
    enable: true
    title_left: "Stappen om XPS te bewerken in C#"
    content_left: |
        [GroupDocs.Editor for .NET](/nl/editor/net/) biedt ontwikkelaars een gemakkelijke en duidelijke manier om de XPS-bestanden te bewerken met een paar regels code.
        * Maak een instantie van de klasse 'Editor' met verplicht bestandspad of -stream en optionele klasse 'PdfLoadOptions' voor PDF (niet van toepassing op XPS) en laad het bestand XPS
        * Maak en stel de klasse-instantie 'XpsEditOptions' in voor de bestandsindeling XPS
        * Roep de `Editor.Edit()` methode aan en verkrijg een XPS document in HTML-formaat dat gemakkelijk kan worden bewerkt met elke WYSIWYG-editor.
        * Roep de `Editor.Save()`-methode aan en sla het bewerkte XPS-bestand op met de klasse `XpsSaveOptions`
...
demos:
    enable: true
    title: "XPS Editor Live demo's"
    content: |
        Bewerk XPS nu direct door naar de website [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) te gaan.
