...
############################# Head ############################
head_title: "Editor XPS — Edite XPS em C# .NET"
head_description: "Como editar XPS em C# .NET usando algumas linhas de código? Use as APIs de processamento de documentos do GroupDocs para editar, atualizar e salvar mais de 30 formatos de arquivo."

############################# Header ############################
title: "Edite XPS em C# .NET"
description: "Edição eficaz e robusta do XPS usando o GroupDocs.Editor do lado do servidor para APIs do C# .NET, sem o uso de qualquer software como Microsoft ou Open Office."
...
steps:
    enable: true
    title_left: "Etapas para editar XPS em C#"
    content_left: |
        [GroupDocs.Editor for .NET](/pt/editor/net/) fornece uma maneira fácil e direta para os desenvolvedores editarem os arquivos XPS usando algumas linhas de código.
        * Crie uma instância da classe `Editor` com caminho ou fluxo de arquivo obrigatório e classe opcional `PdfLoadOptions` para PDF (não aplicável para XPS) e carregue o arquivo XPS
        * Crie e defina a instância de classe `XpsEditOptions` para o formato de arquivo XPS
        * Chame o método `Editor.Edit()` e obtenha o documento XPS em formato HTML que é facilmente editável com qualquer editor WYSIWYG.
        * Chame o método `Editor.Save()` e salve o arquivo XPS editado usando a classe `XpsSaveOptions`
...
demos:
    enable: true
    title: "XPS Editor de demonstrações ao vivo"
    content: |
        Edite XPS agora mesmo visitando o site [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
