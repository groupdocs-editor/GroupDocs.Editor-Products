...
############################# Head ############################
head_title: "XPS Editor — Redigera XPS i C# .NET"
head_description: "Hur redigerar man XPS i C# .NET med några rader kod? Använd API:er för bearbetning av GroupDocs-dokument för att redigera, uppdatera och spara över 30 filformat."

############################# Header ############################
title: "Redigera XPS i C# .NET"
description: "Effektiv och robust XPS-redigering med hjälp av GroupDocs.Editor på serversidan för C# .NET API:er, utan användning av någon programvara som Microsoft eller Open Office."
...
steps:
    enable: true
    title_left: "Steg för att redigera XPS i C#"
    content_left: |
        [GroupDocs.Editor for .NET](/sv/editor/net/) tillhandahåller ett enkelt och okomplicerat sätt för utvecklare att redigera XPS-filerna med några rader kod.
        * Skapa en instans av klassen "Editor" med obligatorisk sökväg eller ström och valfri klass "PdfLoadOptions" för PDF (ej tillämpligt för XPS) och ladda XPS-filen
        * Skapa och ställ in klassinstansen `XpsEditOptions` för filformatet XPS
        * Anropa `Editor.Edit()`-metoden och skaffa XPS-dokument i HTML-format som lätt kan redigeras med vilken WYSIWYG-redigerare som helst.
        * Anropa `Editor.Save()`-metoden och spara den redigerade XPS-filen med klassen `XpsSaveOptions`
...
demos:
    ...
    content: |
        Redigera XPS just nu genom att besöka webbplatsen [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family).
