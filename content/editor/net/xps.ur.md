...
############################# Head ############################
head_title: "XPS ایڈیٹر — XPS میں C# .NET میں ترمیم کریں"
head_description: "کوڈ کی چند سطروں کا استعمال کرتے ہوئے C# .NET میں XPS میں ترمیم کیسے کی جائے؟ 30+ فائل فارمیٹس میں ترمیم، اپ ڈیٹ اور محفوظ کرنے کے لیے GroupDocs دستاویزات پر کارروائی کرنے والے APIs کا استعمال کریں۔"

############################# Header ############################
title: "C# .NET میں XPS میں ترمیم کریں"
description: "مائیکروسافٹ یا اوپن آفس جیسے کسی سافٹ ویئر کے استعمال کے بغیر، C# .NET APIs کے لیے سرور سائڈ GroupDocs.Editor کا استعمال کرتے ہوئے مؤثر اور مضبوط XPS ترمیم۔"
...
steps:
    enable: true
    title_left: "C# میں XPS میں ترمیم کرنے کے مراحل"
    content_left: |
        [GroupDocs.Editor for .NET](/ur/editor/net/) ڈویلپرز کو کوڈ کی چند سطروں کا استعمال کرتے ہوئے XPS فائلوں میں ترمیم کرنے کا ایک آسان اور سیدھا طریقہ فراہم کرتا ہے۔
        * لازمی فائل پاتھ یا اسٹریم کے ساتھ 'ایڈیٹر' کلاس کی مثال بنائیں اور پی ڈی ایف کے لیے اختیاری 'PdfLoadOptions' کلاس (XPS کے لیے قابل اطلاق نہیں) اور XPS فائل لوڈ کریں۔
        * XPS فائل فارمیٹ کے لیے `XpsEditOptions` کلاس مثال بنائیں اور سیٹ کریں
        * 'Editor.Edit()' طریقہ کو کال کریں اور HTML فارمیٹ میں XPS دستاویز حاصل کریں جو کسی بھی WYSIWYG ایڈیٹر کے ساتھ آسانی سے قابل تدوین ہو۔
        * `Editor.Save()` طریقہ پر کال کریں اور `XpsSaveOptions` کلاس کا استعمال کرتے ہوئے ترمیم شدہ XPS فائل کو محفوظ کریں
...
demos:
    enable: true
    title: "XPS ایڈیٹر لائیو ڈیمو"
    content: |
        [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) ویب سائٹ پر جا کر ابھی XPS میں ترمیم کریں۔
