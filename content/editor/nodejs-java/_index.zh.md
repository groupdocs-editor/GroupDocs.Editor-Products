...
overview:
  ...
  features:
    ...
    - title: "在 Node.js 中轻松编辑多个文档"
      content: "无缝编辑多个 PDF 和 Office 文件，支持多种格式。 Node.js 的 GroupDocs.Editor 使文档编辑变得快速、轻松。"
...
formats:
  ...
  title: "支持的文件格式"
  description: |
    Node.js 的 GroupDocs.Editor 支持以下[文件格式](https://docs.groupdocs.com/editor/nodejs/supported-document-formats/) 的操作。
  groups:
    # group loop
    - color: "green"
      content: |
