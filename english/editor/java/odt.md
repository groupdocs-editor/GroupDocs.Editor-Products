...
############################# Head ############################
head_title: "ODT Editor for Java – Edit ODT"
head_description: "Edit ODT in Java using a few lines of code. Fast and robust document editor API for 30+ file formats."

############################# Header ############################
title: "Edit ODT in Java"
description: "Powerfull and fast ODT editor for your Java application without third-party software like Microsoft Office or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/java) provides an easy and starightforward way for developers to edit the ODT files using a few lines of code.
