...
############################# Head ############################
head_title: "PPS Editor for Java – Edit PPS"
head_description: "Edit PPS in Java using a few lines of code. Fast and robust document editor API for 30+ file formats."

############################# Header ############################
title: "Edit PPS in Java"
description: "Powerfull and fast PPS editor for your Java application without third-party software like Microsoft Office or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/java) provides an easy and starightforward way for developers to edit the PPS files using a few lines of code.
