...
############################# Head ############################
head_title: "CSV Editor – Eidt CSV in C# .NET"
...
############################# Header ############################
title: "Edit CSV in C#"
description: "Effective and robust CSV editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the CSV files using a few lines of code.

        *   Create an instance of Editor class and load the CSV file with full path
        *   Create & set EditOptions for the CSV file type
        *   Call Editor.Edit method and obtain CSV document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited CSV file
