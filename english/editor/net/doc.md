...
############################# Head ############################
head_title: "DOC Editor – Eidt DOC in C# .NET"
...
############################# Header ############################
title: "Edit DOC in C#"
description: "Effective and robust DOC editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the DOC files using a few lines of code.
