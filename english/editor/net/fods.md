...
############################# Header ############################
title: "Edit FODS in C#"
description: "Effective and robust FODS editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the FODS files using a few lines of code.

        *   Create an instance of Editor class and load the FODS file with full path
        *   Create & set EditOptions for the FODS file type
        *   Call Editor.Edit method and obtain FODS document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited FODS file
    ...
    code: |
        ```cs
        // Load the FODS file into Editor
