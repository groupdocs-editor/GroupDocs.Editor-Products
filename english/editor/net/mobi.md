...
############################# Static ############################
layout: "auto-gen"
date: 2021-12-20T10:08:47
draft: false

############################# Head ############################
head_title: "MOBI Editor – Eidt MOBI in C# .NET"
...
############################# Header ############################
title: "Edit MOBI in C#"
description: "Effective and robust MOBI editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the MOBI files using a few lines of code.
    ...
    code: |
        ...
        editor.Save(afterEdit, "edited..mobi", saveOptions);
        ```
