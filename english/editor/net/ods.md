...
############################# Head ############################
head_title: "ODS Editor – Eidt ODS in C# .NET"
...
############################# Header ############################
title: "Edit ODS in C#"
description: "Effective and robust ODS editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the ODS files using a few lines of code.

        *   Create an instance of Editor class and load the ODS file with full path
        *   Create & set EditOptions for the ODS file type
        *   Call Editor.Edit method and obtain ODS document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited ODS file
