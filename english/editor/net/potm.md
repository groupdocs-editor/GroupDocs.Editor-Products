...
############################# Head ############################
head_title: "POTM Editor – Edit POTM in C# .NET"
head_description: "How to edit POTM in C# .NET using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit POTM in C#"
description: "Effective and robust POTM editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit POTM in C#"
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the POTM files using a few lines of code.

        *   Create an instance of Editor class and load the POTM file with full path
        *   Create & set EditOptions for the POTM file type
        *   Call Editor.Edit method and obtain POTM document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited POTM file
    ...
    code: |
        ```cs
        // Load the POTM file into Editor
...
demos:
    ...
    content: |
        Edit POTM right now by visiting [GroupDocs.Editor Live Demos](https://products.groupdocs.app/editor/family) website.  
