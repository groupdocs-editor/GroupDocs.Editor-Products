...
############################# Header ############################
title: "Edit XLT in C#"
description: "Effective and robust XLT editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    ...
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the XLT files using a few lines of code.

        *   Create an instance of Editor class and load the XLT file with full path
        *   Create & set EditOptions for the XLT file type
        *   Call Editor.Edit method and obtain XLT document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited XLT file
