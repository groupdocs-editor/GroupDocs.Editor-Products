...
############################# Head ############################
head_title: "XLTX Editor – Eidt XLTX in C# .NET"
head_description: "How to edit XLTX in C# .NET using a few lines of code? Use GroupDocs documents processing APIs to edit, update and save 30+ file formats."

############################# Header ############################
title: "Edit XLTX in C#"
description: "Effective and robust XLTX editing using server side GroupDocs.Editor for .NET APIs, without the use of any software like Microsoft or Open Office."
...
steps:
    enable: true
    title_left: "Steps to Edit XLTX in C#"
    content_left: |
        [GroupDocs.Editor](https://products.groupdocs.com/editor/net) provides an easy and starightforward way for developers to edit the XLTX files using a few lines of code.

        *   Create an instance of Editor class and load the XLTX file with full path
        *   Create & set EditOptions for the XLTX file type
        *   Call Editor.Edit method and obtain XLTX document in HTML format that is easily editable with any WYSIWYG-editor.
        *   Call Editor.Save method and save edited XLTX file
    ...
    code: |
        ```cs
        // Load the XLTX file into Editor
